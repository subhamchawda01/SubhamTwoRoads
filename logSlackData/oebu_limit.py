...
def main():
        while True:
                with open('/home/subham/subham/generateHtmlPage/market_data_ind17_tmp.json') as json_file:
                        data = json.load(json_file);
                        logfilename = '/home/subham/subham/generateHtmlPage/log/' + 'log_' + time.strftime("%Y%m%d") + '.txt';
                        ...
                        for line in data['data']:
                                ...
                                if float(line[19]) >= 0 and traded_val >= 1 and float(line[13]) <= 0:
