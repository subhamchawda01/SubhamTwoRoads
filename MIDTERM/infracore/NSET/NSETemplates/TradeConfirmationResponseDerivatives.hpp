...
#define NSE_TRADE_RESPONSE_PAN_OFFSET \
  (NSE_TRADE_RESPONSE_PAD_OFFSET+NSE_TRADE_RESPONSE_PAD_LENGTH)
...
#define NSE_TRADE_RESPONSE_STP_RESERVED_OFFSET (NSE_TRADE_RESPONSE_LASTACTIVITYREFERENCE_OFFSET + NSE_TRADE_RESPONSE_LASTACTIVITYREFERENCE_LENGTH)
#define NSE_TRADE_RESPONSE_STP_RESERVED_LENGTH 52

#define NSE_TRADE_RESPONSE_LENGTH \
  (NSE_TRADE_RESPONSE_STP_RESERVED_OFFSET + NSE_TRADE_RESPONSE_STP_RESERVED_LENGTH)
