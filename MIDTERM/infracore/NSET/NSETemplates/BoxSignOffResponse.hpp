...
class NSEBoxSignOffResponse {
 protected:
  ProcessedBoxSignOffResponse processed_boxsignoff_response_;

 public:
  NSEBoxSignOffResponse() { memset((void *)&processed_boxsignoff_response_, 0, sizeof(ProcessedBoxSignOffResponse)); }
  ~NSEBoxSignOffResponse() {}

  ProcessedBoxSignOffResponse *ProcessBoxSignOffResponse(char const *msg_ptr) { 
    processed_boxsignoff_response_.box_id = ntoh16(*((int16_t *)(msg_ptr + 0)));
    return &processed_boxsignoff_response_; 
  }
