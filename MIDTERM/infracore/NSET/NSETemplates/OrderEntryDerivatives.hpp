...
#define NSE_ORDERENTRY_REQUEST_PAN_OFFSET (NSE_ORDERENTRY_REQUEST_NFFIELD_OFFSET+NSE_ORDERENTRY_REQUEST_NFFIELD_LENGTH)
...
#define NSE_ORDERENTRY_REQUEST_ALGOCAT_OFFSET (NSE_ORDERENTRY_REQUEST_ALGOID_OFFSET+NSE_ORDERENTRY_REQUEST_ALGOID_LENGTH)
#define NSE_ORDERENTRY_REQUEST_ALGOCAT_LENGTH 2

#define NSE_ORDERENTRY_REQUEST_STP_RESERVED_OFFSET (NSE_ORDERENTRY_REQUEST_ALGOCAT_OFFSET+NSE_ORDERENTRY_REQUEST_ALGOCAT_LENGTH)
#define NSE_ORDERENTRY_REQUEST_STP_RESERVED_LENGTH 32

#define NSE_ORDERENTRY_REQUEST_LENGTH (NSE_ORDERENTRY_REQUEST_STP_RESERVED_OFFSET + NSE_ORDERENTRY_REQUEST_STP_RESERVED_LENGTH)
...
class OrderEntryRequestDerivatives : public OrderEntryRequest {
 public:
  void InitializeStaticFields() {
    ...
    *((int16_t *)(msg_ptr + NSE_ORDERENTRY_REQUEST_STORDERFLAGS_STRUCT_OFFSET)) =
    ...
    // *((int16_t *)(msg_ptr + NSE_ORDERENTRY_REQUEST_BRNACHID_OFFSET)) = hton16(1);
 ...
 public:
  ...
  inline void SetDynamicOrderEntryRequestFields(int32_t const &packet_sequence_number, int16_t const &buy_sell,
                                                ...
                                                InstrumentDesc *inst_desc, bool is_mo = false, bool add_preopen = false) {
    ...
    if (__builtin_expect(!is_ioc, true) && __builtin_expect(!is_mo, true)) {
      SetDay();
