...
my $mkdir_cmd_ = `taskset -c 20,21,22,23 ssh sghosh\@10.23.142.51 'mkdir -p $t_remote_file_location_'`;
my $rsync_cmd_ = `taskset -c 20,21,22,23 rsync -avz --quiet $t_local_file_location_ sghosh\@10.23.142.51:$t_remote_file_location_`;
