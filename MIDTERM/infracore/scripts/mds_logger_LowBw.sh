...
MDS_LOG_EXEC=$HOME/LiveExec/bin/mds_logger_MCAST #default exec, invalid
...
case $EXCH in
    cme|CME)
       ...
       MDS_LOG_EXEC=$HOME/LiveExec/bin/cme_live_source_logger 

       ;;
    eurex|EUREX)

       MDS_LOG_EXEC=$HOME/LiveExec/bin/eurex_live_source_logger 
