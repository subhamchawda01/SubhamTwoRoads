// Logout : Optimized way
// BMFEP :  Doc Version 1.2.1
// Similar to CME but we send very few Tags
//
#include "dvccode/Utils/tcp_client_socket.hpp"
#include "infracore/BMFEP/BMFEPFIX/BMFEPMessageDefs.hpp"

#ifndef BMFEP_LOGOUT_HPP
#define BMFEP_LOGOUT_HPP
...
class Logout {
 public:
  Logout(const bool _make_optimize_assumptions_)
      : Header_Tag_8_(NULL),
        Header_Tag_9_(NULL),
        Header_Tag_35_(NULL),
        Header_Tag_34_(NULL),
    ...
    bzero(msg_char_buf_, BMFEP_Header_msg_size_ + BMFEP_Logout_msg_size_ + BMFEP_Trailer_msg_size_);
  }
  ...
  void setFields(const char *sender_compID_, const char *target_compID_) {
    ...
    Header_Tag_34_ = Header_Tag_35_ + sprintf(Header_Tag_35_, "35=5%c", BMFEP_Delimiter_SOH_);
    ...
    Trailer_Tag_10_ = Header_Tag_56_ + sprintf(Header_Tag_56_, "56=%s%c", target_compID_, BMFEP_Delimiter_SOH_);
 ...
 public:
  ...
  char msg_char_buf_[BMFEP_Header_msg_size_ + BMFEP_Logout_msg_size_ + BMFEP_Trailer_msg_size_];
