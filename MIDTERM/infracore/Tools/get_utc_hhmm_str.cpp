...
int main(int argc, char** argv) {
  ...
  if ((strncmp(argv[1], "EST_", 4) == 0) || (strncmp(argv[1], "CST_", 4) == 0) || (strncmp(argv[1], "CET_", 4) == 0) ||
      ...
      (strncmp(argv[1], "MSK_", 4) == 0) || (strncmp(argv[1], "BST_", 4) == 0) || (strncmp(argv[1], "AST_", 4) == 0) ||
      (strncmp(argv[1], "SGT_", 4) == 0)) {
    printf("%d", HFSAT::DateTime::GetUTCHHMMFromTZHHMM(tradingdate_, atoi(argv[1] + 4), argv[1]));
  } else {
