cd /home/sghosh/fxstreet;
perl union_bbg_fxs_usauctions.pl bbg_us_eco_2012_processed.txt fxstreet_eco_2012_processed.txt auction_us_eco_2012_processed.txt merged_eco_2012_processed.txt ; 
