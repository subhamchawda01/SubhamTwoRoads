...
# E.g. PermuteParams ("/home/dvcinfra/strat_options", "/spare/local/dvctrader")
# will create files containing all permutations in directory '/spare/local/dvctrader'. 
# Files will be named strat_options_1, strat_options_2 ...
sub PermuteParams
{
    my $src_file_ = shift;
    my $dest_dir_ = shift;
    ...
    open SRC_FILE_, "<", $src_file_ or die "Could not open file : $src_file_\n";
	...
	open FILE, ">", $file_name_ or die "Could not write to file : $file_name_\n";
