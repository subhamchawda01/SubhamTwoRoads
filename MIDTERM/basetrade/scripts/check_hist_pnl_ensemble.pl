...
$shortcode2numqueries_{"ZN_0"}=1; $shortcode2numdayspast_{"ZN_0"}=3; # second best was 3 days
...
$shortcode2numqueries_{"CGB_0"}=5; $shortcode2numdayspast_{"CGB_0"}=10; # second best is 2-3 ... 10 is also good
...
$shortcode2numqueries_{"BR_WIN_0"}=1; $shortcode2numdayspast_{"BR_WIN_0"}=5;
