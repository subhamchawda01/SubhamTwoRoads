...
my $LOCKFILE=$HOME_DIR."/locks/call_run_sim_overnight_staged_".$shortcode_."_".$num_working_days_."_".$time_period_.".lock";

my $hostname_ = `hostname`;
if ( index ( $hostname_ , "ip-10-0" ) >= 0 )
{ # AWS
    $LOCKFILE="/mnt/sdf/locks/call_run_sim_overnight_staged_".$shortcode_."_".$num_working_days_."_".$time_period_.".lock";
}
