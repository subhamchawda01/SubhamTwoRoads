...
given ( $timeperiod_ )
{
    ...
    default
    {
	print "options for arg1 US_MORN_DAY / EU_MORN_DAY\n";
	exit ( 0 );
    }
}
...
{
    when ("FGBS_0") {
	$shortcode2numqueries_{"FGBS_0"}=5; $shortcode2numdayspast_{"FGBS_0"}=3; # best was 1 but very close to 3
    } when ("FGBM_0") {
	$shortcode2numqueries_{"FGBM_0"}=1; $shortcode2numdayspast_{"FGBM_0"}=5; # second best is 5 days
    } when ("FGBL_0") {
	$shortcode2numqueries_{"FGBL_0"}=3; $shortcode2numdayspast_{"FGBL_0"}=7; # second best is 1
    } when ("FESX_0") {
	$shortcode2numqueries_{"FESX_0"}=4; $shortcode2numdayspast_{"FESX_0"}=14; # second best is 14
    } when ("FDAX_0") {
	$shortcode2numqueries_{"FDAX_0"}=1; $shortcode2numdayspast_{"FDAX_0"}=14; # no research done yet
    } when ("ZF_0") {
	$shortcode2numqueries_{"ZF_0"}=1; $shortcode2numdayspast_{"ZF_0"}=5; # second best was 2 days
    } when ("ZN_0") {
	...
	$shortcode2numqueries_{"CGB_0"}=5; $shortcode2numdayspast_{"CGB_0"}=1; # second best is 2-3 ... 10 is also good
    } when ("SFX_0") { 
	...
	$shortcode2numqueries_{"BAX_1"}=0; $shortcode2numdayspast_{"BAX_1"}=5; # second best is 2-3 ... 10 is also good
    } when ("BAX_2") {
	$shortcode2numqueries_{"BAX_2"}=3; $shortcode2numdayspast_{"BAX_2"}=5; # second best is 2-3 ... 10 is also good
    } when ("BAX_3") {
	$shortcode2numqueries_{"BAX_3"}=3; $shortcode2numdayspast_{"BAX_3"}=5; # second best is 2-3 ... 10 is also good
    } when ("BAX_4") {
	$shortcode2numqueries_{"BAX_4"}=3; $shortcode2numdayspast_{"BAX_4"}=5; # second best is 2-3 ... 10 is also good
    } when ("BAX_5") {
	$shortcode2numqueries_{"BAX_5"}=2; $shortcode2numdayspast_{"BAX_5"}=5; # second best is 2-3 ... 10 is also good
    } when ("BAX_6") {
	$shortcode2numqueries_{"BAX_6"}=0; $shortcode2numdayspast_{"BAX_6"}=5; # second best is 2-3 ... 10 is also good
    } when ("BR_DOL_0") {
	$shortcode2numqueries_{"BR_DOL_0"}=1; $shortcode2numdayspast_{"BR_DOL_0"}=5; #
    } when ("BR_IND_0") {
	$shortcode2numqueries_{"BR_IND_0"}=1; $shortcode2numdayspast_{"BR_IND_0"}=5; #
    } when ("BR_WIN_0") {
	$shortcode2numqueries_{"BR_WIN_0"}=3; $shortcode2numdayspast_{"BR_WIN_0"}=5; #
    }
}
