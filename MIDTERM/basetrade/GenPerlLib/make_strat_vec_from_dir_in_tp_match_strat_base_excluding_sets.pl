# \file GenPerlLib/make_strat_vec_from_dir_in_tp_match_strat_base_excluding_sets.pl
#
...
require "$GENPERLLIB_DIR/make_strat_vec_from_dir_match_strat_base.pl"; # MakeStratVecFromDirMatchStratBase
...
sub MakeStratVecFromDirInTpMatchStratBaseExcludingSets
{ # expects an argument like ~/modelling/strats/ZN_0
  my ($top_directory_, $time_period_, $strategy_type_, $basepx_pxtype_, @exclude_tp_dirs_) = @_;
...
#	      print STDERR "checking $dir_item_\n";
	      ...
	      { 
		  push @ret_abs_file_paths_, MakeStratVecFromDirMatchStratBase ( "$top_directory_/$dir_item_", $strategy_type_, $basepx_pxtype_ ) ; 
	      }
