# \file GenPerlLib/make_strat_vec_from_dir_in_tp_match_strat_excluding_sets.pl
#
...
require "$GENPERLLIB_DIR/make_strat_vec_from_dir_match_strat.pl"; # MakeStratVecFromDirMatchStrat
...
sub MakeStratVecFromDirInTpMatchStratExcludingSets
{ # expects an argument like ~/modelling/strats/ZN_0
  my ($top_directory_, $time_period_, $strategy_type_, @exclude_tp_dirs_) = @_;
...
#	      print STDERR "checking $dir_item_\n";
	      ...
	      { 
		  push @ret_abs_file_paths_, MakeStratVecFromDirMatchStrat ( "$top_directory_/$dir_item_", $strategy_type_ ) ; 
	      }
