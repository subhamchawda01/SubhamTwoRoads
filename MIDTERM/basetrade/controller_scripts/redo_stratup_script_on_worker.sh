...
ssh  -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no  -t  -i ~/.ssh/dvckeypair_virginia.pem  ec2-user@$IP ' sudo mount -t nfs 10.0.0.11:/home/dvctrader/globalresults /mnt/globalresults '
ssh  -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no  -t  -i ~/.ssh/dvckeypair_virginia.pem  ec2-user@$IP ' sudo mount -t nfs 10.0.0.11:/home/dvctrader/indicatorwork /mnt/indicatorwork '

echo "setup s3cmd"
rsync -avz /home/dvctrader/.s3cfg dvctrader@$IP:/home/dvctrader
