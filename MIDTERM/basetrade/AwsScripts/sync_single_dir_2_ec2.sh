...
rsync -ravz --timeout=60 $src/ 54.208.92.178:$tgt/;
ssh -o ConnectTimeout=60 54.208.92.178 "sh /home/dvctrader/basetrade/AwsScripts/update_dir_on_workers.sh $src $tgt"
