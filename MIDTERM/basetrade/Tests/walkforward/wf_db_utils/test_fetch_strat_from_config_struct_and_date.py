...
class TestFetchStratFromConfigStructAndDate(unittest.TestCase):
    ...
    def test_fetch_strat_from_config_struct_and_date_type3(self):
        start_date = 20170501
        (shortcode, execlogic, modelname, paramname, start_time, end_time, strat_type, event_token,
         query_id) = fetch_strat_from_config_struct_and_date(self.type3_cfg, start_date, 1)
    ...
    def test_fetch_strat_from_config_struct_and_date_type6(self):
        tradingdate = 20170711
        # fetching model for 11july17 should give us sample model 4 weights.
        (shortcode, execlogic, modelname, paramname, start_time, end_time, strat_type, event_token,
         query_id) = fetch_strat_from_config_struct_and_date(self.type6_cfg, tradingdate, 1)
