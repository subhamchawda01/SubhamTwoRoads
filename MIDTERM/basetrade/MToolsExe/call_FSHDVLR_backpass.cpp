...
int main(int argc, char** argv) {
  ...
  std::vector<std::vector<double> > train_data_orig_independants_ = train_data_independants_;

  FSHDVLR_SO_NoMeanData_Backpass(train_data_orig_dependant_, train_data_orig_independants_, train_data_dependant_,
                                 train_data_independants_, must_add_next_k_indeps_, in_included_, finmodel_,
                                 min_correlation_, max_indep_correlation_, initial_correlations_, max_model_size_, 1.0,
