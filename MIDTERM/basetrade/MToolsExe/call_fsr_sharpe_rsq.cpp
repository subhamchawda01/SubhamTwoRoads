/**
    \file MToolsExe/call_fsr_sharpe_rsq.cpp
...
/// call FSR_sharpe_rsq ( on data that is mean zero to save needless mean calcing operations )
/// FSR_sharpe_rsq selects the indicator (X_i) that has the highest mean * abs(sharpe) variance reduction of residual
...
int main(int argc, char** argv) {
  ...
  if (stdev_orig_dependant_ > 0.00000001) {
    FSR_sharpe_rsq(train_data_dependant_, train_data_independants_, must_add_next_k_indeps_, in_included_, finmodel_,
