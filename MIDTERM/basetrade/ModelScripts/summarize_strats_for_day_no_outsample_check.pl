...
my $GLOBALRESULTSDBDIR="DB"; # Changed for DVCTrader ... so that it does not clash with others
...
my $trading_start_yyyymmdd_ = CalcPrevWorkingDateMult ( $trading_end_yyyymmdd_, $num_days_past_ , $shortcode_ , $skip_dates_file_);
