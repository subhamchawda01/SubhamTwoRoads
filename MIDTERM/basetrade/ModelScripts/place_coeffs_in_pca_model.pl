...
while ( my $regline_ = <REGOUTFILE> )
{
	...
	{
		my $this_index_ = $regwords_[1]-1;
		my $this_coeff_ = $regwords_[2];
		if($this_index_ >= 0 && $this_coeff_ != 0 )	
		{
...
$ilist_post_indicator_text_ = $ilist_post_indicator_text_."# RSquared: ".$model_rsquared_."\n";
$ilist_post_indicator_text_ = $ilist_post_indicator_text_."# Correlation: ".$model_corr_."\n";
$ilist_post_indicator_text_ = $ilist_post_indicator_text_."# StdevModel: ".$model_stdev_."\n";
$ilist_post_indicator_text_ = $ilist_post_indicator_text_."# MSE: ".$model_mse_."\n";
