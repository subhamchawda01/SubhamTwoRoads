...
my $result_file_ = $DESTINATION_PATH_."/portfolio_data_tr_".$timezone_.".txt";
...
sub WriteResultsToFile 
{
  ...
  print $main_log_file_handle_ "WriteResultsToFile: $result_file_\n"; 
...
# Currenlty dividing into are 4 timezones, UTC 0-6,6-12,12-18,18-00
  ...
  print STDERR " $utc_end_time_ $utc_start_time_ ";
  ...
  print STDERR " Returned TImezone : " .$timezone_."\n" ;
  $timezone_ ;
}
