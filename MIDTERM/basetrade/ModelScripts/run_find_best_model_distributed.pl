...
sub ReadConfigFile
{
    ...
    my $fbm_version_string_ = $find_best_model_version_?"v1:find_best_model_for_strategy_var_pert_distributed.pl":"v0:find_best_model_for_strategy_random_dates.pl";
