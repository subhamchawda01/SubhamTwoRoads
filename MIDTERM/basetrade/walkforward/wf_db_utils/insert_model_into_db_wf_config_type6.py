...
def insert_model_coeffs_in_db(init_model, model_file, configid, tradingdate, insert_model_if_not_found=False):
    """
    ...
    modelid = fetch_modelid_from_modelname(init_model, insert_model_if_not_found, configid)
...
def insert_model_coeffs_in_db_for_dicbt(init_model, model_file, configid, tradingdate, insert_model_if_not_found=False):
    modelid = fetch_modelid_from_modelname(init_model, insert_model_if_not_found, configid)
    model_desc = fetch_model_desc(modelid)
    table_entry = ""
    for i in range(0, 20):
