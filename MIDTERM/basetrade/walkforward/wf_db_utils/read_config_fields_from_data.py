...
def read_config_fields_from_data(config_struct, line):
    """
    ...
    :return: 
    """
    (config_struct.configid, config_struct.cname, config_struct.shortcode, config_struct.execlogic, config_struct.start_time,
     ...
     config_struct.structured_id) \
        = (int(line[wf_configs['configid']]), line[wf_configs['cname']], line[wf_configs['shortcode']],line[wf_configs['execlogic']],
