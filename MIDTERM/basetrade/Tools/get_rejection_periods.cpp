/**
   \file Tools/get_rejection_periods.cpp
...
int main(int argc, char** argv) {
  ...
  t_oss_ << output_dir_ << "/grp_log." << shortcode_ << "." << tradingdate_;
  ...
  HFSAT::ORSMessageStatsComputer::GetTimeToNumRejections(dbglogger_, sec_name_indexer_, tradingdate_, 0,
                                                         trading_location_,
