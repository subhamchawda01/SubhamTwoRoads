...
#ifndef BASE_TOOLS_T3PROCESSINGNEW_HPP
#define BASE_TOOLS_T3PROCESSINGNEW_HPP

namespace HFSAT {
class T3Processing_new : public Processing {
 protected:
 ...
 public:
  T3Processing_new(const std::string& input_data_filename_, SimpleLineProcessor& _simple_line_processor_,
