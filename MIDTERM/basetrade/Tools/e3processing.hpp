/**
   ...
   \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
    Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_TOOLS_E3PROCESSING_HPP
#define BASE_TOOLS_E3PROCESSING_HPP
#include "basetrade/Tools/timed_data_to_reg_data_common.hpp"

namespace HFSAT {

void E3Processing(const std::string& input_data_filename_, SimpleLineProcessor& simple_line_processor_,
  ...
  // int event_count1_to_predict_ = counters_to_predict_;
  // int event_count2_to_predict_ = 2 * counters_to_predict_;
  // int event_count3_to_predict_ = 3 * counters_to_predict_;
