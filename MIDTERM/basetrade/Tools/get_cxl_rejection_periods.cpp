/**
   \file Tools/get_cxl_rejection_periods.cpp
...
int main(int argc, char** argv) {
  ...
  t_oss_ << output_dir_ << "/glcrp_log." << shortcode_ << "." << tradingdate_;
  ...
  HFSAT::ORSMessageStatsComputer::GetTimeToNumCxlRejections(dbglogger_, sec_name_indexer_, tradingdate_, 0,
                                                            trading_location_,
