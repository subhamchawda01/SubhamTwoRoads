...
void SimpleBAwithMarket::DefLoop(unsigned int this_sid_number, const int _trade_px_,
  ...
  printf(
      "%*s %5s %3s %15s %7s X %7s %15s %3s %5s  %9s %6s %6s %5s %8s %6s %6s %9s %7s %6s %6s %6s %6s %8s %8s"
      "%6s %6s\n",
      16, "SYM", "BS", "BO", "BP", "BIP", "AIP", "AP", "AO", "AS", "S_BS", "S_BP", "S_AP", "S_AS", "T_PNL", "POS", "TV",
      "MV", "% v/V", "O_REJ", "E_REJ", "E_C_REJ", "C_REJ", "E_Re_Rej", "O_Re_Rej", "ORS", "RejRes");
    ...
    switch (this_smv_.secname()[0]) {
      ...
      case 'U': {
        ...
        if (this_smv_.this_smv_exch_source_ == HFSAT::kExchSourceMICEX ||
          ...
          printf(
              "%s%*s %5d %3d %15.7lf %7d X %7d %15.7lf %3d %5d  %9s %6s %6s %5s %8d %6d %6d %9lu %7.2lf %6d "
              "%6d %6d %6d %8d %8d %6d %6s\n",
              ...
              (int)prom_pnl_->total_pnl(), p_prom_order_manager_->global_position(),
...
// ================================================================
  ...
  HFSAT::IndexedTMXOBFOFMarketViewManager indexed_tmx_obf_of_market_view_manager_(dbglogger_, watch_, sec_name_indexer_,
                                                                                  sid_to_smv_ptr_map_);
  ...
  HFSAT::IndexedRtsOFMarketViewManager indexed_rts_of_market_view_manager_(dbglogger_, watch_, sec_name_indexer_,
                                                                           sid_to_smv_ptr_map_);
  ...
  combined_mds_messages_shm_processor_.AddDataSourceForProcessing(
      HFSAT::MDS_MSG::RTS_OF,
      (void*)((HFSAT::OrderGlobalListener<RTS_MDS::RTSOFCommonStructv2>*)(&indexed_rts_of_market_view_manager_)),
      &watch_);
  combined_mds_messages_shm_processor_.AddDataSourceForProcessing(
      HFSAT::MDS_MSG::MICEX_OF,
      (void*)((HFSAT::OrderGlobalListener<MICEX_OF_MDS::MICEXOFCommonStruct>*)(&indexed_micex_of_market_view_manager_)),
      &watch_);
  combined_mds_messages_shm_processor_.AddDataSourceForProcessing(
  ...
  combined_mds_messages_shm_processor_.AddDataSourceForProcessing(
      ...
      (void*)((HFSAT::OrderFeedGlobalListener*)(&indexed_ose_order_feed_market_view_manager_)), &watch_);
  combined_mds_messages_shm_processor_.AddDataSourceForProcessing(
  ...
  combined_mds_messages_shm_processor_.AddDataSourceForProcessing(
      // book building modification purpose
      HFSAT::MDS_MSG::TMX_OBF_OF, (void*)((HFSAT::OrderFeedGlobalListener*)(&indexed_tmx_obf_of_market_view_manager_)),
      &watch_);
