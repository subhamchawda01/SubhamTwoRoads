/**
   ...
   \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
    Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_TOOLS_E5PROCESSING_HPP
#define BASE_TOOLS_E5PROCESSING_HPP
...
void E5Processing(const std::string& input_data_filename_, SimpleLineProcessor& simple_line_processor_,
  ...
  int event_count1_to_predict_ = std::max(1, (counters_to_predict_ * 1) / 5);
  int event_count2_to_predict_ = std::max(1, (counters_to_predict_ * 2) / 5);
  int event_count3_to_predict_ = std::max(1, (counters_to_predict_ * 3) / 5);
  int event_count4_to_predict_ = std::max(1, (counters_to_predict_ * 4) / 5);
  int event_count5_to_predict_ = counters_to_predict_;
