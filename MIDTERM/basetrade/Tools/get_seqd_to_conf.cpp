/**
   \file Tools/get_seqd_to_conf.cpp
...
int main(int argc, char** argv) {
  ...
  t_oss_ << output_dir_ << "/gstc_log." << shortcode_ << "." << tradingdate_;
  ...
  HFSAT::ORSMessageStatsComputer::GetSeqdToConfTimes(dbglogger_, sec_name_indexer_, tradingdate_, 0, trading_location_,
