...
#define PAPI_VEC_INS \
  (PAPI_VEC_INS_idx | PAPI_PRESET_MASK) /*Vector/SIMD instructions executed (could include integer) */
...
#define PAPI_SP_OPS                                                                                            \
  (PAPI_SP_OPS_idx | PAPI_PRESET_MASK) /* Floating point operations executed; optimized to count scaled single \
                                          precision vector operations */
#define PAPI_DP_OPS                                                                                            \
  (PAPI_DP_OPS_idx | PAPI_PRESET_MASK) /* Floating point operations executed; optimized to count scaled double \
                                          precision vector operations */
