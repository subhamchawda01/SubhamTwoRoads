...
int main(int argc, char **argv) {
  ...
  if (argc < 5) {
    std::cerr << "expecting :\n"
              << " $postmarketexec pos_file_to_execute TRADINGDATE START_TIME TRIGGER_TIME PROGID" << '\n';
  ...
  CommonInitializer *common_intializer =
      new CommonInitializer(source_shortcode_list_, ors_shortcode_list_, tradingdate_, dbglogger_, true);
