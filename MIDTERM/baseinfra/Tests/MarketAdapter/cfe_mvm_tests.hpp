/**
   \file Tests/dvctrade/MarketAdapter/cme_mvm_tests.hpp
...
class CFEMvmTests : public CppUnit::TestFixture {
  /**
   * General testing framework,
   * Currently It reads inputs from a file and processes accordingly
   */
  CPPUNIT_TEST_SUITE(CFEMvmTests);
  CPPUNIT_TEST(TestCFEMvm);
