/**
   \file Tests/dvctrade/MarketAdapter/rts_mvm_tests.hpp
...
class MICEXMvmTests : public CppUnit::TestFixture {
  /**
   * General testing framework,
   * Currently It reads inputs from a file and processes accordingly
   */
  CPPUNIT_TEST_SUITE(MICEXMvmTests);
  CPPUNIT_TEST(TestMICEXMvm);
