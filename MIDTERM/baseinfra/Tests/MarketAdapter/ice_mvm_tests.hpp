/**
   \file Tests/dvctrade/MarketAdapter/ice_mvm_tests.hpp
...
class ICEMvmTests : public CppUnit::TestFixture {
  /**
   * General testing framework,
   * Currently It reads inputs from a file and processes accordingly
   */
  CPPUNIT_TEST_SUITE(ICEMvmTests);
  CPPUNIT_TEST(TestICEMvm);
