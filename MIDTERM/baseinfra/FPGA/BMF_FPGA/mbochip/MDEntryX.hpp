...
{// Message (X)
    ...
    union
    {
        ...
        OpeningPriceX_t      openingPrice;              ///< \brief Valid when \ref MDEntryType = '4' (OpeningPrice). Check if your API version supports this MDEntryType.
        ImbalanceX_t         imbalance;                 ///< \brief Valid when \ref MDEntryType = 'A' (Imbalance). Check if your API version supports this MDEntryType.
