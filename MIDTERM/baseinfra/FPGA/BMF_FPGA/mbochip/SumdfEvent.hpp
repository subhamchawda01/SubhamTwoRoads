...
struct InstrumentInfo_t {
    ...
    unsigned int StatusMDEntryDate;                 ///< \brief Date of last instrument status update. Valid when \ref initializedBySnapshot is true
    unsigned int StatusMDEntryTime;                 ///< \brief Time of last instrument status update. Valid when \ref initializedBySnapshot is true
...
struct Instrument_t {
    ...
    OpeningPrice_t              openingPrice;               ///< \brief Current \b OpeningPrice information. Check if your API version supports this MDEntryType.
    TheoreticalOpeningPrice_t   theoreticalOpeningPrice;    ///< \brief Current \b TheoreticalOpeningPrice information. Check if your API version supports this MDEntryType.
    Imbalance_t                 imbalance;                  ///< \brief Current \b TheoreticalOpeningPrice information. Check if your API version supports this MDEntryType.
...
struct Events_t {
    ...
    std::vector<BVMF::MDEntryInit_t> MDEntriesInit;     ///< \brief Vector of MDEntries received on snapshot. Valid when \ref eventsReturned is MDENTRIES_INIT_ONLY.
    BVMF::PUMA_1_6::MDEntriesX_t MDEntries_PUMA_1_6;    ///< \brief MDEntries struct from PUMA 1.6 incremental messages. Valid when \ref eventsReturned is BOOK_AND_MDENTRIES_BVMF_PUMA_1_6, MDENTRIES_ONLY_BVMF_PUMA_1_6.
    BVMF::PUMA_2_0::MDEntriesX_t MDEntries_PUMA_2_0;    ///< \brief MDEntries struct from PUMA 2.0 incremental messages. Valid when \ref eventsReturned is BOOK_AND_MDENTRIES_BVMF_PUMA_2_0, MDENTRIES_ONLY_BVMF_PUMA_2_0.
    Instrument_t * bookAndInstrumentInfo;               ///< \brief Pointer to book and instruments information. Valid when \ref eventsReturned is BOOK_AND_MDENTRIES_BVMF_PUMA_1_6, BOOK_AND_MDENTRIES_BVMF_PUMA_2_0, BOOK_ONLY_BVMF_PUMA_1_6, BOOK_ONLY_BVMF_PUMA_2_0 or BOOK_ONLY
    unsigned incremental_MsgSeqNum;                     ///< \brief The MsgSeqNum of incremental message. Valid when \ref eventsReturned is BOOK_AND_MDENTRIES_BVMF_PUMA_1_6, BOOK_AND_MDENTRIES_BVMF_PUMA_2_0, BOOK_ONLY_BVMF_PUMA_1_6, BOOK_ONLY_BVMF_PUMA_2_0 or BOOK_ONLY
    std::tr1::unordered_map<Uint64 ,Instrument_t> * instrumentList; ///< \brief Pointer to the instrument list of the channel. Valid when \ref eventsReturned is INSTRUMENT_LIST
    std::tr1::unordered_map<std::string, Group_t> * groupList;      ///< \brief Pointer to the group list of the channel. Valid when \ref eventsReturned is INSTRUMENT_LIST
    std::vector<InstrumentUpdate_t> instrumentUpdates;  ///< \brief Vector of instrument updates. Valid when \ref eventsReturned is INSTRUMENT_UPDATES
    InstrumentStatus_t instrumentStatus;                ///< \brief Informs instrument status modifications. Valid when \ref eventsReturned is INSTRUMENT_STATUS
    GroupStatus_t groupStatus;                          ///< \brief Informs group status modifications. Valid when \ref eventsReturned is GROUP_STATUS
