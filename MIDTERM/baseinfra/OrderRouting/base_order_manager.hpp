...
#define REJECT_COOLOFF_MSECS 20
...
class BaseOrderManager : public OrderNotFoundListener,
 ...
 protected:
  ...
  int last_cancel_caos;
  TradeType_t last_order_buysell;
 ...
 public:
  ...
  inline bool Cancel(BaseOrder& t_this_order_) {
    ...
    if (cancel_order_.CanBeCanceled(watch_.msecs_from_midnight() - CXL_WAIT_MSECS,
      ...
      last_cancel_caos = cancel_order_.client_assigned_order_sequence();
      last_order_buysell =  cancel_order_.buysell_;
