/**
    \file MDSMessages/sgx_pf_logged_message_filesource.hpp
...
class SGXPFLoggedMessageFileSource : public ExternalDataListener {
 protected:
 ...
 public:
   ...
   */
  SGXPFLoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
