/**
   \file LoggedSources/eobi_price_feed_logged_message_filesource.hpp
...
class EOBIPriceFeedLoggedMessageFileSource : public ExternalDataListener {
 protected:
 ...
 public:
   ...
   */
  EOBIPriceFeedLoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
  ...
  ~EOBIPriceFeedLoggedMessageFileSource() {}
