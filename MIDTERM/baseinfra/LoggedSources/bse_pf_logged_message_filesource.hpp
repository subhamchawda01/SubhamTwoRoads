#ifndef _BSE_PF_LOGGED_MESSAGE_FILESOURCE_
#define _BSE_PF_LOGGED_MESSAGE_FILESOURCE_

/**
    \file MDSMessages/bse_pf_logged_message_filesource.hpp
...
class BSEPFLoggedMessageFileSource : public ExternalDataListener {
 protected:
  ...
  BSE_MDS::BSEPFCommonStruct next_event_;
 ...
 public:
   ...
   */
  BSEPFLoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
