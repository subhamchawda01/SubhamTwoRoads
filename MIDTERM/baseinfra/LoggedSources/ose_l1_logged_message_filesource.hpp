/**
    \file LoggedSources/ose_l1_logged_message_filesource.hpp
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_MDSMESSAGES_OSE_L1_LOGGED_MESSAGE_FILESOURCE_H
#define BASE_MDSMESSAGES_OSE_L1_LOGGED_MESSAGE_FILESOURCE_H
...
/// @brief reads OSE logged data stored in file for this { symbol, tradingdate }
/// Reads OSE_MDS::OSEPLCommonStruct
///    depending on OSE_MDS::OSEPLCommonStruct::msgType
///    and for msgType == OSE_MDS::OSE_DELTA
///        depending on OSE_MDS::OSEPLCommonStruct::data_::ose_dels_::action_
///        calls the listeners, if any, of the security, action_
class OSEL1LoggedMessageFileSource : public ExternalDataListener {
 protected:
  ...
  FullBookGlobalListener*
      p_full_book_global_listener_;  ///< Listeners of CME messages recorded in LiveTrading of all types
 ...
 public:
   ...
   */
  OSEL1LoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
...
#endif  // BASE_MDSMESSAGES_OSE_L1_LOGGED_MESSAGE_FILESOURCE_H
