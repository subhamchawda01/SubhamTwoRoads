/**
    \file MDSMessages/CHIX_logged_message_filenamer.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_MDSMESSAGES_CHIX_L1_LOGGED_MESSAGE_FILENAMER_H
#define BASE_MDSMESSAGES_CHIX_L1_LOGGED_MESSAGE_FILENAMER_H
...
/// Returns the name of the data file where CHIX MDS has logged data
/// Typically it will be of the format /NAS1/data/CHIXLoggedData/CHIX/2011/05/01/DOLM11_20110501
class CHIXL1LoggedMessageFileNamer {
 public:
  ...
  static std::string GetName(const char* _exchange_symbol_, const unsigned int _preevent_YYYYMMDD_,
    ...
    static std::string logging_dir = "/NAS1/data/CHIX_L1LoggedData/";
...
#endif  // BASE_MDSMESSAGES_CHIX_LOGGED_MESSAGE_FILENAMER_H
