/**
   ...
   +91 80 4190 3551
 */
#ifndef BASE_MDSMESSAGES_RTS_LOGGED_MESSAGE_FILESOURCE_H
#define BASE_MDSMESSAGES_RTS_LOGGED_MESSAGE_FILESOURCE_H
...
/// @brief reads RTS-EBS logged data stored in file for this { symbol, tradingdate }
/// Reads RTS_MDS::RTSCommonStruct
///    depending on RTS_MDS::RTSCommonStruct::msgType
///    and for msgType == RTS_MDS::RTS_DELTA
///        depending on RTS_MDS::RTSCommonStruct::data_::rts_dels_::action_
///        calls the listeners, if any, of the security, action_
class RTSLoggedMessageFileSource : public ExternalDataListener {
 protected:
  ...
  std::vector<RTS_MDS::RTSCommonStruct> event_queue_;
  int events_left_;
 ...
 public:
   ...
   */
  RTSLoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
