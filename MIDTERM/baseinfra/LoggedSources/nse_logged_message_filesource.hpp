...
class NSELoggedMessageFileSource : public ExternalDataListener {
 protected:
 ...
 public:
   ...
   */
  NSELoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
