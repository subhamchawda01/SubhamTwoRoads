/**
    \file MDSMessages/ose_pf_logged_message_filesource.hpp
...
class OSEPFLoggedMessageFileSource : public ExternalDataListener {
 protected:
 ...
 public:
   ...
   */
  OSEPFLoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
  ...
  inline bool IsNormalTradeTime(int security_id, ttime_t tv) {
    return trade_time_manager_.isValidTimeToTrade(security_id, tv.tv_sec % 86400);
  }
