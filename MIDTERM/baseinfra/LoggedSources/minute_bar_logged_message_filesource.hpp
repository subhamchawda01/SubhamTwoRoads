/**
    \file LoggedSources/minute_bar_logged_message_filesource.hpp
...
#include "baseinfra/LoggedSources/minute_bar_logged_message_filenamer.hpp"
...
class MinuteBarLoggedMessageFileSource : public ExternalDataListener {
 public:
  /**
   ...
   */
  MinuteBarLoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
  ...
  void SetMinuteBarDataListener(MinuteBarDataListener* listener);
 ...
 protected:
  ...
  MinuteBarDataListener* listener_;
