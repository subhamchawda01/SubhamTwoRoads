/**
   \file LoggedSources/micex_logged_message_filesource.hpp
   ...
   +91 80 4190 3551
 */
#ifndef BASE_MDSMESSAGES_MICEX_LOGGED_MESSAGE_FILESOURCE_H
#define BASE_MDSMESSAGES_MICEX_LOGGED_MESSAGE_FILESOURCE_H
...
/// Reads MICEX_MDS::MICEXCommonStruct
///    depending on MICEX_MDS::MICEXCommonStruct::msgType
///    and for msgType == MICEX_MDS::MICEX_DELTA
///        depending on MICEX_MDS::MICEXCommonStruct::data_::micex_dels_::action_
///        calls the listeners, if any, of the security, action_
class MICEXLoggedMessageFileSource : public ExternalDataListener {
 protected:
  ...
  std::vector<MICEX_MDS::MICEXCommonStruct> event_queue_;
  int events_left_;
 ...
 public:
   ...
   */
  MICEXLoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
...
#endif  // BASE_MDSMESSAGES_MICEX_LOGGED_MESSAGE_FILESOURCE_H
