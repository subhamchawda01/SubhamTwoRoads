/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_EXECLOGIC_PRICE_BASED_AGGRESSIVE_TRADING_H
#define BASE_EXECLOGIC_PRICE_BASED_AGGRESSIVE_TRADING_H
...
class PriceBasedAggressiveTrading : virtual public BaseTrading {
 protected:
 public:
  PriceBasedAggressiveTrading(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  ~PriceBasedAggressiveTrading(){};  ///< destructor not made virtual ... please do so when making child classes

  static std::string StrategyName() {
    return "PriceBasedAggressiveTrading";
