/**
    \file ExecLogic/returns_based_aggressive_trading.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_EXECLOGIC_RETURNS_BASED_AGGRESSIVE_TRADING_H
#define BASE_EXECLOGIC_RETURNS_BASED_AGGRESSIVE_TRADING_H
...
class ReturnsBasedAggressiveTrading : public virtual BaseTrading {
 protected:
 public:
  ReturnsBasedAggressiveTrading(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  ~ReturnsBasedAggressiveTrading(){};  ///< destructor not made virtual ... please do so when making child classes

  static std::string StrategyName() {
    return "ReturnsBasedAggressiveTrading";
...
#endif  // BASE_EXECLOGIC_RETURNS_BASED_AGGRESSIVE_TRADING_H
