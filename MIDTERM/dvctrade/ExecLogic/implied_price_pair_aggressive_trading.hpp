/**
    \file ExecLogic/implied_price_pair_aggressive_trading.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_EXECLOGIC_IMPLIED_PRICE_PAIR_AGGRESSIVE_TRADING_H
#define BASE_EXECLOGIC_IMPLIED_PRICE_PAIR_AGGRESSIVE_TRADING_H
...
class ImpliedPricePairAggressiveTrading : public virtual BaseTrading {
 public:
 ...
 protected:
 public:
  ImpliedPricePairAggressiveTrading(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  ~ImpliedPricePairAggressiveTrading(){};  ///< destructor not made virtual ... please do so when making child classes

  static std::string StrategyName() {
    return "ImpliedPricePairAggressiveTrading";
...
#endif  // BASE_EXECLOGIC_IMPLIED_PRICE_PAIR_AGGRESSIVE_TRADING_H
