/**
    \file ExecLogic/event_price_based_aggressive_trading.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_EXECLOGIC_EVENT_PRICE_BASED_AGGRESSIVE_TRADING_H
#define BASE_EXECLOGIC_EVENT_PRICE_BASED_AGGRESSIVE_TRADING_H
...
class EventPriceBasedAggressiveTrading : public virtual BaseTrading {
 protected:
 public:
  EventPriceBasedAggressiveTrading(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  ~EventPriceBasedAggressiveTrading(){};  ///< destructor not made virtual ... please do so when making child classes

  static std::string StrategyName() {
    return "EventPriceBasedAggressiveTrading";
...
#endif  // BASE_EXECLOGIC_EVENT_PRICE_BASED_AGGRESSIVE_TRADING_H
