/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_EXECLOGIC_DIRECTIONAL_INTERVENTION_AGGRESSIVE_TRADING_H
#define BASE_EXECLOGIC_DIRECTIONAL_INTERVENTION_AGGRESSIVE_TRADING_H
...
class DirectionalInterventionAggressiveTrading : public virtual BaseTrading {
 protected:
 public:
  ...
  static std::string StrategyName() {
    return "DirectionalInterventionAggressiveTrading";
...
#endif  // BASE_EXECLOGIC_DIRECTIONAL_INTERVENTION_AGGRESSIVE_TRADING_H
