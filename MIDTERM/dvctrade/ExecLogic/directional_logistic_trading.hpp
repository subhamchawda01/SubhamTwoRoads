/**
    \file ExecLogic/directional_logistic_trading.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_EXECLOGIC_DIRECTIONAL_LOGISTIC_TRADING_H
#define BASE_EXECLOGIC_DIRECTIONAL_LOGISTIC_TRADING_H
...
class DirectionalLogisticTrading : public virtual BaseTrading {
 protected:
 public:
  DirectionalLogisticTrading(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  static std::string StrategyName() {
    return "DirectionalLogisticTrading";
...
#endif  // BASE_EXECLOGIC_DIRECTIONAL_LOGISTIC_TRADING_H
