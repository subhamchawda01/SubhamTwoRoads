/**
    \file ExecLogic/price_based_security_aggressive_trading.hpp
...
#ifndef BASE_EXECLOGIC_PRICE_BASED_SECURITY_AGGRESSIVE_TRADING_H
#define BASE_EXECLOGIC_PRICE_BASED_SECURITY_AGGRESSIVE_TRADING_H
...
class PriceBasedSecurityAggressiveTrading : public virtual BaseTrading {
 public:
 ...
 public:
  PriceBasedSecurityAggressiveTrading(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  ~PriceBasedSecurityAggressiveTrading(){};  ///< destructor not made virtual ... please do so when making child classes

  static std::string StrategyName() {
    return "PriceBasedSecurityAggressiveTrading";
...
#endif  // BASE_EXECLOGIC_PRICE_BASED_SECURITY_AGGRESSIVE_TRADING_H
