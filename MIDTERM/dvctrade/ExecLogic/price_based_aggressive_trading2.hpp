/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_EXECLOGIC_PRICE_BASED_AGGRESSIVE_TRADING2_H
#define BASE_EXECLOGIC_PRICE_BASED_AGGRESSIVE_TRADING2_H
...
class PriceBasedAggressiveTrading2 : virtual public BaseTrading {
 protected:
  int band_lower_bid_px_;
  int band_lower_ask_px_;

  int existing_bid_int_price_;
  int existing_ask_int_price_;

 public:
  PriceBasedAggressiveTrading2(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  ~PriceBasedAggressiveTrading2(){};  ///< destructor not made virtual ... please do so when making child classes

  static std::string StrategyName() {
    return "PriceBasedAggressiveTrading2";
 ...
 protected:
  ...
  void SetBidSideDirectives();
  void SetAskSideDirectives();

  bool CanProcessBidSide();
  bool CanProcessAskSide();

  bool CanPlaceBestBid();
  bool CanPlaceBestAsk();

  bool CanPlaceBidAggress();
  bool CanPlaceAskAggress();

  bool CanPlaceBidImprove();
  bool CanPlaceAskImprove();

  void ManageBidOrders();
  void ManageAskOrders();
};
}
