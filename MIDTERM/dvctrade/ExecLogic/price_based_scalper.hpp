/**
    \file ExecLogic/price_based_scalper.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_EXECLOGIC_PRICE_BASED_SCALPER_H
#define BASE_EXECLOGIC_PRICE_BASED_SCALPER_H
...
class PriceBasedScalper : public virtual BaseTrading {
 protected:
 public:
  PriceBasedScalper(DebugLogger& _dbglogger_, const Watch& _watch_, const SecurityMarketView& _dep_market_view_,
                    ...
                    EconomicEventsManager& t_economic_events_manager_, MarketUpdateManager& t_market_update_manager_,
  ...
  virtual ~PriceBasedScalper() {}

  static std::string StrategyName() {
    return "PriceBasedScalper";
...
#endif  // BASE_EXECLOGIC_PRICE_BASED_SCALPER_H
