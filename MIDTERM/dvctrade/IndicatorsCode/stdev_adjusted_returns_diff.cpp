...
void StdevAdjustedReturnsDiff::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
StdevAdjustedReturnsDiff* StdevAdjustedReturnsDiff::GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
                                                                      const std::vector<const char*>& r_tokens_,
  ...
  if (r_tokens_.size() < 8) {
    ExitVerbose(kModelCreationIndicatorLineLessArgs, t_dbglogger_,
                "INDICATOR weight StdevAdjustedReturnsDiff _dep_market_view_ _indep_market_view_ _fractional_seconds_ "
...
StdevAdjustedReturnsDiff* StdevAdjustedReturnsDiff::GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
  ...
  static std::map<std::string, StdevAdjustedReturnsDiff*> concise_indicator_description_map_;
  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new StdevAdjustedReturnsDiff(t_dbglogger_, r_watch_, concise_indicator_description_, _dep_market_view_,
                                     _indep_market_view_, _indicator_duration_, _stdev_duration_, _price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

StdevAdjustedReturnsDiff::StdevAdjustedReturnsDiff(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void StdevAdjustedReturnsDiff::OnIndicatorUpdate(const unsigned int& _indicator_index_,
...
void StdevAdjustedReturnsDiff::WhyNotReady() {
  if (!is_ready_) {
...
void StdevAdjustedReturnsDiff::OnMarketUpdate(const unsigned int _security_id_,
...
void StdevAdjustedReturnsDiff::InitializeValues() {
...
void StdevAdjustedReturnsDiff::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void StdevAdjustedReturnsDiff::OnMarketDataResumed(const unsigned int _security_id_) {
