/**
    \file IndicatorsCode/online_computed_cutoff_pair_port.cpp
...
void OnlineComputedCutoffPairPort::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
OnlineComputedCutoffPairPort* OnlineComputedCutoffPairPort::GetUniqueInstance(DebugLogger& t_dbglogger_,
  ...
  if (r_tokens_.size() < 7) {
    ExitVerbose(kModelCreationIndicatorLineLessArgs, t_dbglogger_,
                "INDICATOR weight OnlineComputedCutoffPairPort _dep_shortcode_ _indep_shortcode_ "
...
OnlineComputedCutoffPairPort* OnlineComputedCutoffPairPort::GetUniqueInstance(
  ...
  static std::map<std::string, OnlineComputedCutoffPairPort*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OnlineComputedCutoffPairPort(t_dbglogger_, r_watch_, concise_indicator_description_, _dep_market_view_,
                                         _portfolio_descriptor_shortcode_, _fractional_seconds_, _price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

OnlineComputedCutoffPairPort::OnlineComputedCutoffPairPort(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OnlineComputedCutoffPairPort::OnPortfolioPriceChange(double _new_price_) {
...
void OnlineComputedCutoffPairPort::OnMarketUpdate(
...
void OnlineComputedCutoffPairPort::UpdateComputedVariables() {
...
void OnlineComputedCutoffPairPort::OnPortfolioPriceReset(double t_new_portfolio_price_, double t_old_portfolio_price_,
...
void OnlineComputedCutoffPairPort::InitializeValues() {
...
void OnlineComputedCutoffPairPort::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OnlineComputedCutoffPairPort::OnMarketDataResumed(const unsigned int _security_id_) {
  InitializeValues();
  data_interrupted_ = false;
}
}
