...
void OfflineBreakoutAdjustedPairsPort::CollectShortCodes(
...
OfflineBreakoutAdjustedPairsPort* OfflineBreakoutAdjustedPairsPort::GetUniqueInstance(
...
OfflineBreakoutAdjustedPairsPort* OfflineBreakoutAdjustedPairsPort::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineBreakoutAdjustedPairsPort*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OfflineBreakoutAdjustedPairsPort(
...
OfflineBreakoutAdjustedPairsPort::OfflineBreakoutAdjustedPairsPort(
    ...
    : CommonIndicator(t_dbglogger_, r_watch_, concise_indicator_description_),
      ...
      indep_scaled_volume_calculator_(*(RecentScaledVolumeCalculatorPort::GetUniqueInstance(
      ...
      scaled_dep_volume_(0),
      scaled_indep_volume_(0),
      pred_mode_(1u),
...
void OfflineBreakoutAdjustedPairsPort::OnScaledVolumeUpdate(const unsigned int r_security_id_,
...
void OfflineBreakoutAdjustedPairsPort::OnIndicatorUpdate(const unsigned int& t_indicator_index_,
...
void OfflineBreakoutAdjustedPairsPort::WhyNotReady() {
  if (!is_ready_) {
...
void OfflineBreakoutAdjustedPairsPort::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineBreakoutAdjustedPairsPort::UpdateLRInfo() {
