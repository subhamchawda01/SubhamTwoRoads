/**
    \file IndicatorsCode/online_ratio_projected_price_diff.cpp
...
void OnlineRatioProjectedPriceDiff::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
OnlineRatioProjectedPriceDiff* OnlineRatioProjectedPriceDiff::GetUniqueInstance(
...
OnlineRatioProjectedPriceDiff* OnlineRatioProjectedPriceDiff::GetUniqueInstance(
  ...
  static std::map<std::string, OnlineRatioProjectedPriceDiff*> concise_indicator_description_map_;
  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OnlineRatioProjectedPriceDiff(t_dbglogger_, r_watch_, concise_indicator_description_, _dep_market_view_,
                                          _indep_market_view_, _fractional_seconds_, _price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

OnlineRatioProjectedPriceDiff::OnlineRatioProjectedPriceDiff(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OnlineRatioProjectedPriceDiff::OnMarketUpdate(const unsigned int t_security_id_,
  ...
  if (!is_ready_) {
    ...
    indicator_value_ = moving_avg_ratio_ * current_indep_price_ - current_dep_price_;
...
void OnlineRatioProjectedPriceDiff::InitializeValues() {
...
void OnlineRatioProjectedPriceDiff::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OnlineRatioProjectedPriceDiff::OnMarketDataResumed(const unsigned int _security_id_) {
  if (indep_market_view_.security_id() == _security_id_) {
    InitializeValues();
