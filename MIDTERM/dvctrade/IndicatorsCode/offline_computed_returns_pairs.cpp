...
void OfflineComputedReturnsPairs::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
OfflineComputedReturnsPairs* OfflineComputedReturnsPairs::GetUniqueInstance(DebugLogger& t_dbglogger_,
...
OfflineComputedReturnsPairs* OfflineComputedReturnsPairs::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineComputedReturnsPairs*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OfflineComputedReturnsPairs(t_dbglogger_, r_watch_, concise_indicator_description_, t_dep_market_view_,
                                        t_indep_market_view_, t_fractional_seconds_, t_price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

OfflineComputedReturnsPairs::OfflineComputedReturnsPairs(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OfflineComputedReturnsPairs::OnIndicatorUpdate(const unsigned int& t_indicator_index_,
...
void OfflineComputedReturnsPairs::WhyNotReady() {
  if (!is_ready_) {
...
void OfflineComputedReturnsPairs::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineComputedReturnsPairs::OnMarketDataResumed(const unsigned int _security_id_) {
  if (_security_id_ == indep_market_view_.security_id()) {
    InitializeValues();
...
void OfflineComputedReturnsPairs::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineComputedReturnsPairs::UpdateLRInfo() {
