/**
    \file IndicatorsCode/offline_computed_pairs_mktevents_port.cpp
...
void OfflineComputedPairsMktEventsPort::CollectShortCodes(
...
OfflineComputedPairsMktEventsPort* OfflineComputedPairsMktEventsPort::GetUniqueInstance(
  ...
  if (r_tokens_.size() < 7) {
    ExitVerbose(kModelCreationIndicatorLineLessArgs, t_dbglogger_,
                "INDICATOR weight OfflineComputedPairsMktEventsPort _dep_market_view_ _indep_market_view_ "
...
OfflineComputedPairsMktEventsPort* OfflineComputedPairsMktEventsPort::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineComputedPairsMktEventsPort*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OfflineComputedPairsMktEventsPort(
...
OfflineComputedPairsMktEventsPort::OfflineComputedPairsMktEventsPort(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OfflineComputedPairsMktEventsPort::OnIndicatorUpdate(const unsigned int& _indicator_index_,
...
void OfflineComputedPairsMktEventsPort::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineComputedPairsMktEventsPort::UpdateLRInfo() {
...
void OfflineComputedPairsMktEventsPort::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineComputedPairsMktEventsPort::OnMarketDataResumed(const unsigned int _security_id_) {
  InitializeValues();
