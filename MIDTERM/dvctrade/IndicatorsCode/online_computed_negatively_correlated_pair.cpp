/**
    \file IndicatorsCode/online_computed_negatively_correlated_pair.cpp
...
void OnlineComputedNegativelyCorrelatedPair::CollectShortCodes(
...
OnlineComputedNegativelyCorrelatedPair* OnlineComputedNegativelyCorrelatedPair::GetUniqueInstance(
...
OnlineComputedNegativelyCorrelatedPair* OnlineComputedNegativelyCorrelatedPair::GetUniqueInstance(
  ...
  static std::map<std::string, OnlineComputedNegativelyCorrelatedPair*> concise_indicator_description_map_;
  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OnlineComputedNegativelyCorrelatedPair(
...
OnlineComputedNegativelyCorrelatedPair::OnlineComputedNegativelyCorrelatedPair(
...
void OnlineComputedNegativelyCorrelatedPair::OnMarketUpdate(const unsigned int t_security_id_,
  ...
  if (!is_ready_) {
    ...
    if (moving_avg_indep_indep_price_ > 1.00) {  // added to prevent nan
      ...
      // Main difference from OnlineComputedNegativelyCorrelatedPairs
...
void OnlineComputedNegativelyCorrelatedPair::InitializeValues() {
...
void OnlineComputedNegativelyCorrelatedPair::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OnlineComputedNegativelyCorrelatedPair::OnMarketDataResumed(const unsigned int _security_id_) {
  if (indep_market_view_.security_id() == _security_id_) {
    InitializeValues();
