/**
    \file IndicatorsCode/stud_price_returns_diff_port.cpp
...
void StudPriceReturnsDiffPort::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
StudPriceReturnsDiffPort* StudPriceReturnsDiffPort::GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
                                                                      const std::vector<const char*>& r_tokens_,
  ...
  if (r_tokens_.size() < 8) {
    ExitVerbose(kModelCreationIndicatorLineLessArgs, t_dbglogger_,
                "INDICATOR weight StudPriceReturnsDiffPort _dep_market_view_ _portfolio_ _fractional_seconds_ "
...
StudPriceReturnsDiffPort* StudPriceReturnsDiffPort::GetUniqueInstance(
  ...
  static std::map<std::string, StudPriceReturnsDiffPort*> concise_indicator_description_map_;
  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new StudPriceReturnsDiffPort(
...
StudPriceReturnsDiffPort::StudPriceReturnsDiffPort(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void StudPriceReturnsDiffPort::OnIndicatorUpdate(const unsigned int& _indicator_index_, const double& _new_value_) {
...
void StudPriceReturnsDiffPort::WhyNotReady() {
  if (!is_ready_) {
...
void StudPriceReturnsDiffPort::OnMarketUpdate(const unsigned int _security_id_,
...
void StudPriceReturnsDiffPort::OnPortfolioPriceChange(double _new_price_) {
...
void StudPriceReturnsDiffPort::UpdateComputedVariables() {
  if (watch_.msecs_from_midnight() - last_new_page_msecs_ < page_width_msecs_) {
...
void StudPriceReturnsDiffPort::OnPortfolioPriceReset(double t_new_portfolio_price_, double t_old_portfolio_price_,
...
void StudPriceReturnsDiffPort::SetTimeDecayWeights() {
...
void StudPriceReturnsDiffPort::InitializeValues() {
...
void StudPriceReturnsDiffPort::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void StudPriceReturnsDiffPort::OnMarketDataResumed(const unsigned int _security_id_) {
