...
void OnlineComputedPairPort::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
OnlineComputedPairPort* OnlineComputedPairPort::GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
                                                                  const std::vector<const char*>& r_tokens_,
...
OnlineComputedPairPort* OnlineComputedPairPort::GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
  ...
  static std::map<std::string, OnlineComputedPairPort*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OnlineComputedPairPort(t_dbglogger_, r_watch_, concise_indicator_description_, _dep_market_view_,
                                   _portfolio_descriptor_shortcode_, _fractional_seconds_, _price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

OnlineComputedPairPort::OnlineComputedPairPort(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OnlineComputedPairPort::OnPortfolioPriceChange(double _new_price_) {
...
void OnlineComputedPairPort::OnMarketUpdate(
...
void OnlineComputedPairPort::UpdateComputedVariables() {
...
void OnlineComputedPairPort::OnPortfolioPriceReset(double t_new_portfolio_price_, double t_old_portfolio_price_,
...
void OnlineComputedPairPort::InitializeValues() {
...
void OnlineComputedPairPort::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OnlineComputedPairPort::OnMarketDataResumed(const unsigned int _security_id_) {
  InitializeValues();
  data_interrupted_ = false;
}
}
