/**
   \file IndicatorsCode/offline_corradjusted_cutoff_pairs.cpp
...
void OfflineCorradjustedCutoffPairs::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
OfflineCorradjustedCutoffPairs* OfflineCorradjustedCutoffPairs::GetUniqueInstance(
...
OfflineCorradjustedCutoffPairs* OfflineCorradjustedCutoffPairs::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineCorradjustedCutoffPairs*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OfflineCorradjustedCutoffPairs(t_dbglogger_, r_watch_, concise_indicator_description_, _dep_market_view_,
                                           _indep_market_view_, _fractional_seconds_, _price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

OfflineCorradjustedCutoffPairs::OfflineCorradjustedCutoffPairs(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OfflineCorradjustedCutoffPairs::OnIndicatorUpdate(const unsigned int& t_indicator_index_,
...
void OfflineCorradjustedCutoffPairs::WhyNotReady() {
  if (!is_ready_) {
...
void OfflineCorradjustedCutoffPairs::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineCorradjustedCutoffPairs::OnMarketDataResumed(const unsigned int _security_id_) {
  if (_security_id_ == indep_market_view_.security_id()) {
    InitializeValues();
...
void OfflineCorradjustedCutoffPairs::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineCorradjustedCutoffPairs::UpdateLRInfo() {
