/**
    \file IndicatorsCode/offline_computed_cutoff_pairs.cpp
...
void OfflineComputedCutoffPairs::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
OfflineComputedCutoffPairs* OfflineComputedCutoffPairs::GetUniqueInstance(DebugLogger& t_dbglogger_,
...
OfflineComputedCutoffPairs* OfflineComputedCutoffPairs::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineComputedCutoffPairs*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OfflineComputedCutoffPairs(t_dbglogger_, r_watch_, concise_indicator_description_, t_dep_market_view_,
                                       t_indep_market_view_, t_fractional_seconds_, t_price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

OfflineComputedCutoffPairs::OfflineComputedCutoffPairs(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OfflineComputedCutoffPairs::OnIndicatorUpdate(const unsigned int& t_indicator_index_,
...
void OfflineComputedCutoffPairs::WhyNotReady() {
  if (!is_ready_) {
...
void OfflineComputedCutoffPairs::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineComputedCutoffPairs::OnMarketDataResumed(const unsigned int _security_id_) {
  if (_security_id_ == indep_market_view_.security_id()) {
    InitializeValues();
...
void OfflineComputedCutoffPairs::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineComputedCutoffPairs::UpdateLRInfo() {
