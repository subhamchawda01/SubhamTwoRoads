/**
   \file IndicatorsCode/offline_corradjusted_pairs.cpp
...
void OfflineCorradjustedPairs::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
OfflineCorradjustedPairs* OfflineCorradjustedPairs::GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
                                                                      const std::vector<const char*>& r_tokens_,
...
OfflineCorradjustedPairs* OfflineCorradjustedPairs::GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
  ...
  static std::map<std::string, OfflineCorradjustedPairs*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OfflineCorradjustedPairs(t_dbglogger_, r_watch_, concise_indicator_description_, _dep_market_view_,
                                     _indep_market_view_, _fractional_seconds_, _price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

OfflineCorradjustedPairs::OfflineCorradjustedPairs(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OfflineCorradjustedPairs::OnIndicatorUpdate(const unsigned int& t_indicator_index_,
...
void OfflineCorradjustedPairs::WhyNotReady() {
  if (!is_ready_) {
...
void OfflineCorradjustedPairs::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineCorradjustedPairs::OnMarketDataResumed(const unsigned int _security_id_) {
  if (_security_id_ == indep_market_view_.security_id()) {
    InitializeValues();
...
void OfflineCorradjustedPairs::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineCorradjustedPairs::UpdateLRInfo() {
