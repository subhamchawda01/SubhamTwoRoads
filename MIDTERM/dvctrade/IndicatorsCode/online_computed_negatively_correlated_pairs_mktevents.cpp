/**
    \file IndicatorsCode/online_computed_negatively_correlated_pairs_mktevents.cpp
...
void OnlineComputedNegativelyCorrelatedPairsMktEvents::CollectShortCodes(
...
OnlineComputedNegativelyCorrelatedPairsMktEvents* OnlineComputedNegativelyCorrelatedPairsMktEvents::GetUniqueInstance(
...
OnlineComputedNegativelyCorrelatedPairsMktEvents* OnlineComputedNegativelyCorrelatedPairsMktEvents::GetUniqueInstance(
  ...
  static std::map<std::string, OnlineComputedNegativelyCorrelatedPairsMktEvents*> concise_indicator_description_map_;
  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OnlineComputedNegativelyCorrelatedPairsMktEvents(t_dbglogger_, r_watch_, concise_indicator_description_,
...
OnlineComputedNegativelyCorrelatedPairsMktEvents::OnlineComputedNegativelyCorrelatedPairsMktEvents(
...
void OnlineComputedNegativelyCorrelatedPairsMktEvents::OnMarketUpdate(const unsigned int t_security_id_,
  ...
  if (!is_ready_) {
    ...
    if (moving_avg_indep_indep_price_ > 1.00) {  // added to prevent nan
      ...
      // Main difference from OnlineComputedNegativelyCorrelatedPairMktEvents
...
void OnlineComputedNegativelyCorrelatedPairsMktEvents::InitializeValues() {
...
void OnlineComputedNegativelyCorrelatedPairsMktEvents::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OnlineComputedNegativelyCorrelatedPairsMktEvents::OnMarketDataResumed(const unsigned int _security_id_) {
  if (indep_market_view_.security_id() == _security_id_) {
    InitializeValues();
