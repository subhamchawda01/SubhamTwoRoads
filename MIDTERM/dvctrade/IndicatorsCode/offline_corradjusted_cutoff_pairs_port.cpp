/**
    \file IndicatorsCode/offline_corradjusted_cutoff_pairs_port.cpp
...
void OfflineCorradjustedCutoffPairsPort::CollectShortCodes(
...
OfflineCorradjustedCutoffPairsPort* OfflineCorradjustedCutoffPairsPort::GetUniqueInstance(
...
OfflineCorradjustedCutoffPairsPort* OfflineCorradjustedCutoffPairsPort::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineCorradjustedCutoffPairsPort*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OfflineCorradjustedCutoffPairsPort(
...
OfflineCorradjustedCutoffPairsPort::OfflineCorradjustedCutoffPairsPort(
...
void OfflineCorradjustedCutoffPairsPort::OnIndicatorUpdate(const unsigned int& _indicator_index_,
...
void OfflineCorradjustedCutoffPairsPort::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineCorradjustedCutoffPairsPort::UpdateLRInfo() {
...
void OfflineCorradjustedCutoffPairsPort::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineCorradjustedCutoffPairsPort::OnMarketDataResumed(const unsigned int _security_id_) {
  InitializeValues();
