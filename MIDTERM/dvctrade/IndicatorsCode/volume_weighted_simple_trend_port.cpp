/**
    \file IndicatorsCode/volume_weighted_simple_trend_port.cpp
...
void VolumeWeightedSimpleTrendPort::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
                                                      std::vector<std::string>& _ors_source_needed_vec_,
                                                      const std::vector<const char*>& r_tokens_) {
  IndicatorUtil::AddPortfolioShortCodeVec((std::string)r_tokens_[3], _shortcodes_affecting_this_indicator_);
}

VolumeWeightedSimpleTrendPort* VolumeWeightedSimpleTrendPort::GetUniqueInstance(
...
VolumeWeightedSimpleTrendPort* VolumeWeightedSimpleTrendPort::GetUniqueInstance(
  ...
  static std::map<std::string, VolumeWeightedSimpleTrendPort*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new VolumeWeightedSimpleTrendPort(
...
VolumeWeightedSimpleTrendPort::VolumeWeightedSimpleTrendPort(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void VolumeWeightedSimpleTrendPort::WhyNotReady() {
  if (!is_ready_) {
...
void VolumeWeightedSimpleTrendPort::OnVolumeRatioUpdate(const unsigned int r_security_id_,
...
void VolumeWeightedSimpleTrendPort::OnScaledVolumeUpdate(const unsigned int r_security_id_,
...
void VolumeWeightedSimpleTrendPort::OnPortfolioPriceReset(double t_new_portfolio_price_, double t_old_portfolio_price_,
...
void VolumeWeightedSimpleTrendPort::OnPortfolioPriceChange(double _new_price_) {
...
void VolumeWeightedSimpleTrendPort::InitializeValues() {
...
void VolumeWeightedSimpleTrendPort::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void VolumeWeightedSimpleTrendPort::OnMarketDataResumed(const unsigned int _security_id_) {
  InitializeValues();
  data_interrupted_ = false;
}
}
