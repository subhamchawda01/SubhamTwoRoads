...
void VolumeRatioCalculatorPort2::CollectShortCodes(std::vector<std::string>& shortcodes_affecting_this_indicator,
...
VolumeRatioCalculatorPort2* VolumeRatioCalculatorPort2::GetUniqueInstance(DebugLogger& t_dbglogger,
                                                                          const Watch& r_watch,
                                                                          const std::vector<const char*>& r_tokens,
...
VolumeRatioCalculatorPort2* VolumeRatioCalculatorPort2::GetUniqueInstance(
  ...
  static std::map<std::string, VolumeRatioCalculatorPort2*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new VolumeRatioCalculatorPort2(t_dbglogger_, r_watch_, concise_indicator_description_,
                                       t_portfolio_descriptor_shortcode_, _fractional_seconds_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

VolumeRatioCalculatorPort2::VolumeRatioCalculatorPort2(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void VolumeRatioCalculatorPort2::OnVolumeRatioUpdate(const unsigned int array_index_,
