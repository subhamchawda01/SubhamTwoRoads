/**
    \file IndicatorsCode/offline_computed_cutoff_pairs_mktevents.cpp
...
void OfflineComputedCutoffPairsMktEvents::CollectShortCodes(
...
OfflineComputedCutoffPairsMktEvents* OfflineComputedCutoffPairsMktEvents::GetUniqueInstance(
...
OfflineComputedCutoffPairsMktEvents* OfflineComputedCutoffPairsMktEvents::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineComputedCutoffPairsMktEvents*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OfflineComputedCutoffPairsMktEvents(
...
OfflineComputedCutoffPairsMktEvents::OfflineComputedCutoffPairsMktEvents(
...
void OfflineComputedCutoffPairsMktEvents::OnIndicatorUpdate(const unsigned int& t_indicator_index_,
...
void OfflineComputedCutoffPairsMktEvents::WhyNotReady() {
  if (!is_ready_) {
...
void OfflineComputedCutoffPairsMktEvents::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineComputedCutoffPairsMktEvents::OnMarketDataResumed(const unsigned int _security_id_) {
  if (_security_id_ == indep_market_view_.security_id()) {
    InitializeValues();
...
void OfflineComputedCutoffPairsMktEvents::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineComputedCutoffPairsMktEvents::UpdateLRInfo() {
