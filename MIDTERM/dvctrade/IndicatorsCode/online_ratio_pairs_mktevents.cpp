/**
    \file IndicatorsCode/online_ratio_pairs_mktevents.cpp
...
void OnlineRatioPairsMktEvents::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
OnlineRatioPairsMktEvents* OnlineRatioPairsMktEvents::GetUniqueInstance(DebugLogger& t_dbglogger_,
...
OnlineRatioPairsMktEvents* OnlineRatioPairsMktEvents::GetUniqueInstance(
  ...
  static std::map<std::string, OnlineRatioPairsMktEvents*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OnlineRatioPairsMktEvents(t_dbglogger_, r_watch_, concise_indicator_description_, _dep_market_view_,
                                      _indep_market_view_, _num_events_halflife_, _price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

OnlineRatioPairsMktEvents::OnlineRatioPairsMktEvents(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OnlineRatioPairsMktEvents::OnMarketUpdate(const unsigned int t_security_id_,
...
void OnlineRatioPairsMktEvents::InitializeValues() {
  moving_avg_ratio_ = current_price_ratio_;

  indicator_value_ = 0;
}

void OnlineRatioPairsMktEvents::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OnlineRatioPairsMktEvents::OnMarketDataResumed(const unsigned int _security_id_) {
  if (indep_market_view_.security_id() == _security_id_) {
    InitializeValues();
