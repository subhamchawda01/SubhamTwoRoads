/**
    \file IndicatorsCode/offline_corradjusted_serban_port.cpp
...
void OfflineCorradjustedSerbanPort::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
OfflineCorradjustedSerbanPort* OfflineCorradjustedSerbanPort::GetUniqueInstance(
...
OfflineCorradjustedSerbanPort* OfflineCorradjustedSerbanPort::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineCorradjustedSerbanPort*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OfflineCorradjustedSerbanPort(
...
OfflineCorradjustedSerbanPort::OfflineCorradjustedSerbanPort(
...
void OfflineCorradjustedSerbanPort::OnIndicatorUpdate(const unsigned int& t_indicator_index_,
...
void OfflineCorradjustedSerbanPort::WhyNotReady() {
  if (!is_ready_) {
...
void OfflineCorradjustedSerbanPort::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineCorradjustedSerbanPort::UpdateLRInfo() {
