/**
    \file IndicatorsCode/offline_computed_returns_cutoff_pairs.cpp
...
void OfflineComputedReturnsCutoffPairs::CollectShortCodes(
...
OfflineComputedReturnsCutoffPairs* OfflineComputedReturnsCutoffPairs::GetUniqueInstance(
...
OfflineComputedReturnsCutoffPairs* OfflineComputedReturnsCutoffPairs::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineComputedReturnsCutoffPairs*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OfflineComputedReturnsCutoffPairs(
...
OfflineComputedReturnsCutoffPairs::OfflineComputedReturnsCutoffPairs(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OfflineComputedReturnsCutoffPairs::OnIndicatorUpdate(const unsigned int& t_indicator_index_,
...
void OfflineComputedReturnsCutoffPairs::WhyNotReady() {
  if (!is_ready_) {
...
void OfflineComputedReturnsCutoffPairs::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineComputedReturnsCutoffPairs::OnMarketDataResumed(const unsigned int _security_id_) {
  if (_security_id_ == indep_market_view_.security_id()) {
    InitializeValues();
...
void OfflineComputedReturnsCutoffPairs::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineComputedReturnsCutoffPairs::UpdateLRInfo() {
