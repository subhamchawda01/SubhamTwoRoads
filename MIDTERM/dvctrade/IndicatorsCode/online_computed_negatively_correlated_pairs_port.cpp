/**
    \file IndicatorsCode/online_computed_negatively_correlated_pairs_port.cpp
...
void OnlineComputedNegativelyCorrelatedPairsPort::CollectShortCodes(
...
OnlineComputedNegativelyCorrelatedPairsPort* OnlineComputedNegativelyCorrelatedPairsPort::GetUniqueInstance(
...
OnlineComputedNegativelyCorrelatedPairsPort* OnlineComputedNegativelyCorrelatedPairsPort::GetUniqueInstance(
  ...
  static std::map<std::string, OnlineComputedNegativelyCorrelatedPairsPort*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OnlineComputedNegativelyCorrelatedPairsPort(t_dbglogger_, r_watch_, concise_indicator_description_,
...
OnlineComputedNegativelyCorrelatedPairsPort::OnlineComputedNegativelyCorrelatedPairsPort(
...
void OnlineComputedNegativelyCorrelatedPairsPort::WhyNotReady() {
  if (!is_ready_) {
...
void OnlineComputedNegativelyCorrelatedPairsPort::OnPortfolioPriceChange(double _new_price_) {
...
void OnlineComputedNegativelyCorrelatedPairsPort::OnPortfolioPriceReset(double t_new_portfolio_price_,
...
void OnlineComputedNegativelyCorrelatedPairsPort::OnMarketUpdate(
...
void OnlineComputedNegativelyCorrelatedPairsPort::UpdateComputedVariables() {
  ...
  if (moving_avg_indep_indep_price_ > 1.00) {  // added to prevent nan
    ...
    // Main difference from OnlineComputedNegativelyCorrelatedPairPort
...
void OnlineComputedNegativelyCorrelatedPairsPort::InitializeValues() {
...
void OnlineComputedNegativelyCorrelatedPairsPort::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OnlineComputedNegativelyCorrelatedPairsPort::OnMarketDataResumed(const unsigned int _security_id_) {
  InitializeValues();
  data_interrupted_ = false;
}
}
