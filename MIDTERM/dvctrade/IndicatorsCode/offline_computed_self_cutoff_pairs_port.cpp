/**
    \file IndicatorsCode/offline_computed_self_cutoff_pairs_port.cpp
...
void OfflineComputedSelfCutoffPairsPort::CollectShortCodes(
...
OfflineComputedSelfCutoffPairsPort* OfflineComputedSelfCutoffPairsPort::GetUniqueInstance(
  ...
  if (r_tokens_.size() < 7) {
    ExitVerbose(kModelCreationIndicatorLineLessArgs, t_dbglogger_,
                "INDICATOR weight OfflineComputedSelfCutoffPairsPort _dep_market_view_ _indep_market_view_ "
                "_fractional_seconds_ _trend_fractional_seconds_ (optional) _price_type_ ");
  }
...
OfflineComputedSelfCutoffPairsPort* OfflineComputedSelfCutoffPairsPort::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineComputedSelfCutoffPairsPort*> concise_indicator_description_map_;
  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OfflineComputedSelfCutoffPairsPort(
...
OfflineComputedSelfCutoffPairsPort::OfflineComputedSelfCutoffPairsPort(
...
void OfflineComputedSelfCutoffPairsPort::OnIndicatorUpdate(const unsigned int& _indicator_index_,
  ...
  if (!is_ready_) {
    ...
    if (_indicator_index_ == 1u) {
      ...
      dep_cutoff_price_trend_ = _new_value_ * trend_duration_ratio_;
    }
...
void OfflineComputedSelfCutoffPairsPort::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineComputedSelfCutoffPairsPort::UpdateLRInfo() {
...
void OfflineComputedSelfCutoffPairsPort::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineComputedSelfCutoffPairsPort::OnMarketDataResumed(const unsigned int _security_id_) {
  InitializeValues();
