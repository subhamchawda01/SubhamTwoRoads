...
void OfflineBreakoutAdjustedPairs2::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
OfflineBreakoutAdjustedPairs2* OfflineBreakoutAdjustedPairs2::GetUniqueInstance(
...
OfflineBreakoutAdjustedPairs2* OfflineBreakoutAdjustedPairs2::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineBreakoutAdjustedPairs2*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OfflineBreakoutAdjustedPairs2(
...
OfflineBreakoutAdjustedPairs2::OfflineBreakoutAdjustedPairs2(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OfflineBreakoutAdjustedPairs2::OnVolumeRatioUpdate(const unsigned int r_security_id_,
...
void OfflineBreakoutAdjustedPairs2::OnIndicatorUpdate(const unsigned int& t_indicator_index_,
...
void OfflineBreakoutAdjustedPairs2::WhyNotReady() {
  if (!is_ready_) {
...
void OfflineBreakoutAdjustedPairs2::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineBreakoutAdjustedPairs2::OnMarketDataResumed(const unsigned int _security_id_) {
  if (_security_id_ == indep_market_view_.security_id()) {
    InitializeValues();
...
void OfflineBreakoutAdjustedPairs2::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineBreakoutAdjustedPairs2::UpdateLRInfo() {
