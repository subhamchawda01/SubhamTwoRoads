/**
    \file IndicatorsCode/offline_computed_cutoff_pairs_mktevents_port.cpp
...
void OfflineComputedCutoffPairsMktEventsPort::CollectShortCodes(
...
OfflineComputedCutoffPairsMktEventsPort* OfflineComputedCutoffPairsMktEventsPort::GetUniqueInstance(
  ...
  if (r_tokens_.size() < 7) {
    ExitVerbose(kModelCreationIndicatorLineLessArgs, t_dbglogger_,
                "INDICATOR weight OfflineComputedCutoffPairsMktEventsPort _dep_market_view_ _indep_market_view_ "
...
OfflineComputedCutoffPairsMktEventsPort* OfflineComputedCutoffPairsMktEventsPort::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineComputedCutoffPairsMktEventsPort*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OfflineComputedCutoffPairsMktEventsPort(
...
OfflineComputedCutoffPairsMktEventsPort::OfflineComputedCutoffPairsMktEventsPort(
...
void OfflineComputedCutoffPairsMktEventsPort::OnIndicatorUpdate(const unsigned int& _indicator_index_,
...
void OfflineComputedCutoffPairsMktEventsPort::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineComputedCutoffPairsMktEventsPort::UpdateLRInfo() {
...
void OfflineComputedCutoffPairsMktEventsPort::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineComputedCutoffPairsMktEventsPort::OnMarketDataResumed(const unsigned int _security_id_) {
  InitializeValues();
