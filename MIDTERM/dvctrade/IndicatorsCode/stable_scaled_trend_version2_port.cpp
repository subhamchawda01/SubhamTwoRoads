...
void StableScaledTrendVersion2Port::CollectShortCodes(std::vector<std::string>& t_shortcodes_affecting_this_indicator_,
                                                      std::vector<std::string>& _ors_source_needed_vec_,
                                                      const std::vector<const char*>& r_tokens_) {
  IndicatorUtil::AddPortfolioShortCodeVec((std::string)r_tokens_[3], t_shortcodes_affecting_this_indicator_);
}

StableScaledTrendVersion2Port* StableScaledTrendVersion2Port::GetUniqueInstance(
    DebugLogger& t_dbglogger_, const Watch& r_watch_, const std::vector<const char*>& r_tokens_,
    PriceType_t _basepx_pxtype_) {
  if (r_tokens_.size() < 7) {
    ExitVerbose(kModelCreationIndicatorLineLessArgs, t_dbglogger_,
                "INDICATOR weight StableScaledTrendVersion2Port _portfolio_ _fractional_seconds_ "
                "_stdev_duration_ _price_type_ ");
  }

  // INDICATOR _this_weight_ _indicator_string_ _portfolio_ _fractional_seconds_ _stdev_duration_ _price_type_
...
StableScaledTrendVersion2Port* StableScaledTrendVersion2Port::GetUniqueInstance(
  ...
  static std::map<std::string, StableScaledTrendVersion2Port*> concise_indicator_description_map_;
  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new StableScaledTrendVersion2Port(
...
StableScaledTrendVersion2Port::StableScaledTrendVersion2Port(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void StableScaledTrendVersion2Port::OnIndicatorUpdate(const unsigned int& _indicator_index_,
...
void StableScaledTrendVersion2Port::WhyNotReady() {
  if (!is_ready_) {
...
void StableScaledTrendVersion2Port::OnPortfolioPriceChange(double _new_price_) {
...
void StableScaledTrendVersion2Port::OnPortfolioPriceReset(double t_new_price_, double t_old_price_,
...
void StableScaledTrendVersion2Port::InitializeValues() {
