/**
    \file IndicatorsCode/online_computed_pairs_mktevents_port.cpp
...
void OnlineComputedPairsMktEventsPort::CollectShortCodes(
...
OnlineComputedPairsMktEventsPort* OnlineComputedPairsMktEventsPort::GetUniqueInstance(
...
OnlineComputedPairsMktEventsPort* OnlineComputedPairsMktEventsPort::GetUniqueInstance(
  ...
  static std::map<std::string, OnlineComputedPairsMktEventsPort*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OnlineComputedPairsMktEventsPort(t_dbglogger_, r_watch_, concise_indicator_description_, _dep_market_view_,
                                             _portfolio_descriptor_shortcode_, _num_events_halflife_, _price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

OnlineComputedPairsMktEventsPort::OnlineComputedPairsMktEventsPort(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OnlineComputedPairsMktEventsPort::OnPortfolioPriceChange(double _new_price_) {
...
void OnlineComputedPairsMktEventsPort::OnPortfolioPriceReset(double t_new_portfolio_price_,
...
void OnlineComputedPairsMktEventsPort::OnMarketUpdate(
...
void OnlineComputedPairsMktEventsPort::UpdateComputedVariables() {
  ...
  if (moving_avg_indep_indep_price_ > 1.00) {  // added to prevent nan
    ...
    // Main Differnece from OnlineComputedPairMktEventsPort
...
void OnlineComputedPairsMktEventsPort::InitializeValues() {
...
void OnlineComputedPairsMktEventsPort::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OnlineComputedPairsMktEventsPort::OnMarketDataResumed(const unsigned int _security_id_) {
  InitializeValues();
  data_interrupted_ = false;
}
}
