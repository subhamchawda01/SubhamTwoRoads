/**
    \file IndicatorsCode/online_ratio_projected_price.cpp
...
void OnlineRatioProjectedPrice::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
...
OnlineRatioProjectedPrice* OnlineRatioProjectedPrice::GetUniqueInstance(DebugLogger& t_dbglogger_,
...
OnlineRatioProjectedPrice* OnlineRatioProjectedPrice::GetUniqueInstance(
  ...
  static std::map<std::string, OnlineRatioProjectedPrice*> concise_indicator_description_map_;
  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OnlineRatioProjectedPrice(t_dbglogger_, r_watch_, concise_indicator_description_, _dep_market_view_,
                                      _indep_market_view_, _fractional_seconds_, _price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

OnlineRatioProjectedPrice::OnlineRatioProjectedPrice(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OnlineRatioProjectedPrice::OnMarketUpdate(const unsigned int t_security_id_,
  ...
  if (!is_ready_) {
    ...
    indicator_value_ = moving_avg_ratio_ * current_indep_price_;
...
void OnlineRatioProjectedPrice::InitializeValues() {
...
void OnlineRatioProjectedPrice::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OnlineRatioProjectedPrice::OnMarketDataResumed(const unsigned int _security_id_) {
  if (indep_market_view_.security_id() == _security_id_) {
    InitializeValues();
