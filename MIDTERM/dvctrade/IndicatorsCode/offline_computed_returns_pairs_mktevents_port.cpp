/**
    \file IndicatorsCode/offline_computed_returns_pairs_mktevents_port.cpp
...
void OfflineComputedReturnsPairsMktEventsPort::CollectShortCodes(
...
OfflineComputedReturnsPairsMktEventsPort* OfflineComputedReturnsPairsMktEventsPort::GetUniqueInstance(
  ...
  if (r_tokens_.size() < 7) {
    ExitVerbose(kModelCreationIndicatorLineLessArgs, t_dbglogger_,
                "INDICATOR weight OfflineComputedReturnsPairsMktEventsPort _dep_market_view_ _indep_market_view_ "
...
OfflineComputedReturnsPairsMktEventsPort* OfflineComputedReturnsPairsMktEventsPort::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineComputedReturnsPairsMktEventsPort*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OfflineComputedReturnsPairsMktEventsPort(
...
OfflineComputedReturnsPairsMktEventsPort::OfflineComputedReturnsPairsMktEventsPort(
...
void OfflineComputedReturnsPairsMktEventsPort::OnIndicatorUpdate(const unsigned int& _indicator_index_,
...
void OfflineComputedReturnsPairsMktEventsPort::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineComputedReturnsPairsMktEventsPort::UpdateLRInfo() {
...
void OfflineComputedReturnsPairsMktEventsPort::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineComputedReturnsPairsMktEventsPort::OnMarketDataResumed(const unsigned int _security_id_) {
  InitializeValues();
