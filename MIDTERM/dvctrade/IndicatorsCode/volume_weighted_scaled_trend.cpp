/**
    \file IndicatorsCode/volume_weighted_scaled_trend.cpp
...
void VolumeWeightedScaledTrend::CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
                                                  std::vector<std::string>& _ors_source_needed_vec_,
                                                  const std::vector<const char*>& r_tokens_) {
  VectorUtils::UniqueVectorAdd(_shortcodes_affecting_this_indicator_, (std::string)r_tokens_[3]);
}

VolumeWeightedScaledTrend* VolumeWeightedScaledTrend::GetUniqueInstance(DebugLogger& t_dbglogger_,
  ...
  if (r_tokens_.size() < 8) {
    ExitVerbose(kModelCreationIndicatorLineLessArgs, t_dbglogger_,
                "INDICATOR weight VolumeWeightedScaledTrend _indep_market_view_ _fractional_seconds_, "
...
VolumeWeightedScaledTrend* VolumeWeightedScaledTrend::GetUniqueInstance(
  ...
  static std::map<std::string, VolumeWeightedScaledTrend*> concise_indicator_description_map_;
  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new VolumeWeightedScaledTrend(
...
VolumeWeightedScaledTrend::VolumeWeightedScaledTrend(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void VolumeWeightedScaledTrend::OnVolumeRatioUpdate(const unsigned int r_security_id_,
...
void VolumeWeightedScaledTrend::OnScaledVolumeUpdate(const unsigned int r_security_id_,
...
void VolumeWeightedScaledTrend::OnMarketUpdate(const unsigned int _security_id_,
  ...
  if (!is_ready_) {
    ...
    indicator_value_ = volume_factor_ * indicator_value_;
...
void VolumeWeightedScaledTrend::InitializeValues() {
...
void VolumeWeightedScaledTrend::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void VolumeWeightedScaledTrend::OnMarketDataResumed(const unsigned int _security_id_) {
  if (indep_market_view_.security_id() == _security_id_) {
    InitializeValues();
