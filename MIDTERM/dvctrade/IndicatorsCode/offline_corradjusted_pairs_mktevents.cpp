/**
    \file IndicatorsCode/offline_corradjusted_pairs_mktevents.cpp
...
void OfflineCorradjustedPairsMktEvents::CollectShortCodes(
...
OfflineCorradjustedPairsMktEvents* OfflineCorradjustedPairsMktEvents::GetUniqueInstance(
...
OfflineCorradjustedPairsMktEvents* OfflineCorradjustedPairsMktEvents::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineCorradjustedPairsMktEvents*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] =
        new OfflineCorradjustedPairsMktEvents(t_dbglogger_, r_watch_, concise_indicator_description_, _dep_market_view_,
                                              _indep_market_view_, _num_events_halflife_, _price_type_);
  }
  return concise_indicator_description_map_[concise_indicator_description_];
}

OfflineCorradjustedPairsMktEvents::OfflineCorradjustedPairsMktEvents(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
void OfflineCorradjustedPairsMktEvents::OnIndicatorUpdate(const unsigned int& _indicator_index_,
...
void OfflineCorradjustedPairsMktEvents::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineCorradjustedPairsMktEvents::OnMarketDataResumed(const unsigned int _security_id_) {
  if (_security_id_ == indep_market_view_.security_id()) {
    InitializeValues();
...
void OfflineCorradjustedPairsMktEvents::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineCorradjustedPairsMktEvents::UpdateLRInfo() {
