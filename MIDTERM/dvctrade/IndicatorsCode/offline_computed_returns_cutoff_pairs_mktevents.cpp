...
void OfflineComputedReturnsCutoffPairsMktEvents::CollectShortCodes(
...
OfflineComputedReturnsCutoffPairsMktEvents* OfflineComputedReturnsCutoffPairsMktEvents::GetUniqueInstance(
  ...
  if (r_tokens_.size() < 7) {
    ExitVerbose(kModelCreationIndicatorLineLessArgs, t_dbglogger_,
                "INDICATOR weight OfflineComputedReturnsCutoffPairsMktEvents _dep_market_view_ _indep_market_view_ "
...
OfflineComputedReturnsCutoffPairsMktEvents* OfflineComputedReturnsCutoffPairsMktEvents::GetUniqueInstance(
  ...
  static std::map<std::string, OfflineComputedReturnsCutoffPairsMktEvents*> concise_indicator_description_map_;

  if (concise_indicator_description_map_.find(concise_indicator_description_) ==
      concise_indicator_description_map_.end()) {
    concise_indicator_description_map_[concise_indicator_description_] = new OfflineComputedReturnsCutoffPairsMktEvents(
...
OfflineComputedReturnsCutoffPairsMktEvents::OfflineComputedReturnsCutoffPairsMktEvents(
...
void OfflineComputedReturnsCutoffPairsMktEvents::OnIndicatorUpdate(const unsigned int& t_indicator_index_,
...
void OfflineComputedReturnsCutoffPairsMktEvents::WhyNotReady() {
  if (!is_ready_) {
...
void OfflineComputedReturnsCutoffPairsMktEvents::OnMarketDataInterrupted(const unsigned int _security_id_,
...
void OfflineComputedReturnsCutoffPairsMktEvents::OnMarketDataResumed(const unsigned int _security_id_) {
  if (_security_id_ == indep_market_view_.security_id()) {
    InitializeValues();
...
void OfflineComputedReturnsCutoffPairsMktEvents::InitializeValues() {
  indicator_value_ = 0;
  UpdateLRInfo();
}

void OfflineComputedReturnsCutoffPairsMktEvents::UpdateLRInfo() {
