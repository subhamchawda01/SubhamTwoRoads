...
#include "dvctrade/kalman/ktypes.hpp"
...
class KVector {
 public:
  ...
  enum {
    beg = BEG  //!< Starting index of vector, either 0 or 1.
  };
...
KVectorContext createKVectorContext(std::string elemDelim = " ", std::string startDelim = "", std::string endDelim = "",
                                    unsigned prec = 4);
...
#include "dvctrade/kalman/kvector_impl.hpp"
