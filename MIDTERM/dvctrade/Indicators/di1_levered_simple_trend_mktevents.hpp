/**
    \file Indicators/di1_levered_simple_trend_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_DI1_LEVERED_SIMPLE_TREND_MKTEVENTS_H
#define BASE_INDICATORS_DI1_LEVERED_SIMPLE_TREND_MKTEVENTS_H
...
class DI1LeveredSimpleTrendMktEvents : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  SimpleTrendMktEvents* indep_trendI_;
  ...
  DI1LeveredSimpleTrendMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static DI1LeveredSimpleTrendMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                           const std::vector<const char*>& _tokens_,
  ...
  ~DI1LeveredSimpleTrendMktEvents() {}
  ...
  // functions
  static std::string VarName() { return "DI1LeveredSimpleTrendMktEvents"; }
