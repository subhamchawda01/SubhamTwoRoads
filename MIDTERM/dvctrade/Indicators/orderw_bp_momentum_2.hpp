/**
    \file Indicators/orderw_bp_momentum_2.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ORDERW_BP_MOMENTUM_2_H
#define BASE_INDICATORS_ORDERW_BP_MOMENTUM_2_H
...
class OrderWBPMomentum2 : public CommonIndicator, public SMVPLChangeListener, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  OrderWBPMomentum2(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  static OrderWBPMomentum2* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
...
#undef MAX_LEVEL_DECAY_VECTOR_SIZE
  ...
  // functions
  static std::string VarName() { return "OrderWBPMomentum2"; }
};
}
