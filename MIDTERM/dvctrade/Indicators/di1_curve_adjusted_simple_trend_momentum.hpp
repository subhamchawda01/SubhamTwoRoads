/**
    \file Indicators/di1_curve_adjusted_simple_trend_momentum.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_DI1_CURVE_ADJUSTED_SIMPLE_TREND_MOMENTUM_H
#define BASE_INDICATORS_DI1_CURVE_ADJUSTED_SIMPLE_TREND_MOMENTUM_H
...
class DI1CurveAdjustedSimpleTrendMomentum : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  DI1CurveAdjustedSimpleTrendMomentum(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static DI1CurveAdjustedSimpleTrendMomentum* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                const std::vector<const char*>& _tokens_,
  ...
  ~DI1CurveAdjustedSimpleTrendMomentum() {}
  ...
  // functions
  static std::string VarName() { return "DI1CurveAdjustedSimpleTrendMomentum"; }
