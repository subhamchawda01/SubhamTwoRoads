/**
    \file Indicators/diff_tdsizeavg_tpx_basepx.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_DIFF_TDSIZEAVG_TPX_BASEPX_H
#define BASE_INDICATORS_DIFF_TDSIZEAVG_TPX_BASEPX_H
...
class DiffTDSizeAvgTPxBasepx : public CommonIndicator {
 protected:
  // variables
 ...
 protected:
  DiffTDSizeAvgTPxBasepx(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static DiffTDSizeAvgTPxBasepx* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                   const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "DiffTDSizeAvgTPxBasepx"; }
