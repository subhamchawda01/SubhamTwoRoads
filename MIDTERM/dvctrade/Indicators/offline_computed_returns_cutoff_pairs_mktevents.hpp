/**
    \file Indicators/offline_computed_cutoff_pairs_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_RETURNS_CUTOFF_PAIRS_MKTEVENTS_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_RETURNS_CUTOFF_PAIRS_MKTEVENTS_H
...
/// Event-decayed version of SimpleReturns i.e. SimpleReturnsMktEvents used
...
class OfflineComputedReturnsCutoffPairsMktEvents : public IndicatorListener,
 ...
 protected:
  OfflineComputedReturnsCutoffPairsMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedReturnsCutoffPairsMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                       const std::vector<const char*>& _tokens_,
  ...
  ~OfflineComputedReturnsCutoffPairsMktEvents() {}
  ...
  static std::string VarName() { return "OfflineComputedReturnsCutoffPairsMktEvents"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_RETURNS_CUTOFF_PAIRS_MKTEVENTS_H
