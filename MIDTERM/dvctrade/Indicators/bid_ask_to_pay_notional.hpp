/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_BID_ASK_TO_PAY_NOTIONAL_H
#define BASE_INDICATORS_BID_ASK_TO_PAY_NOTIONAL_H
...
class BidAskToPayNotional : public CommonIndicator {
 protected:
  // variables
  ...
  // functions
 protected:
  BidAskToPayNotional(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  static BidAskToPayNotional* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "BidAskToPayNotional"; }
