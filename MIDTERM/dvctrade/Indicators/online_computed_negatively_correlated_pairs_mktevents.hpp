/**
    \file Indicators/online_computed_negatively_correlated_pairs_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_COMPUTED_NEGATIVELY_CORRELATED_PAIRS_MKTEVENTS_H
#define BASE_INDICATORS_ONLINE_COMPUTED_NEGATIVELY_CORRELATED_PAIRS_MKTEVENTS_H
...
class OnlineComputedNegativelyCorrelatedPairsMktEvents : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineComputedNegativelyCorrelatedPairsMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_,
                                                                             const Watch& _watch_,
                                                                             const std::vector<const char*>& _tokens_,
                                                                             PriceType_t _basepx_pxtype_);

  static OnlineComputedNegativelyCorrelatedPairsMktEvents* GetUniqueInstance(
 ...
 protected:
  OnlineComputedNegativelyCorrelatedPairsMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static std::string VarName() { return "OnlineComputedNegativelyCorrelatedPairsMktEvents"; }
...
#endif  // BASE_INDICATORS_ONLINE_COMPUTED_NEGATIVELY_CORRELATED_PAIRS_MKTEVENTS_H
