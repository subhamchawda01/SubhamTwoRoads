/**
    \file Indicators/stdev_simple_trend.hpp
   ...
   +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_STDEV_SIMPLE_TREND_H
#define BASE_INDICATORS_STDEV_SIMPLE_TREND_H
...
class StdevSimpleTrend : public SlowStdevCalculatorListener, public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static StdevSimpleTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  StdevSimpleTrend(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "StdevSimpleTrend"; }
...
#endif  // BASE_INDICATORS_STDEV_SIMPLE_TREND_H
