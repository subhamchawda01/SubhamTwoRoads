/**
    \file Indicators/online_corradjusted_diff_pairs.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_ONLINE_CORRADJUSTED_DIFF_PAIRS_H
#define BASE_INDICATORS_ONLINE_CORRADJUSTED_DIFF_PAIRS_H
...
/// computes the normalized difference of their prices at all points and
/// prints how the current normalized  spread differs from the past normalized spread
class OnlineCorradjustedDiffPairs : public CommonIndicator {
 protected:
  // variables
  ...
  double moving_avg_diff_;
  double moving_avg_indep_;
  double moving_avg_dep_;
  double current_price_diff_;
  double last_price_diff_;
 ...
 public:
  ...
  static OnlineCorradjustedDiffPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                        const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineCorradjustedDiffPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static std::string VarName() { return "OnlineCorradjustedDiffPairs"; }
...
#endif  // BASE_INDICATORS_ONLINE_CORRADJUSTED_DIFF_PAIRS_H
