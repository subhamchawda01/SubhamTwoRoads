/**
    \file Indicators/offline_corradjusted_pairs.hpp
...
class OfflineCorradjustedPairs : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
 ...
 protected:
  OfflineCorradjustedPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineCorradjustedPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                     const std::vector<const char*>& _tokens_,
  ...
  static std::string VarName() { return "OfflineCorradjustedPairs"; }
 ...
 protected:
  ...
  /// From price changes, we compute the coefficient and corerlation through Single Linear Regression
  /// < lr_coeff_, lr_correlation_ > = GetSLRCoeffCorrelation ( dep_price_change_vector_, indep_price_change_vector_ )
  /// For OfflineCorradjustedPairs lr_coeff_/fabs(lr_correlation_) is sort of the lr_coeff_ as it would be if indep and
  /// dep are either perfectly correlated or
