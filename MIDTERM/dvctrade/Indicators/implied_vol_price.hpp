/*
 * implied_vol_indicator.hpp
 *
 *  Created on: 05-Oct-2015
 *      Author: raghuram
 */

#ifndef INDICATORSCODE_IMPLIED_VOL_INDICATOR_HPP_
#define INDICATORSCODE_IMPLIED_VOL_INDICATOR_HPP_
...
/// Returns that
class ImpliedVolPrice : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static ImpliedVolPrice* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  ImpliedVolPrice(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "ImpliedVolPrice"; }
...
#endif /* INDICATORSCODE_IMPLIED_VOL_INDICATOR_HPP_ */
