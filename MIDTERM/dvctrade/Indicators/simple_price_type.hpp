/**
    \file Indicators/simple_price_type.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_SIMPLE_PRICE_TYPE_H
#define BASE_INDICATORS_SIMPLE_PRICE_TYPE_H
...
class SimplePriceType : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static SimplePriceType* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                            SecurityMarketView& _indep_market_view_, PriceType_t _price_type_);
  static SimplePriceType* GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
                                            const std::vector<const char*>& r_tokens_, PriceType_t _basepx_pxtype_);

  SimplePriceType(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
                  SecurityMarketView& _indep_market_view_, PriceType_t _price_type_);
  ...
  // functions
  static std::string VarName() { return "SimplePriceType"; }
...
#endif  // BASE_INDICATORS_SIMPLE_PRICE_TYPE_H
