...
class OfflineBreakoutAdjustedPairs : public IndicatorListener,
 ...
 protected:
  ...
  RecentScaledVolumeCalculator& indep_scaled_volume_calculator_;
 ...
 protected:
  OfflineBreakoutAdjustedPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineBreakoutAdjustedPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                         const std::vector<const char*>& _tokens_,
  ...
  static std::string VarName() { return "OfflineBreakoutAdjustedPairs"; }
 ...
 protected:
  ...
  /// From price changes, we compute the coefficient and corerlation through Single Linear Regression
  /// < lr_coeff_, lr_correlation_ > = GetSLRCoeffCorrelation ( dep_price_change_vector_, indep_price_change_vector_ )
  /// For OfflineBreakoutAdjustedPairs lr_coeff_/fabs(lr_correlation_) is sort of the lr_coeff_ as it would be if indep
