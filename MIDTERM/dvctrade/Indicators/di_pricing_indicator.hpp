/**
    \file Indicators/di_pricing_indicator.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_DI_PRICING_INDICATOR_HPP
#define BASE_INDICATORS_DI_PRICING_INDICATOR_HPP
...
class DIPricingIndicator : public IndicatorListener, public CommonIndicator {
  // TODO:: this should be event / trade based
  // DIPricingIndicator dep_shc_ indep_1_ indep_2_ dep_pxtype_ indep_1_pxtype_ indep_2_pxtype_ _fractional_seconds_
 ...
 protected:
  ...
  SimpleTrend* indep_1_trend_indicator_;
  SimpleTrend* indep_2_trend_indicator_;

 public:
  static DIPricingIndicator* GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
  ...
  static DIPricingIndicator* GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
                                               ...
                                               PriceType_t t_pxtype_);

  static void CollectShortCodes(std::vector<std::string>& _shortcodes_affecting_this_indicator_,
                                std::vector<std::string>& _ors_source_needed_vec_,
                                const std::vector<const char*>& r_tokens_);

  static std::string VarName() { return "DIPricingIndicator"; }
 ...
 protected:
  DIPricingIndicator(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
#endif /* BASE_INDICATORS_DI_PRICING_INDICATOR_HPP */
