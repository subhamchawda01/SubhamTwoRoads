/**
   \file Indicators/corr_ratio_calculator.cpp
...
class CorrRatioCalculator : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
 ...
 public:
  ...
  static CorrRatioCalculator* GetUniqueInstance(DebugLogger& r_dbglogger_, const Watch& r_watch_,
                                                const std::vector<const char*>& r_tokens_,
 ...
 protected:
  CorrRatioCalculator(DebugLogger& r_dbglogger_, const Watch& r_watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "CorrRatioCalculator"; }
