...
class OfflineComputedPairs : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  OfflineComputedPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  static std::string VarName() { return "OfflineComputedPairs"; }
