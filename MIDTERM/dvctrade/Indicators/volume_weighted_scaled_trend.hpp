/**
    \file Indicators/volume_weighted_scaled_trend.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_VOLUME_WEIGHTED_SCALED_TREND_H
#define BASE_INDICATORS_VOLUME_WEIGHTED_SCALED_TREND_H
...
/// Returns that
class VolumeWeightedScaledTrend : public CommonIndicator,
 ...
 public:
  ...
  static VolumeWeightedScaledTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                      const std::vector<const char*>& _tokens_,
 ...
 protected:
  VolumeWeightedScaledTrend(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "VolumeWeightedScaledTrend"; }
...
#endif  // BASE_INDICATORS_VOLUME_WEIGHTED_SCALED_TREND_H
