/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_COMPUTED_PAIRS_H
#define BASE_INDICATORS_ONLINE_COMPUTED_PAIRS_H
...
class OnlineComputedPairs : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineComputedPairs *GetUniqueInstance(DebugLogger &_dbglogger_, const Watch &_watch_,
 ...
 protected:
  OnlineComputedPairs(DebugLogger &_dbglogger_, const Watch &_watch_, const std::string &concise_indicator_description_,
 ...
 public:
  ...
  static std::string VarName() { return "OnlineComputedPairs"; }
...
#endif  // BASE_INDICATORS_ONLINE_COMPUTED_PAIRS_H
