/**
    \file Indicators/offline_computed_returns_cutoff_pairs.hpp
...
class OfflineComputedReturnsCutoffPairs : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  OfflineComputedReturnsCutoffPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedReturnsCutoffPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                              const std::vector<const char*>& _tokens_,
  ...
  ~OfflineComputedReturnsCutoffPairs() {}
  ...
  static std::string VarName() { return "OfflineComputedReturnsCutoffPairs"; }
 ...
 protected:
  ...
  /// and OfflineComputedReturnsCutoffPairs
