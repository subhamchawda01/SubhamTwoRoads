/**
    \file Indicators/online_computed_pair_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_COMPUTED_PAIR_PORT_H
#define BASE_INDICATORS_ONLINE_COMPUTED_PAIR_PORT_H
...
///
class OnlineComputedPairPort : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineComputedPairPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                   const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineComputedPairPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  // functions
  static std::string VarName() { return "OnlineComputedPairPort"; }
