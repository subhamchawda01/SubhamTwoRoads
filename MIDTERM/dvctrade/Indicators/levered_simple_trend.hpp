/**
    \file Indicators/levered_simple_trend.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_LEVERED_SIMPLE_TREND_H
#define BASE_INDICATORS_LEVERED_SIMPLE_TREND_H
...
class LeveredSimpleTrend : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  LeveredSimpleTrend(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& _concise_indicator_description_,
 ...
 public:
  ...
  static LeveredSimpleTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  // functions
  static std::string VarName() { return "LeveredSimpleTrend"; }
