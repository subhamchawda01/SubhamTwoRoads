/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_FRA_PRICE_H
#define BASE_INDICATORS_FRA_PRICE_H
...
class FRAPrice : public CommonIndicator {
 protected:
  ...
  double inv_pu_indep2_;
  double inv_pu_indep1_;
  double inv_pu_dep_;
  double current_predicted_price_;

  FRAPrice(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& _concise_indicator_description_,
 ...
 public:
  ...
  static FRAPrice* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  // functions
  static std::string VarName() { return "FRAPrice"; }

 protected:
  void InitializeValues();
  double ComputeInvPU(double _price_, int _term_);
  double ComputeSlideFRA();
};
}

#endif  // BASE_INDICATORS_FRA_PRICE_H
