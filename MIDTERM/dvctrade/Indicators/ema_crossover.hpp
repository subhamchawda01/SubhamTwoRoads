/**
    \file Indicators/ema_crossover.hpp
...
class EMACrossover : public IndicatorListener, public CommonIndicator {
 protected:
  const SecurityMarketView& indep_market_view_;

  double st_ema_value_;
  double lt_ema_value_;

  ExponentialMovingAverage* p_st_indicator_;
  ExponentialMovingAverage* p_lt_indicator_;
 ...
 public:
  ...
  static EMACrossover* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                         const std::vector<const char*>& _tokens_, PriceType_t _basepx_pxtype_);

  static EMACrossover* GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
 ...
 protected:
  EMACrossover(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
               const SecurityMarketView& _indep_market_view_, double _fractional_st_seconds_,
               double _fractional_lt_seconds_, PriceType_t _price_type_);
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "EMACrossover"; }
