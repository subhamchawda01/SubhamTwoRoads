/**
    \file Indicators/online_computed_cutoff_pair_mktevents.hpp
...
class OnlineComputedCutoffPairMktEvents : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineComputedCutoffPairMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                              const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineComputedCutoffPairMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ~OnlineComputedCutoffPairMktEvents() {}
  ...
  static std::string VarName() { return "OnlineComputedCutoffPairMktEvents"; }
