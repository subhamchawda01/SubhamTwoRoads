/**
    \file Indicators/regime_online_offline_beta.cpp
...
class RegimeOnlineOfflineBeta : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
 ...
 public:
  ...
  static RegimeOnlineOfflineBeta* GetUniqueInstance(DebugLogger& r_dbglogger_, const Watch& r_watch_,
                                                    const std::vector<const char*>& r_tokens_,
 ...
 protected:
  RegimeOnlineOfflineBeta(DebugLogger& r_dbglogger_, const Watch& r_watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "RegimeOnlineOfflineBeta"; }
