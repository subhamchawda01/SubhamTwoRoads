/**
    \file Indicators/online_ratio_projected_price.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_RATIO_PROJECTED_PRICE_H
#define BASE_INDICATORS_ONLINE_RATIO_PROJECTED_PRICE_H
...
class OnlineRatioProjectedPrice : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineRatioProjectedPrice* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                      const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineRatioProjectedPrice(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static std::string VarName() { return "OnlineRatioProjectedPrice"; }
...
#endif  // BASE_INDICATORS_ONLINE_RATIO_PROJECTED_PRICE_H
