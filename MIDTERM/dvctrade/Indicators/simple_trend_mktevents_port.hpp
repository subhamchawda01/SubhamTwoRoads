/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_SIMPLE_TREND_MKTEVENTS_PORT_H
#define BASE_INDICATORS_SIMPLE_TREND_MKTEVENTS_PORT_H
...
class SimpleTrendMktEventsPort : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static SimpleTrendMktEventsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                     const std::vector<const char*>& _tokens_,
 ...
 protected:
  SimpleTrendMktEventsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  // functions
  static std::string VarName() { return "SimpleTrendMktEventsPort"; }
...
#endif  // BASE_INDICATORS_SIMPLE_TREND_MKTEVENTS_H
