/**
    \file Indicators/book_order_diff.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_BOOK_ORDER_DIFF_H
#define BASE_INDICATORS_BOOK_ORDER_DIFF_H
...
class BookOrderDiff : public CommonIndicator {
 protected:
  // variables
  ...
  // functions
 protected:
  BookOrderDiff(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  static BookOrderDiff* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "BookOrderDiff"; }
  void OnMarketDataInterrupted(const unsigned int _security_id_, const int msecs_since_last_receive_);
  void OnMarketDataResumed(const unsigned int _security_id_);
};
}

#endif  // BASE_INDICATORS_BOOK_ORDER_DIFF_H
