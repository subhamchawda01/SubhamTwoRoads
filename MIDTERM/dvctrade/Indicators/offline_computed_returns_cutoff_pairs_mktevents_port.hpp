/**
    \file Indicators/offline_computed_returns_cutoff_pairs_mktevents_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_RETURNS_CUTOFF_PAIRS_MKTEVENTS_PORT_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_RETURNS_CUTOFF_PAIRS_MKTEVENTS_PORT_H
...
class OfflineComputedReturnsCutoffPairsMktEventsPort : public IndicatorListener,
 ...
 protected:
  ...
  // functions
 protected:
  OfflineComputedReturnsCutoffPairsMktEventsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedReturnsCutoffPairsMktEventsPort* GetUniqueInstance(DebugLogger& _dbglogger_,
                                                                           const Watch& _watch_,
                                                                           const std::vector<const char*>& _tokens_,
                                                                           PriceType_t _basepx_pxtype_);

  static OfflineComputedReturnsCutoffPairsMktEventsPort* GetUniqueInstance(
  ...
  ~OfflineComputedReturnsCutoffPairsMktEventsPort() {}
  ...
  // functions
  static std::string VarName() { return "OfflineComputedReturnsCutoffPairsMktEventsPort"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_RETURNS_CUTOFF_PAIRS_MKTEVENTS_PORT_H
