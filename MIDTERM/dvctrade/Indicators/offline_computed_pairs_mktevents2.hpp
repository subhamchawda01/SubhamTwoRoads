/**
    \file Indicators/offline_computed_pairs_mktevents2.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_PAIRS_MKTEVENTS_2_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_PAIRS_MKTEVENTS_2_H
...
class OfflineComputedPairsMktEvents2 : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  SimpleTrendIndepMktEvents* p_dep_indicator_;
  SimpleTrendMktEvents* p_indep_indicator_;

 protected:
  OfflineComputedPairsMktEvents2(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedPairsMktEvents2* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                           const std::vector<const char*>& _tokens_,
  ...
  ~OfflineComputedPairsMktEvents2() {}
  ...
  static std::string VarName() { return "OfflineComputedPairsMktEvents2"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_PAIRS_MKTEVENTS_2_H
