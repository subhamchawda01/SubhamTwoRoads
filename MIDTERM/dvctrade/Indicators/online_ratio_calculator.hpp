/**
    \file Indicators/online_ratio_calculator.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_RATIO_CALCULATOR_H
#define BASE_INDICATORS_ONLINE_RATIO_CALCULATOR_H
...
class OnlineRatioCalculator : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineRatioCalculator* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                  const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineRatioCalculator(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static std::string VarName() { return "SpotToFuturePricing"; }
...
#endif  // BASE_INDICATORS_ONLINE_RATIO_CALCULATOR_H
