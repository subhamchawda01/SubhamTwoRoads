/**
    \file Indicators/stdev_weighted_source_self_trend.hpp
...
class StdevWeightedSourceSelfTrend : public IndicatorListener,
 ...
 protected:
  ...
  double current_stdev_factor_;
  double hist_stdev_;
  double stdev_lower_bound_;
  double stdev_upper_bound_;
  double stdev_norm_factor_;
  SlowStdevCalculator* p_slow_stdev_calculator_;

  // functions
 protected:
  StdevWeightedSourceSelfTrend(DebugLogger& _dbglogger_, const Watch& _watch_,
                               const std::string& concise_indicator_description_, SecurityMarketView& _dep_market_view_,
                               SecurityMarketView& _indep_market_view_, double _stdev_fractional_seconds_,
                               double _stdev_lower_bound_, double _stdev_upper_bound_, double _fractional_seconds_,
 ...
 public:
  ...
  static StdevWeightedSourceSelfTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                         const std::vector<const char*>& _tokens_,
  ...
  static StdevWeightedSourceSelfTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                         ...
                                                         double _stdev_fractional_seconds_, double _stdev_lower_bound_,
                                                         double _stdev_upper_bound_, double _fractional_seconds_,
                                                         PriceType_t _price_type_);

  ~StdevWeightedSourceSelfTrend() {}
  ...
  static std::string VarName() { return "StdevWeightedSourceSelfTrend"; }
