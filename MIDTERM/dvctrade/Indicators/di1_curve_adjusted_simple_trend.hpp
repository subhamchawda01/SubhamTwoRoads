/**
    \file Indicators/di1_curve_adjusted_simple_trend.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_DI1_CURVE_ADJUSTED_SIMPLE_TREND_H
#define BASE_INDICATORS_DI1_CURVE_ADJUSTED_SIMPLE_TREND_H
...
class DI1CurveAdjustedSimpleTrend : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  DI1CurveAdjustedSimpleTrend(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static DI1CurveAdjustedSimpleTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                        const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "DI1CurveAdjustedSimpleTrend"; }
