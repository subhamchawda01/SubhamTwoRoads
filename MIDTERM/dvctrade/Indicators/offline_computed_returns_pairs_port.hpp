/**
    \file Indicators/offline_computed_returns_pairs_port.hpp
...
class OfflineComputedReturnsPairsPort : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  OfflineComputedReturnsPairsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedReturnsPairsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                            const std::vector<const char*>& _tokens_,
  ...
  ~OfflineComputedReturnsPairsPort() {}
  ...
  static std::string VarName() { return "OfflineComputedReturnsPairsPort"; }
 ...
 protected:
  ...
  /// and OfflineComputedReturnsPairsPort
