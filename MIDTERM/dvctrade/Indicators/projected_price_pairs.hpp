/**
    \file Indicators/projected_price_pairs.hpp
...
#ifndef PROJECTED_PRICE_PAIRS_HPP_
#define PROJECTED_PRICE_PAIRS_HPP_
...
namespace HFSAT {
class ProjectedPricePairs : public CommonIndicator, public SlowStdevCalculatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static ProjectedPricePairs *GetUniqueInstance(DebugLogger &_dbglogger_, const Watch &_watch_,
                                                const std::vector<const char *> &_tokens_, PriceType_t _basepx_pxtype_);

  static ProjectedPricePairs *GetUniqueInstance(DebugLogger &_dbglogger_, const Watch &_watch_,
                                                SecurityMarketView &_dep_market_view_, std::string _source_shortcode_,
                                                double _fractional_seconds_, PriceType_t _price_type_);

 protected:
  ProjectedPricePairs(DebugLogger &_dbglogger_, const Watch &_watch_, const std::string &concise_indicator_description_,
                      SecurityMarketView &_dep_market_view_, std::vector<SecurityMarketView *> &_indep_market_view_vec_,
                      double _fractional_seconds_, PriceType_t _price_type_);
 ...
 public:
  ...
  static std::string VarName() { return "ProjectedPricePairs"; }
...
#endif /* PROJECTED_PRICE_PAIRS_HPP_ */
