/**
    \file Indicators/offline_computed_source_cutoff_pairs_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_SOURCE_CUTOFF_PAIRS_PORT_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_SOURCE_CUTOFF_PAIRS_PORT_H
...
/// Indicator takes the given portfolio to compute an aggregate price through PortfolioPrice
/// It gets the lr_coeff_ from OfflineReturnsLRDB of _portfolio_descriptor_shortcode_ -> dep_
/// From PortfolioPrice it computes a return of the "portfolio index" by EWMA method like SimpleTrend
/// projects it by multiplying lr_coeff_
/// deducting realized return ( also EWMA like SimpleTrend ) of the dep
/// computes the residual that could be a lead lag relationship
class OfflineComputedSourceCutoffPairsPort : public IndicatorListener,
 ...
 protected:
  ...
  double indep_cutoff_price_trend_;

  SimpleTrend* p_dep_indicator_;
  SimpleTrendPort* p_indep_indicator_;
  SimpleTrendPort* p_indep_trend_indicator_;
  ...
  double current_cutoff_projected_trend_;
  double trend_duration_ratio_;
 ...
 public:
  ...
  static OfflineComputedSourceCutoffPairsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                 const std::vector<const char*>& _tokens_,
 ...
 protected:
  OfflineComputedSourceCutoffPairsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ~OfflineComputedSourceCutoffPairsPort() {}
  ...
  static std::string VarName() { return "OfflineComputedSourceCutoffPairsPort"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_SOURCE_CUTOFF_PAIRS_PORT_H
