/**
    \file Indicators/volume_pca_deviation_pairs_port_mktevents.hpp
...
class VolumePCADeviationPairsPortMktEvents : public IndicatorListener,
 ...
 public:
  ...
  static VolumePCADeviationPairsPortMktEvents *GetUniqueInstance(DebugLogger &_dbglogger_, const Watch &_watch_,
                                                                 const std::vector<const char *> &_tokens_,
 ...
 protected:
  VolumePCADeviationPairsPortMktEvents(DebugLogger &_dbglogger_, const Watch &_watch_,
 ...
 public:
  ~VolumePCADeviationPairsPortMktEvents() {}
  ...
  static std::string VarName() { return "VolumePCADeviationPairsPortMktEvents"; }
