/**
    \file Indicators/returns_stdev.hpp
   ...
   +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_RETURNS_STDEV_H
#define BASE_INDICATORS_RETURNS_STDEV_H
...
class ReturnsStdev : public SlowStdevCalculatorListener, public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static ReturnsStdev* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  ReturnsStdev(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "ReturnsStdev"; }
...
#endif  // BASE_INDICATORS_RETURNS_STDEV_H
