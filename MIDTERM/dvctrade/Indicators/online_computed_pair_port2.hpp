/**
    \file Indicators/online_computed_pair_port2.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_COMPUTED_PAIR_PORT2_H
#define BASE_INDICATORS_ONLINE_COMPUTED_PAIR_PORT2_H
...
/// Portfolio version of OnlineComputedPair
...
///
class OnlineComputedPairPort2 : public CommonIndicator, public IndicatorListener {
 protected:
  // variables

  PricePortfolio* dep_portfolio_price__;
 ...
 public:
  ...
  static OnlineComputedPairPort2* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                    const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineComputedPairPort2(DebugLogger& _dbglogger_, const Watch& _watch_,
                          const std::string& concise_indicator_description_, std::string _dep_portfolio_shortcode_,
                          std::string _portfolio_descriptor_shortcode_, double _fractional_seconds_,
                          double _fractional_seconds_port_, int _is_indep_portfolio_, PriceType_t _price_type_);

 public:
  ~OnlineComputedPairPort2() {}
  ...
  inline void SubscribeDataInterrupts(MarketUpdateManager& market_update_manager_) {
    if (is_indep_portfolio_) market_update_manager_.AddMarketDataInterruptedListener(indep_portfolio_price__);
  }
  ...
  // functions
  // functions
  static std::string VarName() { return "OnlineComputedPairPort2"; }
...
#endif  // BASE_INDICATORS_ONLINE_COMPUTED_PAIR_PORT_H
