/**
   \file Indicators/sg_mg_tr_regime.hpp
...
class SgMgTrRegime : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  const SecurityMarketView* dep_market_view_;
  double dep_price_trend_;
  SimpleTrend* p_dep_indicator_;
  std::map<int, double> offline_trend_avg_;

  double tolerance_;
  double avg_periodic_trend_;
  std::map<int, double> periodic_trends_;
  int current_slot_;

 protected:
  SgMgTrRegime(DebugLogger& dbglogger, const Watch& watch, const std::string& t_concise_indicator_description,
 ...
 public:
  ...
  static SgMgTrRegime* GetUniqueInstance(DebugLogger& dbglogger, const Watch& watch,
  ...
  static std::string VarName() { return "SgMgTrRegime"; }
