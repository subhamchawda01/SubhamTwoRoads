/**
    \file Indicators/diff_travg_tpx_basepx.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_DIFF_TRAVG_TPX_BASEPX_H
#define BASE_INDICATORS_DIFF_TRAVG_TPX_BASEPX_H
...
class DiffTRAvgTPxBasepx : public CommonIndicator {
 protected:
  // variables
 ...
 protected:
  DiffTRAvgTPxBasepx(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  static DiffTRAvgTPxBasepx* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  // functions
  static std::string VarName() { return "DiffTRAvgTPxBasepx"; }
  void OnMarketDataInterrupted(const unsigned int _security_id_, const int msecs_since_last_receive_);
  void OnMarketDataResumed(const unsigned int _security_id_);
};
}

#endif  // BASE_INDICATORS_DIFF_TRAVG_TPX_BASEPX_H
