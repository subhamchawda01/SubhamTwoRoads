/**
    \file Indicators/offline_computed_self_cutoff_pairs_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_SELF_CUTOFF_PAIRS_PORT_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_SELF_CUTOFF_PAIRS_PORT_H
...
class OfflineComputedSelfCutoffPairsPort : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  double dep_cutoff_price_trend_;

  SimpleTrend* p_dep_indicator_;
  SimpleTrendPort* p_indep_indicator_;
  SimpleTrend* p_dep_trend_indicator_;
 ...
 public:
  ...
  static OfflineComputedSelfCutoffPairsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                               const std::vector<const char*>& _tokens_,
 ...
 protected:
  OfflineComputedSelfCutoffPairsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ~OfflineComputedSelfCutoffPairsPort() {}
  ...
  static std::string VarName() { return "OfflineComputedSelfCutoffPairsPort"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_SELF_CUTOFF_PAIRS_PORT_H
