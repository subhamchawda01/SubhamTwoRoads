/**
    \file Indicators/di1_levered_simple_trend.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_DI1_LEVERED_SIMPLE_TREND_H
#define BASE_INDICATORS_DI1_LEVERED_SIMPLE_TREND_H
...
class DI1LeveredSimpleTrend : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  DI1LeveredSimpleTrend(DebugLogger& _dbglogger_, const Watch& _watch_,
                        const std::string& _concise_indicator_description_, const SecurityMarketView& _dep_market_view_,
                        const SecurityMarketView& _indep_market_view_, double _trend_history_secs_,
 ...
 public:
  ...
  static DI1LeveredSimpleTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                  const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "DI1LeveredSimpleTrend"; }
