/**
    \file Indicators/offline_corradjusted_pairs_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_CORRADJUSTED_PAIRS_MKTEVENTS_H
#define BASE_INDICATORS_OFFLINE_CORRADJUSTED_PAIRS_MKTEVENTS_H
...
/// Similar to OfflineCorradjustedPairs
...
/// For theory on the multiplier read OfflineCorradjustedPairs
class OfflineCorradjustedPairsMktEvents : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
 ...
 protected:
  OfflineCorradjustedPairsMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
                                    const std::string& concise_indicator_description_,
                                    const SecurityMarketView& _dep_market_view_,
                                    const SecurityMarketView& _indep_market_view_, unsigned int _num_events_halflife_,
 ...
 public:
  ...
  static OfflineCorradjustedPairsMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                              const std::vector<const char*>& _tokens_,
  ...
  static std::string VarName() { return "OfflineCorradjustedPairsMktEvents"; }
...
#endif  // BASE_INDICATORS_OFFLINE_CORRADJUSTED_PAIRS_MKTEVENTS_H
