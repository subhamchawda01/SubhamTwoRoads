/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_BOLLINGER_BAND_H
#define BASE_INDICATORS_BOLLINGER_BAND_H
...
/// Returns that
class BollingerBand : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static BollingerBand* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  BollingerBand(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "BollingerBand"; }
...
#endif  // BASE_INDICATORS_BOLLINGER_BAND_H
