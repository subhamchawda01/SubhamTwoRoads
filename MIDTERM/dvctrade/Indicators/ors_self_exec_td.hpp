/**
    \file Indicators/ors_self_exec_td.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ORS_SELF_EXEC_TD_H
#define BASE_INDICATORS_ORS_SELF_EXEC_TD_H
...
class ORSSelfExecTD : public CommonIndicator {
 protected:
  // variables
  ...
  // functions
 protected:
  ORSSelfExecTD(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
                SecurityMarketView& _indep_market_view_, double factor_reduced_, double decay_factor_);
 ...
 public:
  ...
  static ORSSelfExecTD* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "ORSSelfExecTD"; }
};
}

#endif  // BASE_INDICATORS_ORS_SELF_EXEC_TD_H
