/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_SIMPLE_MEAN_H
#define BASE_INDICATORS_SIMPLE_MEAN_H
...
class SimpleMean : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static SimpleMean* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  SimpleMean(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "SimpleMean"; }
...
#endif  // BASE_INDICATORS_SIMPLE_MEAN_H
