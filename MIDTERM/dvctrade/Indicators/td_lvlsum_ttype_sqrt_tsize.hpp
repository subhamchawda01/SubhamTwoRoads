/**
    \file Indicators/td_lvlsum_ttype_sqrt_tsize.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_TD_LVLSUM_TTYPE_SQRT_TSIZE_H
#define BASE_INDICATORS_TD_LVLSUM_TTYPE_SQRT_TSIZE_H
...
class TDLvlSumTTypeSqrtTSize : public CommonIndicator {
 protected:
 ...
 protected:
  TDLvlSumTTypeSqrtTSize(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static TDLvlSumTTypeSqrtTSize* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                   const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "TDLvlSumTTypeSqrtTSize"; }
...
#endif  // BASE_INDICATORS_TD_LVLSUM_TTYPE_SQRT_TSIZE_H
