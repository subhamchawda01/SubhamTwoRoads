/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_MKTEVENTS_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_MKTEVENTS_H
...
class OfflineComputedCutoffPairsMktEvents : public IndicatorListener,
 ...
 protected:
  OfflineComputedCutoffPairsMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedCutoffPairsMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                const std::vector<const char*>& _tokens_,
  ...
  static std::string VarName() { return "OfflineComputedCutoffPairsMktEvents"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_MKTEVENTS_H
