/**
    \file Indicators/owp_diff_price_l1.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_TIME_OWP_DIFF_PRICE_L1_H
#define BASE_INDICATORS_TIME_OWP_DIFF_PRICE_L1_H
...
class TimeOwpDiffPriceL1 : public CommonIndicator, public TimePeriodListener {
 protected:
  ...
  unsigned int last_level_shift_msecs_;
 ...
 public:
  ...
  static TimeOwpDiffPriceL1* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  TimeOwpDiffPriceL1(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
  ...
  // functions
  static std::string VarName() { return "TimeOwpDiffPriceL1"; }
...
#endif  // BASE_INDICATORS_TIME_OWP_DIFF_PRICE_L1_H
