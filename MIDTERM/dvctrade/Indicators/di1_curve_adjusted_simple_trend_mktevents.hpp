/**
    \file Indicators/di1_curve_adjusted_simple_trend_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_DI1_CURVE_ADJUSTED_SIMPLE_TREND_MKTEVENTS_H
#define BASE_INDICATORS_DI1_CURVE_ADJUSTED_SIMPLE_TREND_MKTEVENTS_H
...
class DI1CurveAdjustedSimpleTrendMktEvents : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  DI1CurveAdjustedSimpleTrendMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static DI1CurveAdjustedSimpleTrendMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                 const std::vector<const char*>& _tokens_,
  ...
  ~DI1CurveAdjustedSimpleTrendMktEvents() {}
  ...
  // functions
  static std::string VarName() { return "DI1CurveAdjustedSimpleTrendMktEvents"; }
