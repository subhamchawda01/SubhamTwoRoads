/**
    \file Indicators/offline_computed_serban.hpp
...
class OfflineComputedSerban : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  OfflineComputedSerban(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedSerban* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                  const std::vector<const char*>& _tokens_,
  ...
  static OfflineComputedSerban* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                  ...
                                                  double t_indep_trend_momentum_factor_,
                                                  double t_spread_reversion_factor_,
  ...
  static std::string VarName() { return "OfflineComputedSerban"; }
