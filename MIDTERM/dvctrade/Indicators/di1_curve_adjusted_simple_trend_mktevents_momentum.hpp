/**
    \file Indicators/di1_curve_adjusted_simple_trend_mktevents_momentum.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_DI1_CURVE_ADJUSTED_SIMPLE_TREND_MKTEVENTS_MOMENTUM_H
#define BASE_INDICATORS_DI1_CURVE_ADJUSTED_SIMPLE_TREND_MKTEVENTS_MOMENTUM_H
...
class DI1CurveAdjustedSimpleTrendMktEventsMomentum : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  DI1CurveAdjustedSimpleTrendMktEventsMomentum(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static DI1CurveAdjustedSimpleTrendMktEventsMomentum* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                         const std::vector<const char*>& _tokens_,
  ...
  ~DI1CurveAdjustedSimpleTrendMktEventsMomentum() {}
  ...
  // functions
  static std::string VarName() { return "DI1CurveAdjustedSimpleTrendMktEventsMomentum"; }
