/**
    \file Indicators/trend_reversal.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_TREND_REVERSAL_H
#define BASE_INDICATORS_TREND_REVERSAL_H
...
class TrendReversal : public IndicatorListener, public CommonIndicator {
 protected:
 ...
 public:
  ...
  static TrendReversal* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                          const std::vector<const char*>& _tokens_, PriceType_t _basepx_pxtype_);

  static TrendReversal* GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
 ...
 protected:
  TrendReversal(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
                const SecurityMarketView& _indep_market_view_, double _fractional_st_seconds_,
                double _fractional_lt_seconds_, PriceType_t _price_type_);
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "TrendReversal"; }
...
#endif  // BASE_INDICATORS_TREND_REVERSAL_H
