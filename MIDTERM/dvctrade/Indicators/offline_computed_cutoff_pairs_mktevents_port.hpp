/**
    \file Indicators/offline_computed_cutoff_pairs_mktevents_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_MKTEVENTS_PORT_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_MKTEVENTS_PORT_H
...
class OfflineComputedCutoffPairsMktEventsPort : public IndicatorListener,
 ...
 protected:
  ...
  // functions
 protected:
  OfflineComputedCutoffPairsMktEventsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedCutoffPairsMktEventsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                    const std::vector<const char*>& _tokens_,
  ...
  ~OfflineComputedCutoffPairsMktEventsPort() {}
  ...
  // functions
  static std::string VarName() { return "OfflineComputedCutoffPairsMktEventsPort"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_MKTEVENTS_PORT_H
