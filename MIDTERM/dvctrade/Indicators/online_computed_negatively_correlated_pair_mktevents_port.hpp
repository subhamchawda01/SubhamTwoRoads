/**
    \file Indicators/online_computed_negatively_correlated_pair_mktevents_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_COMPUTED_NEGATIVELY_CORRELATED_PAIR_MKTEVENTS_PORT_H
#define BASE_INDICATORS_ONLINE_COMPUTED_NEGATIVELY_CORRELATED_PAIR_MKTEVENTS_PORT_H
...
/// Indicator that is a mktevents decayed version of OnlineComputedNegativelyCorrelatedPairPort
class OnlineComputedNegativelyCorrelatedPairMktEventsPort : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineComputedNegativelyCorrelatedPairMktEventsPort* GetUniqueInstance(
 ...
 protected:
  OnlineComputedNegativelyCorrelatedPairMktEventsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "OnlineComputedNegativelyCorrelatedPairMktEventsPort"; }
...
#endif  // BASE_INDICATORS_ONLINE_COMPUTED_NEGATIVELY_CORRELATED_PAIR_MKTEVENTS_PORT_H
