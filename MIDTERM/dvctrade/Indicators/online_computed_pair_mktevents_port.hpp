/**
    \file Indicators/online_computed_pair_mktevents_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_COMPUTED_PAIR_MKTEVENTS_PORT_H
#define BASE_INDICATORS_ONLINE_COMPUTED_PAIR_MKTEVENTS_PORT_H
...
/// Indicator that is a mktevents decayed version of OnlineComputedPairPort
class OnlineComputedPairMktEventsPort : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineComputedPairMktEventsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                            const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineComputedPairMktEventsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ~OnlineComputedPairMktEventsPort() {}
  ...
  // functions
  // functions
  static std::string VarName() { return "OnlineComputedPairMktEventsPort"; }
...
#endif  // BASE_INDICATORS_ONLINE_COMPUTED_PAIR_MKTEVENTS_PORT_H
