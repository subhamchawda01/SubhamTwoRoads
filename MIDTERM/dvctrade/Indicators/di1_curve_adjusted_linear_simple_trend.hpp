/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_DI1_CURVE_ADJUSTED_LINEAR_SIMPLE_TREND_H
#define BASE_INDICATORS_DI1_CURVE_ADJUSTED_LINEAR_SIMPLE_TREND_H
...
class DI1CurveAdjustedLinearSimpleTrend : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  DI1CurveAdjustedLinearSimpleTrend(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static DI1CurveAdjustedLinearSimpleTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                              const std::vector<const char*>& _tokens_,
  ...
  ~DI1CurveAdjustedLinearSimpleTrend() {}
  ...
  // functions
  static std::string VarName() { return "DI1CurveAdjustedLinearSimpleTrend"; }
