/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_STUD_PRICE_RETURNS_DIFF_H
#define BASE_INDICATORS_STUD_PRICE_RETURNS_DIFF_H
...
class StudPriceReturnsDiff : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static StudPriceReturnsDiff *GetUniqueInstance(DebugLogger &_dbglogger_, const Watch &_watch_,
                                                 const std::vector<const char *> &_tokens_,
 ...
 protected:
  StudPriceReturnsDiff(DebugLogger &_dbglogger_, const Watch &_watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "StudPriceReturnsDiff"; }
