/**
    \file Indicators/valuew_bp_momentum.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_VALUEW_BP_MOMENTUM_H
#define BASE_INDICATORS_VALUEW_BP_MOMENTUM_H
...
class ValueWBPMomentum : public CommonIndicator, public SMVPLChangeListener, public TimePeriodListener {
 protected:
  // variables
  ...
  double bidpressure_;
  double askpressure_;
  double synthetic_volume_;
  double percentage_;
  MktStatus_t last_mkt_status_;
  // functions
 protected:
  ValueWBPMomentum(DebugLogger& _dbglogger_, const Watch& _watch_, SecurityMarketView* _indep_security_market_view_,
                   std::string _concise_indicator_description_, unsigned int _num_levels_, double _level_decay_factor_,
 ...
 public:
  ...
  static ValueWBPMomentum* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
...
#undef MAX_LEVEL_DECAY_VECTOR_SIZE
  ...
  // functions
  static std::string VarName() { return "ValueWBPMomentum"; }
...
#endif  // BASE_INDICATORS_SIZEW_BP_MOMENTUM_H
