...
class ValueWBPMomentum2 : public CommonIndicator, public SMVPLChangeListener, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  ValueWBPMomentum2(DebugLogger& _dbglogger_, const Watch& _watch_, SecurityMarketView* _indep_security_market_view_,
 ...
 public:
  ...
  static ValueWBPMomentum2* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
...
#undef MAX_LEVEL_DECAY_VECTOR_SIZE
  ...
  // functions
  static std::string VarName() { return "ValueWBPMomentum2"; }
