/**
    \file Indicators/offline_computed_pairs.hpp
...
class OfflineComputedReturnsPairs : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  OfflineComputedReturnsPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedReturnsPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                        const std::vector<const char*>& _tokens_,
  ...
  static std::string VarName() { return "OfflineComputedReturnsPairs"; }
 ...
 protected:
  ...
  /// and OfflineComputedReturnsPairs
