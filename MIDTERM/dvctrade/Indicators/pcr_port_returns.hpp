/**
   \file Indicators/pcr_port_returns.hpp
...
class PCRPortReturns : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
  ...
  std::vector<std::vector<double>> eigen_matrix_;
  std::vector<double> beta_vector_;
  std::vector<double> stdev_vector_;
 ...
 public:
  ...
  static PCRPortReturns* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                           const std::vector<const char*>& _tokens_, PriceType_t _basepx_pxtype_);

  static PCRPortReturns* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                           const std::string& _portfolio_,
                                           const std::string& _portfolio_descriptor_shortcode_,
                                           double _fractional_seconds_, int _lookback_days_, int _num_eigenvectors_,
                                           int _mode_, PriceType_t _price_type_);

 protected:
  PCRPortReturns(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
                 const std::string& _portfolio_, const std::string& _portfolio_descriptor_shortcode_,
                 double _fractional_seconds_, int _lookback_days_, int _num_eigenvectors_, int _mode_,
 ...
 public:
  ...
  static std::string VarName() { return "PCRPortReturns"; }
