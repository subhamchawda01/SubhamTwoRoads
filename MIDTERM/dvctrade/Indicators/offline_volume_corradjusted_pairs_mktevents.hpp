/**
    \file Indicators/offline_volume_corradjusted_pairs_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_VOLUME_CORRADJUSTED_PAIRS_MKTEVENTS_H
#define BASE_INDICATORS_OFFLINE_VOLUME_CORRADJUSTED_PAIRS_MKTEVENTS_H
...
/// Similar to OfflineVolumeCorradjustedPairs
/// except in computation of trends the indicator used is SimpleTrendMktEvents
/// instead of SimpleTrend, i.e. the price changes are decayed by events and not time.
/// For theory on the multiplier read OfflineVolumeCorradjustedPairs
class OfflineVolumeCorradjustedPairsMktEvents : public IndicatorListener,
                                                public CommonIndicator,
                                                public RecentVolumeRatioListener,
 ...
 protected:
  ...
  SimpleTrendMktEvents* p_indep_indicator_;

 protected:
  OfflineVolumeCorradjustedPairsMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineVolumeCorradjustedPairsMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                    const std::vector<const char*>& _tokens_,
  ...
  ~OfflineVolumeCorradjustedPairsMktEvents() {}

  // listener interface
  void OnTimePeriodUpdate(const int num_pages_to_add_) { UpdateLRInfo(); }

  inline void OnVolumeRatioUpdate(const double& r_new_volume_ratio_value_) {
    recent_volume_ratio_ = r_new_volume_ratio_value_;
  }
  ...
  static std::string VarName() { return "OfflineVolumeCorradjustedPairsMktEvents"; }
...
#endif  // BASE_INDICATORS_OFFLINE_VOLUME_CORRADJUSTED_PAIRS_MKTEVENTS_H
