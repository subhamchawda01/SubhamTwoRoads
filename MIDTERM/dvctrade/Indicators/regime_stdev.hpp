/**
    \file Indicators/regime_stdev.cpp
...
class RegimeStdev : public IndicatorListener, public CommonIndicator {
 protected:
  SecurityMarketView& indep_market_view_;
  SlowStdevCalculator* p_stdev_calculator;
 ...
 public:
  ...
  static RegimeStdev* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                        const std::vector<const char*>& _tokens_, PriceType_t _basepx_pxtype_);

  static RegimeStdev* GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
                                        SecurityMarketView& _indep_market_view_, double fractional_sec,
                                        double switch_threshold, double tolerance);

 protected:
  RegimeStdev(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  inline void SubscribeDataInterrupts(MarketUpdateManager& market_update_manager_) {
    if (p_stdev_calculator != NULL) market_update_manager_.AddMarketDataInterruptedListener(p_stdev_calculator);
  }
  ...
  // functions
  static std::string VarName() { return "RegimeStdev"; }
