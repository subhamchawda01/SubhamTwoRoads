/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_EXPONENTIAL_MOVING_AVERAGE_H
#define BASE_INDICATORS_EXPONENTIAL_MOVING_AVERAGE_H
...
class ExponentialMovingAverage : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static ExponentialMovingAverage* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                     const std::vector<const char*>& _tokens_,
 ...
 protected:
  ExponentialMovingAverage(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "ExponentialMovingAverage"; }
