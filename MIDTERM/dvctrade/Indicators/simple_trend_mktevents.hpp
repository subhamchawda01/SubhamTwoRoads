/**
    \file Indicators/simple_trend_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_SIMPLE_TREND_MKTEVENTS_H
#define BASE_INDICATORS_SIMPLE_TREND_MKTEVENTS_H
...
class SimpleTrendMktEvents : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static SimpleTrendMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  SimpleTrendMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "SimpleTrendMktEvents"; }
