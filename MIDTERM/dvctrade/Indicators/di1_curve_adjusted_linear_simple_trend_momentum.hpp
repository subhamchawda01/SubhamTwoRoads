/**
    \file Indicators/di1_curve_adjusted_linear_simple_trend.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2013
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_DI1_CURVE_ADJUSTED_LINEAR_SIMPLE_TREND_MOMENTUM_H
#define BASE_INDICATORS_DI1_CURVE_ADJUSTED_LINEAR_SIMPLE_TREND_MOMENTUM_H
...
class DI1CurveAdjustedLinearSimpleTrendMomentum : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  DI1CurveAdjustedLinearSimpleTrendMomentum(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static DI1CurveAdjustedLinearSimpleTrendMomentum* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                      const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "DI1CurveAdjustedLinearSimpleTrendMomentum"; }
