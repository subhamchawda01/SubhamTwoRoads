/**
    \file Indicators/ors_self_exec.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ORS_SELF_EXEC_H
#define BASE_INDICATORS_ORS_SELF_EXEC_H
...
class ORSSelfExec : public CommonIndicator {
 protected:
  // variables
  ...
  // functions
 protected:
  ORSSelfExec(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
              SecurityMarketView& _indep_market_view_, double factor_reduced_);
 ...
 public:
  ...
  static ORSSelfExec* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "ORSSelfExec"; }
  void OnMarketDataInterrupted(const unsigned int _security_id_, const int msecs_since_last_receive_);
  void OnMarketDataResumed(const unsigned int _security_id_);
};
}

#endif  // BASE_INDICATORS_ORS_SELF_EXEC_H
