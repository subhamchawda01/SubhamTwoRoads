/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_DI1_CURVE_ADJUSTED_LINEAR_SIMPLE_TREND_MKTEVENTS_H
#define BASE_INDICATORS_DI1_CURVE_ADJUSTED_LINEAR_SIMPLE_TREND_MKTEVENTS_H
...
class DI1CurveAdjustedLinearSimpleTrendMktEvents : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  DI1CurveAdjustedLinearSimpleTrendMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static DI1CurveAdjustedLinearSimpleTrendMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                       const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "DI1CurveAdjustedLinearSimpleTrendMktEvents"; }
