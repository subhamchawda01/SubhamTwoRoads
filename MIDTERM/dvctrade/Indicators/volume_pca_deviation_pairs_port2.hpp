...
class VolumePCADeviationPairsPort2 : public IndicatorListener,
 ...
 protected:
  ...
  int dep_trend_indicator_index_;
  ...
  double brk_trend_val_;
  double dep_trend_val_;
 ...
 public:
  ...
  static VolumePCADeviationPairsPort2 *GetUniqueInstance(DebugLogger &_dbglogger_, const Watch &_watch_,
                                                         const std::vector<const char *> &_tokens_,
 ...
 protected:
  VolumePCADeviationPairsPort2(DebugLogger &_dbglogger_, const Watch &_watch_,
                               ...
                               const std::vector<double> &t_eigen_components_, const double _brk_trend_fac_,
                               const PriceType_t _price_type_);

 public:
  ~VolumePCADeviationPairsPort2() {}
  ...
  static std::string VarName() { return "VolumePCADeviationPairsPort2"; }
