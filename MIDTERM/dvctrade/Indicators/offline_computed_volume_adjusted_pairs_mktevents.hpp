/**
    \file Indicators/offline_computed_volume_adjusted_pairs_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_VOLUME_ADJUSTED_PAIRS_MKTEVENTS_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_VOLUME_ADJUSTED_PAIRS_MKTEVENTS_H
...
/// Event-decayed version of SimpleTrend i.e. SimpleTrendMktEvents used
/// otherwise same as OfflineComputedVolumeAdjustedPairs
/// computes projected return by taking EWMA_return of indep, multiplied by
/// lr_coeff_ and decut realized EWMA_return of dep
class OfflineComputedVolumeAdjustedPairsMktEvents : public IndicatorListener,
 ...
 protected:
  OfflineComputedVolumeAdjustedPairsMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedVolumeAdjustedPairsMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                        const std::vector<const char*>& _tokens_,
  ...
  ~OfflineComputedVolumeAdjustedPairsMktEvents() {}
  ...
  static std::string VarName() { return "OfflineComputedVolumeAdjustedPairsMktEvents"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_VOLUME_ADJUSTED_PAIRS_MKTEVENTS_H
