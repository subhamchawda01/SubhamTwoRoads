/**
    \file Indicators/offline_computed_cutoff_pairs_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_PORT_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_PORT_H
...
class OfflineComputedCutoffPairsPort : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
 ...
 public:
  ...
  static OfflineComputedCutoffPairsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                           const std::vector<const char*>& _tokens_,
 ...
 protected:
  OfflineComputedCutoffPairsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
                                 const std::string& concise_indicator_description_,
                                 SecurityMarketView& _dep_market_view_, std::string _portfolio_descriptor_shortcode_,
                                 double _fractional_seconds_, PriceType_t _price_type_);

 public:
  ~OfflineComputedCutoffPairsPort() {}
  ...
  static std::string VarName() { return "OfflineComputedCutoffPairsPort"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_PORT_H
