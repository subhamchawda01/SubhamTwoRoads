/**
    \file Indicators/offline_computed_pairs_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_PAIRS_MKTEVENTS_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_PAIRS_MKTEVENTS_H
...
class OfflineComputedPairsMktEvents : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
 ...
 protected:
  OfflineComputedPairsMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
                                const std::string& concise_indicator_description_,
                                SecurityMarketView& _dep_market_view_, SecurityMarketView& _indep_market_view_,
                                unsigned int _num_events_halflife_, PriceType_t _price_type_, bool _use_time_ = false);
 ...
 public:
  ...
  static OfflineComputedPairsMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                          const std::vector<const char*>& _tokens_,
  ...
  static std::string VarName() { return "OfflineComputedPairsMktEvents"; }
