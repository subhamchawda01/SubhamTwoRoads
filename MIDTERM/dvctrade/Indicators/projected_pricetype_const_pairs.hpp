/**
    \file Indicators/projected_pricetype_const_pairs.hpp
...
#ifndef PROJECTED_PRICE_TYPE_CONST_PAIRS_HPP_
#define PROJECTED_PRICE_TYPE_CONST_PAIRS_HPP_
...
namespace HFSAT {
class ProjectedPriceTypeConstPairs : public CommonIndicator, public SlowStdevCalculatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static ProjectedPriceTypeConstPairs *GetUniqueInstance(DebugLogger &_dbglogger_, const Watch &_watch_,
                                                         const std::vector<const char *> &_tokens_,
 ...
 protected:
  ProjectedPriceTypeConstPairs(DebugLogger &_dbglogger_, const Watch &_watch_,
 ...
 public:
  ...
  static std::string VarName() { return "ProjectedPriceTypeConstPairs"; }
