/**
    \file Indicators/offline_corradjusted_pairs_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_CORRADJUSTED_PAIRS_PORT_H
#define BASE_INDICATORS_OFFLINE_CORRADJUSTED_PAIRS_PORT_H
...
class OfflineCorradjustedPairsPort : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
 ...
 protected:
  OfflineCorradjustedPairsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineCorradjustedPairsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                         const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "OfflineCorradjustedPairsPort"; }
...
#endif  // BASE_INDICATORS_OFFLINE_CORRADJUSTED_PAIRS_PORT_H
