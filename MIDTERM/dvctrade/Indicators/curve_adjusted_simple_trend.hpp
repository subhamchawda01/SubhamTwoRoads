/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_CURVE_ADJUSTED_SIMPLE_TREND_H
#define BASE_INDICATORS_CURVE_ADJUSTED_SIMPLE_TREND_H
...
class CurveAdjustedSimpleTrend : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  CurveAdjustedSimpleTrend(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static CurveAdjustedSimpleTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                     const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "CurveAdjustedSimpleTrend"; }
