/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_STDEV_ADJUSTED_RETURNS_DIFF_H
#define BASE_INDICATORS_STDEV_ADJUSTED_RETURNS_DIFF_H
...
class StdevAdjustedReturnsDiff : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static StdevAdjustedReturnsDiff *GetUniqueInstance(DebugLogger &_dbglogger_, const Watch &_watch_,
                                                     const std::vector<const char *> &_tokens_,
 ...
 protected:
  StdevAdjustedReturnsDiff(DebugLogger &_dbglogger_, const Watch &_watch_,
                           const std::string &concise_indicator_description_,
                           const SecurityMarketView &_dep_market_view_, const SecurityMarketView &_indep_market_view_,
                           double _indicator_duration_, double _stdev_duration_, PriceType_t _price_type_);

 public:
  ~StdevAdjustedReturnsDiff() {}
  ...
  // functions
  static std::string VarName() { return "StdevAdjustedReturnsDiff"; }
...
#endif  // BASE_INDICATORS_STDEV_ADJUSTED_RETURNS_DIFF_H
