/**
    \file Indicators/online_ratio_projected_price_diff.hpp
   ...
   +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_RATIO_PROJECTED_PRICE_DIFF_H
#define BASE_INDICATORS_ONLINE_RATIO_PROJECTED_PRICE_DIFF_H
...
class OnlineRatioProjectedPriceDiff : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineRatioProjectedPriceDiff* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                          const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineRatioProjectedPriceDiff(DebugLogger& _dbglogger_, const Watch& _watch_,
                                const std::string& concise_indicator_description_,
                                SecurityMarketView& _dep_market_view_, SecurityMarketView& _indep_market_view_,
                                double _fractional_seconds_, PriceType_t _price_type_);

 public:
  ~OnlineRatioProjectedPriceDiff() {}
  ...
  static std::string VarName() { return "OnlineRatioProjectedPriceDiff"; }
...
#endif  // BASE_INDICATORS_ONLINE_RATIO_PROJECTED_PRICE_DIFF_H
