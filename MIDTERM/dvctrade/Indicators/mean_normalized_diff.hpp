/**
    \file Indicators/mean_normalized_diff.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_MEAN_NORMALIZED_DIFF_H
#define BASE_INDICATORS_MEAN_NORMALIZED_DIFF_H
...
class MeanNormalizedDiff : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static MeanNormalizedDiff* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  MeanNormalizedDiff(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "MeanNormalizedDiff"; }
