/**
    \file Indicators/online_ratio_pairs.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_DIFF_PAIRS_NK_H
#define BASE_INDICATORS_ONLINE_DIFF_PAIRS_NK_H
...
class OnlineDiffPairsNK : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineDiffPairsNK* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  OnlineDiffPairsNK(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  static std::string VarName() { return "OnlineDiffPairsNK"; }
...
#endif  // BASE_INDICATORS_ONLINE_DIFF_PAIRS_H
