/**
    \file Indicators/offline_computed_smart_cutoff_pairs.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_SMART_CUTOFF_PAIRS_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_SMART_CUTOFF_PAIRS_H
...
/**
 * This indicator is built of top of OfflineComputedCutoffPairs.
 * The idea is that when the products are diverging, then return the indicator value as 0
 */
class OfflineComputedSmartCutoffPairs : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  SlowStdevTrendCalculator* p_stdev_trend_indicator_;
  bool lrdb_sign_;

  // functions
 protected:
  OfflineComputedSmartCutoffPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
                                  const std::string& concise_indicator_description_,
                                  SecurityMarketView& _dep_market_view_, SecurityMarketView& _indep_market_view_,
                                  double _fractional_seconds_, double _stdev_duration_, double _divergence_factor_,
 ...
 public:
  ...
  static OfflineComputedSmartCutoffPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                            const std::vector<const char*>& _tokens_,
  ...
  static OfflineComputedSmartCutoffPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                            ...
                                                            double _divergence_factor_, PriceType_t _price_type_);

  ~OfflineComputedSmartCutoffPairs() {}
  ...
  static std::string VarName() { return "OfflineComputedSmartCutoffPairs"; }
 ...
 protected:
  ...
  inline void ComputeMultiplier() {
    ...
    if (current_lrinfo_.lr_correlation_ >= 0)
      lrdb_sign_ = true;
    else
      lrdb_sign_ = false;
  }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_SMART_CUTOFF_PAIRS_H
