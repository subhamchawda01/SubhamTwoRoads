...
class TrendingMeanReverting : public CommonIndicator {
 protected:
  // variables
  const SecurityMarketView& dep_market_view_;
  unsigned int pred_mode_;
  double last_px_;
  double last_recorded_px_;
  double current_dep_price_;
  int num_px_moves_;
  int last_recorded_msecs_;
  int width_msecs_;
  double indicator_threshold_;
  double trend_mean_rev_measure_;

 protected:
  TrendingMeanReverting(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static TrendingMeanReverting* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                  const std::vector<const char*>& _tokens_,
  ...
  static std::string VarName() { return "TrendingMeanReverting"; }
