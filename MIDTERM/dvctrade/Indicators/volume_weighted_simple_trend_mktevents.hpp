/**
    \file Indicators/volume_weighted_simple_trend_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_VOLUME_WEIGHTED_SIMPLE_TREND_MKTEVENTS_H
#define BASE_INDICATORS_VOLUME_WEIGHTED_SIMPLE_TREND_MKTEVENTS_H
...
class VolumeWeightedSimpleTrendMktEvents : public CommonIndicator,
 ...
 public:
  ...
  static VolumeWeightedSimpleTrendMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                               const std::vector<const char*>& _tokens_,
  ...
  static VolumeWeightedSimpleTrendMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                               ...
                                                               double _volume_ratio_exponent_,
                                                               PriceType_t _price_type_);

 protected:
  VolumeWeightedSimpleTrendMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ~VolumeWeightedSimpleTrendMktEvents() {}
  ...
  // functions
  static std::string VarName() { return "VolumeWeightedSimpleTrendMktEvents"; }
...
#endif  // BASE_INDICATORS_VOLUME_WEIGHTED_SIMPLE_TREND_MKTEVENTS_H
