...
/// StabledScaledTredVersion2Port takes that time period as one of the input.
class StableScaledTrendVersion2Port : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static StableScaledTrendVersion2Port* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                          const std::vector<const char*>& _tokens_,
 ...
 protected:
  StableScaledTrendVersion2Port(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "StableScaledTrendVersion2Port"; }
