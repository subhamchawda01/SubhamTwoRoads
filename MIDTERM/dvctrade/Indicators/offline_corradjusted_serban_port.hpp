/**
    \file Indicators/offline_corradjusted_serban_port.hpp
...
class OfflineCorradjustedSerbanPort : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  OfflineCorradjustedSerbanPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineCorradjustedSerbanPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                          const std::vector<const char*>& _tokens_,
                                                          PriceType_t _basepx_pxtype_);

  static OfflineCorradjustedSerbanPort* GetUniqueInstance(
  ...
  static std::string VarName() { return "OfflineCorradjustedSerbanPort"; }
 ...
 protected:
  ...
  /// and OfflineCorradjustedSerbanPort
