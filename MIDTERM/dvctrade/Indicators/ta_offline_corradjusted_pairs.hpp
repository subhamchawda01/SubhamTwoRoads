/**
    \file Indicators/ta_offline_corradjusted_pairs.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_TA_OFFLINE_CORRADJUSTED_PAIRS_H
#define BASE_INDICATORS_TA_OFFLINE_CORRADJUSTED_PAIRS_H
...
class TAOfflineCorradjustedPairs : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  TradeAdjustedSimpleTrend* p_dep_indicator_;
  TradeAdjustedSimpleTrend* p_indep_indicator_;
 ...
 protected:
  TAOfflineCorradjustedPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static TAOfflineCorradjustedPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                       const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "TAOfflineCorradjustedPairs"; }
 ...
 protected:
  ...
  /// From price changes, we compute the coefficient and corerlation through Single Linear Regression
  /// < lr_coeff_, lr_correlation_ > = GetSLRCoeffCorrelation ( dep_price_change_vector_, indep_price_change_vector_ )
  /// For TAOfflineCorradjustedPairs lr_coeff_/fabs(lr_correlation_) is sort of the lr_coeff_ as it would be if indep
...
#endif  // BASE_INDICATORS_TA_OFFLINE_CORRADJUSTED_PAIRS_H
