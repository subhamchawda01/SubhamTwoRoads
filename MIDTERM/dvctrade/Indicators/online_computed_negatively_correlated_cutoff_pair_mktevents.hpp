/**
    \file Indicators/online_computed_negatively_correalted_cutoff_pair_mktevents.hpp
...
/// Indicator that is very similar to OnlineComputedCutoffPairMktEvents
...
/// price_type_ ) )
class OnlineComputedNegativelyCorrelatedCutoffPairMktEvents : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineComputedNegativelyCorrelatedCutoffPairMktEvents* GetUniqueInstance(
 ...
 protected:
  OnlineComputedNegativelyCorrelatedCutoffPairMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static std::string VarName() { return "OnlineComputedNegativelyCorrelatedCutoffPairMktEvents"; }
