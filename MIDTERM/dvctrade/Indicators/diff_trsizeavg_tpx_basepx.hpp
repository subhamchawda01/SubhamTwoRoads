/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_DIFF_TRSIZEAVG_TPX_BASEPX_H
#define BASE_INDICATORS_DIFF_TRSIZEAVG_TPX_BASEPX_H
...
class DiffTRSizeAvgTPxBasepx : public CommonIndicator {
 protected:
  // variables
 ...
 protected:
  DiffTRSizeAvgTPxBasepx(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static DiffTRSizeAvgTPxBasepx* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                   const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "DiffTRSizeAvgTPxBasepx"; }
