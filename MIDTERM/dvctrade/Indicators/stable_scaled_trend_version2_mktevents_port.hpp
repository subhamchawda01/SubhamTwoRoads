...
/// StabledScaledTredVersion2MktEventsPort takes that time period as one of the input.
class StableScaledTrendVersion2MktEventsPort : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static StableScaledTrendVersion2MktEventsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                   const std::vector<const char*>& _tokens_,
 ...
 protected:
  StableScaledTrendVersion2MktEventsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
                                         const std::string& concise_indicator_description_,
                                         const std::string& _portfolio_descriptor_shortcode_,
                                         unsigned int _num_events_halflife_, double _stdev_duration_,
                                         PriceType_t _price_type_);

 public:
  ~StableScaledTrendVersion2MktEventsPort() {}
  ...
  // functions
  static std::string VarName() { return "StableScaledTrendVersion2MktEventsPort"; }
