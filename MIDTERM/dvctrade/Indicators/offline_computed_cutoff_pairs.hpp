/**
    \file Indicators/offline_computed_cutoff_pairs.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_H
...
class OfflineComputedCutoffPairs : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  OfflineComputedCutoffPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedCutoffPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                       const std::vector<const char*>& _tokens_,
  ...
  static std::string VarName() { return "OfflineComputedCutoffPairs"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_CUTOFF_PAIRS_H
