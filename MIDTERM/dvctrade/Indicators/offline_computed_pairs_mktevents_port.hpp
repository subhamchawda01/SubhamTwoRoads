/**
    \file Indicators/offline_computed_pairs_mktevents_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_PAIRS_MKTEVENTS_PORT_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_PAIRS_MKTEVENTS_PORT_H
...
class OfflineComputedPairsMktEventsPort : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  OfflineComputedPairsMktEventsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedPairsMktEventsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                              const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "OfflineComputedPairsMktEventsPort"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_PAIRS_MKTEVENTS_PORT_H
