/**
   \file Indicators/volume_weighted_simple_trend_port.hpp
...
class VolumeWeightedSimpleTrendPort : public CommonIndicator,
 ...
 public:
  ...
  static VolumeWeightedSimpleTrendPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                          const std::vector<const char*>& _tokens_,
 ...
 protected:
  VolumeWeightedSimpleTrendPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static std::string VarName() { return "VolumeWeightedSimpleTrendPort"; }
