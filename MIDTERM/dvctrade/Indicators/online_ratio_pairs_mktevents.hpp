/**
    \file Indicators/online_ratio_pairs_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_RATIO_PAIRS_MKTEVENTS_H
#define BASE_INDICATORS_ONLINE_RATIO_PAIRS_MKTEVENTS_H
...
class OnlineRatioPairsMktEvents : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineRatioPairsMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                      const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineRatioPairsMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static std::string VarName() { return "OnlineRatioPairsMktEvents"; }
...
#endif  // BASE_INDICATORS_ONLINE_RATIO_PAIRS_MKTEVENTS_H
