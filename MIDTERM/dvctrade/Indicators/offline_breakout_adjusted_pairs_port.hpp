/**
   \file Indicators/offline_breakout_adjusted_pairs_port.hpp
...
class OfflineBreakoutAdjustedPairsPort : public IndicatorListener,
 ...
 protected:
  ...
  RecentScaledVolumeCalculator& dep_scaled_volume_calculator_;
  RecentScaledVolumeCalculatorPort& indep_scaled_volume_calculator_;
  ...
  double scaled_dep_volume_;
  double scaled_indep_volume_;
 ...
 protected:
  OfflineBreakoutAdjustedPairsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineBreakoutAdjustedPairsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                             const std::vector<const char*>& _tokens_,
  ...
  ~OfflineBreakoutAdjustedPairsPort() {}
  ...
  static std::string VarName() { return "OfflineBreakoutAdjustedPairsPort"; }
 ...
 protected:
  ...
  /// From price changes, we compute the coefficient and corerlation through Single Linear Regression
  /// < lr_coeff_, lr_correlation_ > = GetSLRCoeffCorrelation ( dep_price_change_vector_, indep_price_change_vector_ )
  /// For OfflineBreakoutAdjustedPairsPort lr_coeff_/fabs(lr_correlation_) is sort of the lr_coeff_ as it would be if
