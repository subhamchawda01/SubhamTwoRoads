/**
    \file Indicators/stud_price_trend_diff_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_STUD_PRICE_TREND_DIFF_PORT_H
#define BASE_INDICATORS_STUD_PRICE_TREND_DIFF_PORT_H
...
namespace HFSAT {
/*
 * This indicator comoutes online stdev of trends of prices for both dep and indep. Indicator value is given by
 * following formula :
 * trend(indep)/ stdev(indep) - trend(dep)/stdev(dep)
 */
class StudPriceTrendDiffPort : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static StudPriceTrendDiffPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                   const std::vector<const char*>& _tokens_,
 ...
 protected:
  StudPriceTrendDiffPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "StudPriceTrendDiffPort"; }
