/**
    \file Indicators/ors_self_exec_recent_orders_td.hpp
...
class ORSSelfExecRecentOrdersTD : public CommonIndicator {
 protected:
  // variables
  ...
  unsigned int num_trades_before_next_mkt_update_;
  ...
  // functions
 protected:
  ORSSelfExecRecentOrdersTD(DebugLogger& _dbglogger_, const Watch& _watch_,
                            const std::string& concise_indicator_description_, SecurityMarketView& _indep_market_view_,
                            double factor_reduced_, double _decay_factor_, double _recent_order_threshold_);
 ...
 public:
  ...
  static ORSSelfExecRecentOrdersTD* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                      const std::vector<const char*>& _tokens_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "ORSSelfExecRecentOrdersTD"; }
};
}
