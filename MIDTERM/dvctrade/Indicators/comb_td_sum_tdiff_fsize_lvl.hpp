/**
    \file Indicators/comb_td_sum_tdiff_fsize_lvl.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_COMB_TD_SUM_TDIFF_FSIZE_LVL_H
#define BASE_INDICATORS_COMB_TD_SUM_TDIFF_FSIZE_LVL_H
...
class CombTDSumTDiffFSizeLvl : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  TDSumTDiffFSizeLvl* p_st_indicator_;
  TDSumTDiffFSizeLvl* p_lt_indicator_;
 ...
 public:
  ...
  static CombTDSumTDiffFSizeLvl* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                   const std::vector<const char*>& _tokens_,
                                                   PriceType_t _basepx_pxtype_);

  static CombTDSumTDiffFSizeLvl* GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
                                                   SecurityMarketView& _indep_market_view_,
                                                   double _fractional_st_seconds_, double _fractional_lt_seconds_);

 protected:
  CombTDSumTDiffFSizeLvl(DebugLogger& _dbglogger_, const Watch& _watch_,
                         const std::string& concise_indicator_description_, SecurityMarketView& _indep_market_view_,
                         double _fractional_st_seconds_, double _fractional_lt_seconds_);

 public:
  ~CombTDSumTDiffFSizeLvl() {}
  ...
  // functions
  static std::string VarName() { return "CombTDSumTDiffFSizeLvl"; }
...
#endif  // BASE_INDICATORS_COMB_TD_SUM_TDIFF_FSIZE_LVL_H
