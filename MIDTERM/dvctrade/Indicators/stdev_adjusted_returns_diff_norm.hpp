/**
    \file Indicators/stdev_adjusted_returns_diff_norm.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_STDEV_ADJUSTED_RETURNS_DIFF_NORM_H
#define BASE_INDICATORS_STDEV_ADJUSTED_RETURNS_DIFF_NORM_H
...
class StdevAdjustedReturnsDiffNorm : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static StdevAdjustedReturnsDiffNorm *GetUniqueInstance(DebugLogger &_dbglogger_, const Watch &_watch_,
                                                         const std::vector<const char *> &_tokens_,
 ...
 protected:
  StdevAdjustedReturnsDiffNorm(DebugLogger &_dbglogger_, const Watch &_watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "StdevAdjustedReturnsDiffNorm"; }
...
#endif  // BASE_INDICATORS_STDEV_ADJUSTED_RETURNS_DIFF_NORM_H
