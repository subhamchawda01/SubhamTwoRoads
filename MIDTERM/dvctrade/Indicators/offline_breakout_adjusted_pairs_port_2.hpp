...
class OfflineBreakoutAdjustedPairsPort2 : public IndicatorListener,
 ...
 protected:
  OfflineBreakoutAdjustedPairsPort2(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineBreakoutAdjustedPairsPort2* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                              const std::vector<const char*>& _tokens_,
  ...
  ~OfflineBreakoutAdjustedPairsPort2() {}
  ...
  static std::string VarName() { return "OfflineBreakoutAdjustedPairsPort2"; }
 ...
 protected:
  ...
  /// From price changes, we compute the coefficient and corerlation through Single Linear Regression
  /// < lr_coeff_, lr_correlation_ > = GetSLRCoeffCorrelation ( dep_price_change_vector_, indep_price_change_vector_ )
  /// For OfflineBreakoutAdjustedPairsPort2 lr_coeff_/fabs(lr_correlation_) is sort of the lr_coeff_ as it would be if
