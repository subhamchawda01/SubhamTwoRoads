/**
    \file Indicators/offline_computed_volume_adjusted_pairs.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_VOLUME_ADJUSTED_PAIRS_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_VOLUME_ADJUSTED_PAIRS_H
...
class OfflineComputedVolumeAdjustedPairs : public IndicatorListener,
 ...
 protected:
  ...
  // functions
 protected:
  OfflineComputedVolumeAdjustedPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineComputedVolumeAdjustedPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                               const std::vector<const char*>& _tokens_,
  ...
  ~OfflineComputedVolumeAdjustedPairs() {}
  ...
  static std::string VarName() { return "OfflineComputedVolumeAdjustedPairs"; }
 ...
 protected:
  ...
  /// and OfflineComputedVolumeAdjustedPairs
  inline void ComputeMultiplier() { current_projection_multiplier_ = current_lrinfo_.lr_coeff_; }
};
}

#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_VOLUME_ADJUSTED_PAIRS_H
