/**
    \file Indicators/offline_volume_corradjusted_pairs.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_VOLUME_CORRADJUSTED_PAIRS_H
#define BASE_INDICATORS_OFFLINE_VOLUME_CORRADJUSTED_PAIRS_H
...
class OfflineVolumeCorradjustedPairs : public IndicatorListener,
 ...
 protected:
  OfflineVolumeCorradjustedPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineVolumeCorradjustedPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                           const std::vector<const char*>& _tokens_,
  ...
  ~OfflineVolumeCorradjustedPairs() {}
  ...
  static std::string VarName() { return "OfflineVolumeCorradjustedPairs"; }
 ...
 protected:
  ...
  /// From price changes, we compute the coefficient and corerlation through Single Linear Regression
  /// < lr_coeff_, lr_correlation_ > = GetSLRCoeffCorrelation ( dep_price_change_vector_, indep_price_change_vector_ )
  /// For OfflineVolumeCorradjustedPairs lr_coeff_/fabs(lr_correlation_) is sort of the lr_coeff_ as it would be if
  /// indep and dep are either perfectly correlated or
...
#endif  // BASE_INDICATORS_OFFLINE_VOLUME_CORRADJUSTED_PAIRS_H
