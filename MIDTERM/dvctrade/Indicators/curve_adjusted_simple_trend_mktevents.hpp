/**
    \file Indicators/curve_adjusted_simple_trend_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_CURVE_ADJUSTED_SIMPLE_TREND_MKTEVENTS_H
#define BASE_INDICATORS_CURVE_ADJUSTED_SIMPLE_TREND_MKTEVENTS_H
...
class CurveAdjustedSimpleTrendMktEvents : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  CurveAdjustedSimpleTrendMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static CurveAdjustedSimpleTrendMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                              const std::vector<const char*>& _tokens_,
  ...
  ~CurveAdjustedSimpleTrendMktEvents() {}
  ...
  // functions
  static std::string VarName() { return "CurveAdjustedSimpleTrendMktEvents"; }
