...
class MovingAvgTradeSize : public CommonIndicator {
 protected:
  // variables
  ...
  double moving_avg_trade_size_;

  double last_trade_size_recorded_;
 ...
 public:
  ...
  static MovingAvgTradeSize* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  MovingAvgTradeSize(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "MovingAvgTradeSize"; }
