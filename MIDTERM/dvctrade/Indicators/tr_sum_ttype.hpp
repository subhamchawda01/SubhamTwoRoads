/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_TR_SUM_TTYPE_H
#define BASE_INDICATORS_TR_SUM_TTYPE_H
...
class TRSumTType : public CommonIndicator {
 protected:
  const SecurityMarketView& indep_market_view_;
  TradeDecayedTradeInfoManager& trade_decayed_trade_info_manager_;

 protected:
  TRSumTType(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  static TRSumTType* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  // functions
  static std::string VarName() { return "TRSumTType"; }
