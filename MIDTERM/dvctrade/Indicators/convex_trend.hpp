/**
    \file Indicators/convex_trend.hpp
...
class ConvexTrend : public IndicatorListener, public CommonIndicator {
 protected:
 ...
 public:
  ...
  static ConvexTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                        const std::vector<const char*>& _tokens_, PriceType_t _basepx_pxtype_);

  static ConvexTrend* GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
 ...
 protected:
  ConvexTrend(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
              const SecurityMarketView& _indep_market_view_, double _fractional_st_seconds_,
              double _fractional_lt_seconds_, PriceType_t _price_type_);
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "ConvexTrend"; }
