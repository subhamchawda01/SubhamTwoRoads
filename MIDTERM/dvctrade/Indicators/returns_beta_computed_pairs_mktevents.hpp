/**
    \file Indicators/returns_beta_computed_pairs_mktevents.hpp
...
class ReturnsBetaComputedPairsMktEvents : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  ReturnsBetaComputedPairsMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
                                    const std::string& concise_indicator_description_,
                                    SecurityMarketView& _dep_market_view_, SecurityMarketView& _indep_market_view_,
                                    unsigned int _num_events_halflife_, double _beta_change_factor_,
 ...
 public:
  ...
  static ReturnsBetaComputedPairsMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                              const std::vector<const char*>& _tokens_,
  ...
  ~ReturnsBetaComputedPairsMktEvents() {}
  ...
  static std::string VarName() { return "ReturnsBetaComputedPairsMktEvents"; }
