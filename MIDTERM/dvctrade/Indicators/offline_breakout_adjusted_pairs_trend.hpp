...
class OfflineBreakoutAdjustedPairsTrend : public IndicatorListener,
 ...
 protected:
  OfflineBreakoutAdjustedPairsTrend(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineBreakoutAdjustedPairsTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                              const std::vector<const char*>& _tokens_,
  ...
  static OfflineBreakoutAdjustedPairsTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                              ...
                                                              int t_volume_measure_seconds_, double t_trend_weight_,
                                                              PriceType_t _price_type_);

  ~OfflineBreakoutAdjustedPairsTrend() {}
  ...
  static std::string VarName() { return "OfflineBreakoutAdjustedPairsTrend"; }
 ...
 protected:
  ...
  /// From price changes, we compute the coefficient and corerlation through Single Linear Regression
  /// < lr_coeff_, lr_correlation_ > = GetSLRCoeffCorrelation ( dep_price_change_vector_, indep_price_change_vector_ )
  /// For OfflineBreakoutAdjustedPairsTrend lr_coeff_/fabs(lr_correlation_) is sort of the lr_coeff_ as it would be if
