/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ADAPTIVE_MOVING_AVERAGE_H
#define BASE_INDICATORS_ADAPTIVE_MOVING_AVERAGE_H
...
class AdaptiveMovingAverage : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
  ...
  double slow_stdev_value_ = 1;
  SlowStdevCalculator* slow_stdev_;
  double hist_stdev_ = 1;
  double factor_ = 1;
  int stdev_duration_;
  // functions
 public:
  ...
  static AdaptiveMovingAverage* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                  const std::vector<const char*>& _tokens_,
 ...
 protected:
  AdaptiveMovingAverage(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "AdaptiveMovingAverage"; }
