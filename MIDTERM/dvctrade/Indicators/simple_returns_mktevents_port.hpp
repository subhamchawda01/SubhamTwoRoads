/**
    \file Indicators/simple_trend_mktevents_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_SIMPLE_RETURNS_MKTEVENTS_PORT_H
#define BASE_INDICATORS_SIMPLE_RETURNS_MKTEVENTS_PORT_H
...
class SimpleReturnsMktEventsPort : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static SimpleReturnsMktEventsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                       const std::vector<const char*>& _tokens_,
 ...
 protected:
  SimpleReturnsMktEventsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
                             const std::string& concise_indicator_description_,
                             std::string _portfolio_descriptor_shortcode_, unsigned int _num_events_halflife_,
                             PriceType_t _price_type_);

 public:
  ~SimpleReturnsMktEventsPort() {}
  ...
  // functions
  // functions
  static std::string VarName() { return "SimpleReturnsMktEventsPort"; }
...
#endif  // BASE_INDICATORS_SIMPLE_RETURNS_MKTEVENTS_H
