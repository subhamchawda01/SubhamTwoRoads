/**
    \file Indicators/offline_computed_self_cutoff_pairs.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_SELF_CUTOFF_PAIRS_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_SELF_CUTOFF_PAIRS_H
...
class OfflineComputedSelfCutoffPairs : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  // functions
 protected:
  OfflineComputedSelfCutoffPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
                                 const std::string& concise_indicator_description_,
                                 SecurityMarketView& _dep_market_view_, SecurityMarketView& _indep_market_view_,
                                 double _fractional_seconds_, double _trend_fractional_seconds_,
 ...
 public:
  ...
  static OfflineComputedSelfCutoffPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                           const std::vector<const char*>& _tokens_,
  ...
  static OfflineComputedSelfCutoffPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                           ...
                                                           double _trend_fractional_second_, PriceType_t _price_type_);

  ~OfflineComputedSelfCutoffPairs() {}
  ...
  static std::string VarName() { return "OfflineComputedSelfCutoffPairs"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_SELF_CUTOFF_PAIRS_H
