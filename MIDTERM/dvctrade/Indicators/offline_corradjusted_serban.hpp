/**
    \file Indicators/offline_corradjusted_serban.hpp
...
class OfflineCorradjustedSerban : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  SimpleTrend* short_term_indep_trend_indicator_;  // proxy for p_i(t) - p_i(t-1)
  ...
  // functions
 protected:
  OfflineCorradjustedSerban(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineCorradjustedSerban* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                      const std::vector<const char*>& _tokens_,
                                                      PriceType_t _basepx_pxtype_);

  static OfflineCorradjustedSerban* GetUniqueInstance(
  ...
  static std::string VarName() { return "OfflineCorradjustedSerban"; }
 ...
 protected:
  ...
  /// function to compute current_projection_multiplier_.   This is the main difference between
  /// OfflineCorradjustedSerban and OfflineComputedSerban
