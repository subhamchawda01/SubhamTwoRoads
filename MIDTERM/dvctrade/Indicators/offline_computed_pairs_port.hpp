/**
    \file Indicators/offline_computed_pairs_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_PAIRS_PORT_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_PAIRS_PORT_H
...
class OfflineComputedPairsPort : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
 ...
 public:
  ...
  static OfflineComputedPairsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                     const std::vector<const char*>& _tokens_,
 ...
 protected:
  OfflineComputedPairsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static std::string VarName() { return "OfflineComputedPairsPort"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_PAIRS_PORT_H
