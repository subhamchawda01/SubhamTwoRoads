/**
    \file Indicators/di1_curve_adjusted_price.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_DI1_CURVE_ADJUSTED_PRICE_H
#define BASE_INDICATORS_DI1_CURVE_ADJUSTED_PRICE_H
...
class DI1CurveAdjustedPrice : public CommonIndicator {
 protected:
  ...
  DI1CurveAdjustedPrice(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static DI1CurveAdjustedPrice* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                  const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "DI1CurveAdjustedPrice"; }
...
#endif  // BASE_INDICATORS_DI1_CURVE_ADJUSTED_PRICE_H
