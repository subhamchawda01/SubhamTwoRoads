/**
    \file Indicators/volume_weighted_scaled_trend_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_VOLUME_WEIGHTED_SCALED_TREND_MKTEVENTS_H
#define BASE_INDICATORS_VOLUME_WEIGHTED_SCALED_TREND_MKTEVENTS_H
...
class VolumeWeightedScaledTrendMktEvents : public CommonIndicator,
 ...
 public:
  ...
  static VolumeWeightedScaledTrendMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                               const std::vector<const char*>& _tokens_,
 ...
 protected:
  VolumeWeightedScaledTrendMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ~VolumeWeightedScaledTrendMktEvents() {}
  ...
  // functions
  static std::string VarName() { return "VolumeWeightedScaledTrendMktEvents"; }
...
#endif  // BASE_INDICATORS_VOLUME_WEIGHTED_SCALED_TREND_MKTEVENTS_H
