/**
    \file Indicators/online_ratio_pairs_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_RATIO_PAIRS_PORT_H
#define BASE_INDICATORS_ONLINE_RATIO_PAIRS_PORT_H
...
/// Portfolio version of OnlineRatioPairs
...
///
class OnlineRatioPairsPort : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineRatioPairsPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  OnlineRatioPairsPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  // functions
  static std::string VarName() { return "OnlineRatioPairsPort"; }
...
#endif  // BASE_INDICATORS_ONLINE_RATIO_PAIRS_PORT_H
