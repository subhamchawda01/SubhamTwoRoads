/**
    \file Indicators/offline_computed_source_cutoff_pairs.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_COMPUTED_SOURCE_CUTOFF_PAIRS_H
#define BASE_INDICATORS_OFFLINE_COMPUTED_SOURCE_CUTOFF_PAIRS_H
...
class OfflineComputedSourceCutoffPairs : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
  ...
  SimpleTrend* p_indep_trend_indicator_;

  // functions
 protected:
  OfflineComputedSourceCutoffPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
                                   const std::string& concise_indicator_description_,
                                   SecurityMarketView& _dep_market_view_, SecurityMarketView& _indep_market_view_,
                                   double _fractional_seconds_, double _trend_fractional_second_,
 ...
 public:
  ...
  static OfflineComputedSourceCutoffPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                             const std::vector<const char*>& _tokens_,
  ...
  ~OfflineComputedSourceCutoffPairs() {}
  ...
  static std::string VarName() { return "OfflineComputedSourceCutoffPairs"; }
...
#endif  // BASE_INDICATORS_OFFLINE_COMPUTED_SOURCE_CUTOFF_PAIRS_H
