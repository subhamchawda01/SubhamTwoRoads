/**
    \file Indicators/curve_adjusted_simple_trend_mktevents_momentum.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_CURVE_ADJUSTED_SIMPLE_TREND_MKTEVENTS_MOMENTUM_H
#define BASE_INDICATORS_CURVE_ADJUSTED_SIMPLE_TREND_MKTEVENTS_MOMENTUM_H
...
class CurveAdjustedSimpleTrendMktEventsMomentum : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  CurveAdjustedSimpleTrendMktEventsMomentum(DebugLogger& _dbglogger_, const Watch& _watch_,
                                            ...
                                            double _num_events_halflife_, PriceType_t _price_type_, bool _use_time_);
 ...
 public:
  ...
  static CurveAdjustedSimpleTrendMktEventsMomentum* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                                      const std::vector<const char*>& _tokens_,
                                                                      PriceType_t _base_price_type_);

  static CurveAdjustedSimpleTrendMktEventsMomentum* GetUniqueInstance(
      ...
      double _num_events_halflife_, PriceType_t t_price_type_, bool _use_time_ = false);

  ~CurveAdjustedSimpleTrendMktEventsMomentum() {}
  ...
  // functions
  static std::string VarName() { return "CurveAdjustedSimpleTrendMktEventsMomentum"; }
