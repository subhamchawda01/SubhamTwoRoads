...
class SimpleTrendPort : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static SimpleTrendPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  SimpleTrendPort(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  static std::string VarName() { return "SimpleTrendPort"; }
