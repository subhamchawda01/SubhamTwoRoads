...
/// StabledScaledTredVersion2MktEvents takes that time period as one of the input.
class StableScaledTrendVersion2MktEvents : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static StableScaledTrendVersion2MktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                               const std::vector<const char*>& _tokens_,
 ...
 protected:
  StableScaledTrendVersion2MktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
                                     const std::string& concise_indicator_description_,
                                     SecurityMarketView& _indep_market_view_, unsigned int _num_events_halflife_,
                                     double _stdev_duration_, PriceType_t _price_type_);

 public:
  ~StableScaledTrendVersion2MktEvents() {}
  ...
  // functions
  static std::string VarName() { return "StableScaledTrendVersion2MktEvents"; }
