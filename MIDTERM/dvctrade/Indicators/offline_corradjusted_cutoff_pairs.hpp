/**
    \file Indicators/offline_corradjusted_cutoff_pairs.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OFFLINE_CORRADJUSTED_CUTOFF_PAIRS_H
#define BASE_INDICATORS_OFFLINE_CORRADJUSTED_CUTOFF_PAIRS_H
...
class OfflineCorradjustedCutoffPairs : public IndicatorListener, public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
 ...
 protected:
  OfflineCorradjustedCutoffPairs(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static OfflineCorradjustedCutoffPairs* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                           const std::vector<const char*>& _tokens_,
  ...
  static std::string VarName() { return "OfflineCorradjustedCutoffPairs"; }
 ...
 protected:
  ...
  /// From price changes, we compute the coefficient and corerlation through Single Linear Regression
  /// < lr_coeff_, lr_correlation_ > = GetSLRCoeffCorrelation ( dep_price_change_vector_, indep_price_change_vector_ )
  /// For OfflineCorradjustedCutoffPairs lr_coeff_/fabs(lr_correlation_) is sort of the lr_coeff_ as it would be if
...
#endif  // BASE_INDICATORS_OFFLINE_CORRADJUSTED_CUTOFF_PAIRS_H
