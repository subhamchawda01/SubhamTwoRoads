/**
   \file Indicators/l1_bookbias.hpp
...
class L1Bookbias : public CommonIndicator {
 protected:
  // variables
  const SecurityMarketView& dep_market_view_;

 protected:
  L1Bookbias(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& _concise_indicator_description_,
 ...
 public:
  ...
  static L1Bookbias* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  static std::string VarName() { return "L1Bookbias"; }
