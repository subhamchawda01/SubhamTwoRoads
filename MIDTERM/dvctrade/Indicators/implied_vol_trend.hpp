/**
    \file Indicators/implied_vol_trend.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_IMPLIED_VOL_TREND_H
#define BASE_INDICATORS_IMPLIED_VOL_TREND_H
...
class ImpliedVolTrend : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static ImpliedVolTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                            const std::vector<const char*>& _tokens_, PriceType_t _basepx_pxtype_);

  static ImpliedVolTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                            const SecurityMarketView& _indep_market_view_, double _fractional_seconds_,
                                            PriceType_t _price_type_, bool _use_oppposite_contract_ = false);

 protected:
  ImpliedVolTrend(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "ImpliedVolTrend"; }
