/**
    \file Indicators/online_computed_pairs_mktevents.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_COMPUTED_PAIRS_MKTEVENTS_H
#define BASE_INDICATORS_ONLINE_COMPUTED_PAIRS_MKTEVENTS_H
...
class OnlineComputedPairsMktEvents : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineComputedPairsMktEvents* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                         const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineComputedPairsMktEvents(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static std::string VarName() { return "OnlineComputedPairsMktEvents"; }
...
#endif  // BASE_INDICATORS_ONLINE_COMPUTED_PAIRS_MKTEVENTS_H
