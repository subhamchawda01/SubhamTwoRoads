...
class TrendVolBasedRegimePort : public IndicatorListener,
 ...
 protected:
  ...
  VolumeRatioCalculatorPort& indep_volume_ratio_calculator_;
  ...
  SimpleTrendPort* p_indep_indicator_brk_;

 protected:
  TrendVolBasedRegimePort(DebugLogger& _dbglogger_, const Watch& _watch_,
                          const std::string& concise_indicator_description_,
                          const SecurityMarketView& _dep_market_view_, std::string t_portfolio_descriptor_shortcode_,
 ...
 public:
  ...
  static TrendVolBasedRegimePort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                    const std::vector<const char*>& _tokens_,
  ...
  static std::string VarName() { return "TrendVolBasedRegimePort"; }
