/**
    \file Indicators/book_order_cdiff.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_BOOK_ORDER_CDIFF_H
#define BASE_INDICATORS_BOOK_ORDER_CDIFF_H
...
class BookOrderCDiff : public CommonIndicator {
 protected:
  // variables
  ...
  // functions
 protected:
  BookOrderCDiff(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  static BookOrderCDiff* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "BookOrderCDiff"; }
  void OnMarketDataInterrupted(const unsigned int _security_id_, const int msecs_since_last_receive_);
  void OnMarketDataResumed(const unsigned int _security_id_);
};
}

#endif  // BASE_INDICATORS_BOOK_ORDER_CDIFF_H
