/**
    \file Indicators/spot_future_spread.hpp
   ...
   +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_SPOT_FUTURE_SPREAD_H
#define BASE_INDICATORS_SPOT_FUTURE_SPREAD_H
...
class SpotFutureSpread : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static SpotFutureSpread* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  SpotFutureSpread(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "SpotFutureSpread"; }
...
#endif  // BASE_INDICATORS_SPOT_FUTURE_SPREAD_H
