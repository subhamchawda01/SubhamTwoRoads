...
class BidAskToPayCutoffL1 : public CommonIndicator {
 protected:
  // variables
  ...
  unsigned int cutoff_increments_;
  L1SizeTrend* l1_size_ind_;

  // functions
 protected:
  BidAskToPayCutoffL1(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
                      SecurityMarketView& _indep_market_view_, unsigned int _num_levels_, unsigned int _size_to_seek_,
                      unsigned int _cutoff_increments_, PriceType_t price_type_);
 ...
 public:
  ...
  static BidAskToPayCutoffL1* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "BidAskToPayCutoffL1"; }
