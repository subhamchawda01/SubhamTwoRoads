/**
    \file Indicators/online_computed_negatively_correlated_pairs.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_COMPUTED_NEGATIVELY_CORRELATED_PAIRS_H
#define BASE_INDICATORS_ONLINE_COMPUTED_NEGATIVELY_CORRELATED_PAIRS_H
...
/// Indicator that is very similar to OnlineComputedPairs
...
/// price_type_ ) )
class OnlineComputedNegativelyCorrelatedPairs : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineComputedNegativelyCorrelatedPairs *GetUniqueInstance(DebugLogger &_dbglogger_, const Watch &_watch_,
                                                                    const std::vector<const char *> &_tokens_,
 ...
 protected:
  OnlineComputedNegativelyCorrelatedPairs(DebugLogger &_dbglogger_, const Watch &_watch_,
 ...
 public:
  ...
  static std::string VarName() { return "OnlineComputedNegativelyCorrelatedPairs"; }
...
#endif  // BASE_INDICATORS_ONLINE_COMPUTED_NEGATIVELY_CORRELATED_PAIRS_H
