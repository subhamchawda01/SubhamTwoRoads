/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_OWP_DIFF_PRICE_L1_H
#define BASE_INDICATORS_OWP_DIFF_PRICE_L1_H
...
class OwpDiffPriceL1 : public CommonIndicator, public TimePeriodListener {
 protected:
 ...
 public:
  ...
  static OwpDiffPriceL1* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
  ...
  OwpDiffPriceL1(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
  ...
  // functions
  static std::string VarName() { return "OwpDiffPriceL1"; }
...
#endif  // BASE_INDICATORS_OWP_DIFF_PRICE_L1_H
