/**
    \file Indicators/stud_price_returns_diff_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_STUD_PRICE_RETURNS_DIFF_PORT_H
#define BASE_INDICATORS_STUD_PRICE_RETURNS_DIFF_PORT_H
...
namespace HFSAT {
class StudPriceReturnsDiffPort : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
 ...
 public:
  ...
  static StudPriceReturnsDiffPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                     const std::vector<const char*>& _tokens_,
 ...
 protected:
  StudPriceReturnsDiffPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "StudPriceReturnsDiffPort"; }
...
#endif  // BASE_INDICATORS_STUD_PRICE_RETURNS_DIFF_PORT_H
