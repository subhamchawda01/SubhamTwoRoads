/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_SLOW_STDEV_RETURNS_CALCULATOR_H
#define BASE_INDICATORS_SLOW_STDEV_RETURNS_CALCULATOR_H
...
class SlowStdevReturnsCalculator : public CommonIndicator, public IndicatorListener {
 protected:
  // variables
  ...
  bool min_stdev_set_;
  bool is_price_ready_;
  double min_unbiased_l2_norm_;

  // functions
 public:
  static SlowStdevReturnsCalculator* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 protected:
  SlowStdevReturnsCalculator(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "SlowStdevReturnsCalculator"; }
  ...
  static SlowStdevReturnsCalculator* GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
...
#endif  // BASE_INDICATORS_SLOW_STDEV_RETURNS_CALCULATOR_H
