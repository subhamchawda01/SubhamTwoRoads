/**
    \file Indicators/online_computed_cutoff_pair_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_ONLINE_COMPUTED_CUTOFF_PAIRS_PORT_H
#define BASE_INDICATORS_ONLINE_COMPUTED_CUTOFF_PAIRS_PORT_H
...
/// Portfolio version of OnlineComputedPairs
...
///
class OnlineComputedCutoffPairPort : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineComputedCutoffPairPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                         const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineComputedCutoffPairPort(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  // functions
  static std::string VarName() { return "OnlineComputedCutoffPairPort"; }
...
#endif  // BASE_INDICATORS_ONLINE_COMPUTED_PAIRS_PORT_H
