...
class RecentSimpleEventsMeasure : public CommonIndicator, public TimePeriodListener {
 protected:
  // variables
 ...
 protected:
  RecentSimpleEventsMeasure(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static RecentSimpleEventsMeasure* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                      const std::vector<const char*>& _tokens_,
  ...
  // functions
  static std::string VarName() { return "RecentSimpleEventsMeasure"; }
  inline int recent_events() const { return indicator_value_; }
};
}
