/**
    \file Indicators/stud_price_diff_port.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
 */
#ifndef BASE_INDICATORS_STUD_PRICE_DIFF_PORT_H
#define BASE_INDICATORS_STUD_PRICE_DIFF_PORT_H
...
namespace HFSAT {
class StudPriceDiffPort : public CommonIndicator,
 ...
 public:
  ...
  static StudPriceDiffPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                              const std::vector<const char*>& _tokens_, PriceType_t _basepx_pxtype_);

  static StudPriceDiffPort* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_, std::string _shortcode_,
                                              const std::string& _portfolio_descriptor_shortcode_,
                                              double _fractional_seconds_, double _lrdb_sign_,
                                              PriceType_t _price_type_);

 protected:
  StudPriceDiffPort(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
                    std::string _shortcode_, const std::string& _portfolio_descriptor_shortcode_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "StudPriceDiffPort"; }
