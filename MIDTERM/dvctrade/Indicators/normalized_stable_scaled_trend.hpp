/**
    \file Indicators/normalized_stable_scaled_trend.hpp
...
/// NormalizedStableScaledTrend uses a flat time period of 200 seconds.
class NormalizedStableScaledTrend : public CommonIndicator,
 ...
 public:
  ...
  static NormalizedStableScaledTrend* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                        const std::vector<const char*>& _tokens_,
 ...
 protected:
  NormalizedStableScaledTrend(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "NormalizedStableScaledTrend"; }
