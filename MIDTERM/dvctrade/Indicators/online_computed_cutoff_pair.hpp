/**
    \file Indicators/online_computed_cutoff_pair.hpp
...
class OnlineComputedCutoffPair : public CommonIndicator {
 protected:
  // variables
 ...
 public:
  ...
  static OnlineComputedCutoffPair* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                     const std::vector<const char*>& _tokens_,
 ...
 protected:
  OnlineComputedCutoffPair(DebugLogger& _dbglogger_, const Watch& _watch_,
 ...
 public:
  ...
  static std::string VarName() { return "OnlineComputedCutoffPair"; }
