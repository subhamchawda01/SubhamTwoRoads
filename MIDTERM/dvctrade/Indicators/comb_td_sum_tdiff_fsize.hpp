/**
    \file Indicators/comb_td_sum_tdiff_fsize.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_INDICATORS_COMB_TD_SUM_TDIFF_FSIZE_H
#define BASE_INDICATORS_COMB_TD_SUM_TDIFF_FSIZE_H
...
class CombTDSumTDiffFSize : public IndicatorListener, public CommonIndicator {
 protected:
  ...
  TDSumTDiffFSize* p_st_indicator_;
  TDSumTDiffFSize* p_lt_indicator_;
 ...
 public:
  ...
  static CombTDSumTDiffFSize* GetUniqueInstance(DebugLogger& _dbglogger_, const Watch& _watch_,
                                                const std::vector<const char*>& _tokens_, PriceType_t _basepx_pxtype_);

  static CombTDSumTDiffFSize* GetUniqueInstance(DebugLogger& t_dbglogger_, const Watch& r_watch_,
                                                SecurityMarketView& _indep_market_view_, double _fractional_st_seconds_,
                                                double _fractional_lt_seconds_);

 protected:
  CombTDSumTDiffFSize(DebugLogger& _dbglogger_, const Watch& _watch_, const std::string& concise_indicator_description_,
                      SecurityMarketView& _indep_market_view_, double _fractional_st_seconds_,
                      double _fractional_lt_seconds_);
 ...
 public:
  ...
  // functions
  static std::string VarName() { return "CombTDSumTDiffFSize"; }
...
#endif  // BASE_INDICATORS_COMB_TD_SUM_TDIFF_FSIZE_H
