...
int main(int argc, char* argv[]) {
  ...
  p_cmd_control_live_source_ =
      new HFSAT::CombinedControlMessageLiveSource(dbglogger_, control_ip_port.bcast_ip_, control_ip_port.bcast_port_,
                                                  network_interface, MULTICAST, HFSAT::kProShm, false);
  ...
  multishm_live_data_source->AddUDPDirectLiveSocket(control_recv_data_info_.bcast_ip_,
                                                    control_recv_data_info_.bcast_port_);
