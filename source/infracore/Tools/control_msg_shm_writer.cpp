// =====================================================================================
//
//       Filename:  control_msg_shm_writer.cpp
//
//    Description:
//
//        Version:  1.0
//        Created:  10/15/2018 07:16:14 AM
//       Revision:  none
//       Compiler:  g++
//
...
class ControlMsgCapture {
 ...
 public:
  ...
  void RunEventDispatcher() {
    while (true) {
      int32_t read_size =
          control_multicast_receiver_socket_->ReadN(sizeof(HFSAT::GenericControlRequestStruct), &control_request_);

      if (read_size < (signed)sizeof(HFSAT::GenericControlRequestStruct)) {
...
int main(int argc, char *argv[]) {
  ...
  control_msg_capture.RunEventDispatcher();
