    ...
    while (true) {
      ...
      switch (source_md_exch_type_) {
        ...
        case HFSAT::MDS_MSG::ORS_REPLY: {
          memcpy((void*)&(generic_mds_message_.generic_data_.ors_reply_data_),
                 ((HFSAT::GenericORSReplyStructLive*)(void*)&next_event_), pkt_size_);
        ...
        case HFSAT::MDS_MSG::ORS_REPLY_MULTISHM: {
          HFSAT::GenericORSReplyStructLiveProShm ors_reply_beta_struct;
          memcpy((void*)&ors_reply_beta_struct, (void*)&next_event_, pkt_size_);

          if(ors_reply_beta_struct.orr_type_ == HFSAT::kORRType_Margin){
            std::cout << "Margin Breach Exchange Message Ignoring " << std::endl;
            std::cout << "Current Margin value " <<  ors_reply_beta_struct.int_price_<< std::endl;
            continue;;
          }

          HFSAT::GenericORSReplyStructLive live_struct;
          memcpy((void*)live_struct.symbol_, (void*)ors_reply_beta_struct.symbol_, sizeof(live_struct.symbol_));
          live_struct.price_ = ors_reply_beta_struct.price_;
          live_struct.client_request_time_ = ors_reply_beta_struct.client_request_time_;
          live_struct.orr_type_ = ors_reply_beta_struct.orr_type_;
          live_struct.server_assigned_message_sequence_ = 0;
          live_struct.server_assigned_client_id_ = ors_reply_beta_struct.server_assigned_client_id_;
          live_struct.size_remaining_ = ors_reply_beta_struct.size_remaining_;
          live_struct.buysell_ = ors_reply_beta_struct.buysell_;
          live_struct.server_assigned_order_sequence_ = ors_reply_beta_struct.server_assigned_order_sequence_;
          live_struct.client_assigned_order_sequence_ = ors_reply_beta_struct.client_assigned_order_sequence_;
          live_struct.size_executed_ = ors_reply_beta_struct.size_executed_;
          live_struct.client_position_ = ors_reply_beta_struct.client_position_;
          live_struct.global_position_ = ors_reply_beta_struct.global_position_;
          live_struct.int_price_ = ors_reply_beta_struct.int_price_;
          live_struct.exch_assigned_sequence_ = ors_reply_beta_struct.csw_start_cycles_;

          if (HFSAT::kORRType_Seqd == live_struct.orr_type_ || HFSAT::kORRType_CxlSeqd == live_struct.orr_type_ ||
              HFSAT::kORRType_CxReSeqd == live_struct.orr_type_) {
            live_struct.time_set_by_server_.val =
                (ors_reply_beta_struct.csw_start_cycles_ + ors_reply_beta_struct.ors_end_cycles_delta_);
          } else {
            live_struct.time_set_by_server_.val = ors_reply_beta_struct.ors_end_cycles_from_exchange_;
          }

          memcpy((void*)&(generic_mds_message_.generic_data_.ors_reply_data_), (void*)&(live_struct),
                 sizeof(HFSAT::GenericORSReplyStructLive));
          generic_mds_message_.mds_msg_exch_ = HFSAT::MDS_MSG::ORS_REPLY;
        } break;
      ...
      if (mode_ == HFSAT::kLogger)
        ...
        if (source_md_exch_type_ == HFSAT::MDS_MSG::ORS_REPLY ||
            HFSAT::MDS_MSG::ORS_REPLY == generic_mds_message_.mds_msg_exch_) {
          if (!using_shm_for_ors_reply_) {
            ...
            //              generic_mds_message_.generic_data_.ors_reply_data_.time_set_by_server_.val =
            ...
            //            }
                   ...
                   source_md_exch_type_ == HFSAT::MDS_MSG::ORS_REPLY ||
                   HFSAT::MDS_MSG::ORS_REPLY == generic_mds_message_.mds_msg_exch_ ||
