...
void SIMEngine::SendSpreadOrder(HFSAT::ORS::Order *order1_, HFSAT::ORS::Order *order2_) {
}

void SIMEngine::SendThreeLegOrder(HFSAT::ORS::Order *order1_, HFSAT::ORS::Order *order2_, HFSAT::ORS::Order *order3_) {
}

void SIMEngine::SendTwoLegOrder(HFSAT::ORS::Order *order1_, HFSAT::ORS::Order *order2_) {
}
...
void SIMEngine::ModifyOrder(HFSAT::ORS::Order *order, HFSAT::ORS::Order *orig_order) {
