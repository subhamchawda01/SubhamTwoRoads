...
MDS_LOG_EXEC=$HOME/LiveExec/bin/eurex_lowbw_live_source_shm_data_logger
...
then
    ...
    MDS_LOG_EXEC="$HOME/LiveExec/bin/eurex_lowbw_live_source_shm_data_logger EOBIPriceFeed" ;
...
then
    ...
    MDS_LOG_EXEC=$HOME/LiveExec/bin/cme_lowbw_live_source_shm_data_logger ;
...
then
    ...
    MDS_LOG_EXEC=$HOME/LiveExec/bin/chix_l1_live_source_shm_data_logger ;
...
then
    ...
    MDS_LOG_EXEC=$HOME/LiveExec/bin/hkex_shm_data_logger ;
...
then
    ...
    MDS_LOG_EXEC=$HOME/LiveExec/bin/tmx_mds_data_logger_via_shm_source ;
...
then
    ...
    MDS_LOG_EXEC=$HOME/LiveExec/bin/ose_mds_data_logger_via_shm_source ;
...
then
    ...
    MDS_LOG_EXEC=$HOME/LiveExec/bin/ose_pricefeed_mds_data_logger_via_shm_source
...
then
    ...
    MDS_LOG_EXEC=$HOME/LiveExec/bin/tse_mds_data_logger_via_shm_source
...
then
    ...
    MDS_LOG_EXEC=$HOME/LiveExec/bin/CombinedShmLogger
...
PIDFILE=$PIDDIR/MDSLOGGER_SHM_$EXCH"_PIDfile.txt"
	...
	then
		...
		onload $MDS_LOG_EXEC &
                ...
                then
                  ...
                  LD_PRELOAD=libvma.so $MDS_LOG_EXEC &
