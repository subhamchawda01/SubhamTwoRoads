...
fut1_data=$(/home/dvctrader/stable_exec/mkt_trade_logger_20180918 SIM "$fut1_product_" "$date_" | grep OnTradePrint)
fut2_data=$(/home/dvctrader/stable_exec/mkt_trade_logger_20180918 SIM "$fut2_product_" "$date_" | grep OnTradePrint)
# echo $fut2_data
low_="1000000"
high_="0"
open_="0"
