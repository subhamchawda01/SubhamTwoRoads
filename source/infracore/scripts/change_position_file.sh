today=$1;
/apps/anaconda/anaconda3/bin/python /home/dvctrader/usarraf/generate_position_file_new_20210928.py $today --max_num_spreads_diff 0 --base_num_spreads_factor 1.5 --physical_factor 1 --yesterday_ban_factor 0.25
/apps/anaconda/anaconda3/bin/python /home/dvctrader/usarraf/generate_position_file_agg_new_20210928.py $today --max_num_spreads_diff 0 --base_num_spreads_factor 1 --physical_factor 1 --aggressive_factor 0.25 --yesterday_ban_factor 0.25
