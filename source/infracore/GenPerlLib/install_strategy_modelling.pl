...
# USAGE : src_strategy_file shortcode datagen_start_end_str trading_start_end_str";
	...
	else
	{
	    ...
	    open FSTRATF, "> $final_strat_filename_" or die "Could not open $final_strat_filename_ for writing\n";
	    
	    open TEMPSTRATFILEHANDLE, "< $t_temp_strategy_filename_ " or die "Could not open $t_temp_strategy_filename_\n";
