// Version 1.2.1 BMF Entry Point Test Request
// Bother only baout Setting Tag 112

#include "dvccode/Utils/tcp_client_socket.hpp"
#include "infracore/BMFEP/BMFEPFIX/BMFEPMessageDefs.hpp"

#ifndef BMFEP_TEST_REQUEST_HPP
#define BMFEP_TEST_REQUEST_HPP
...
class TestRequest {
 public:
  TestRequest(const bool _make_optimize_assumptions_)
      : Header_Tag_8_(NULL),
        Header_Tag_9_(NULL),
        Header_Tag_35_(NULL),
        Header_Tag_34_(NULL),
        ...
        Header_Tag_52_(NULL),
        Header_Tag_56_(NULL),
        TestRequest_Tag_112_(NULL),
        Trailer_Tag_10_(NULL),
        const_sum_(0),
        make_optimize_assumptions_(_make_optimize_assumptions_),
        write_len_(0) {
    bzero(msg_char_buf_, BMFEP_Header_msg_size_ + BMFEP_TestRequest_msg_size_ + BMFEP_Trailer_msg_size_);
  }
  ...
  void setFields(const char *sender_compID_, const char *target_compID_) {
    ...
    Header_Tag_34_ = Header_Tag_35_ + sprintf(Header_Tag_35_, "35=1%c", BMFEP_Delimiter_SOH_);
    Header_Tag_43_ =
    ...
    TestRequest_Tag_112_ = Header_Tag_56_ + sprintf(Header_Tag_56_, "56=%s%c", target_compID_, BMFEP_Delimiter_SOH_);
    Trailer_Tag_10_ = TestRequest_Tag_112_ + sprintf(TestRequest_Tag_112_, "112=%*d%c", OUR_BMFEP_FIX_Tag_112_Width_,
    ...
    for (unsigned int i = 0; i < BMFEP_Header_msg_size_ + BMFEP_TestRequest_msg_size_ + BMFEP_Trailer_msg_size_; ++i) {
  ...
  inline const unsigned int getWriteLen() const { return write_len_; }

  inline int checksum() { return (const_sum_ + calcVarSum()) % 256; }
  ...
  inline void setCheckSum() {
    ...
    // Last arg should ALWAYS be false.
  }
 ...
 public:
  ...
  char *TestRequest_Tag_112_;

  char *Trailer_Tag_10_;

  char msg_char_buf_[BMFEP_Header_msg_size_ + BMFEP_TestRequest_msg_size_ + BMFEP_Trailer_msg_size_];
