...
int main(int argc, char** argv) {
  ...
  if ( strcmp(argv[2], "DUMPORSPNLMARGINSTATUS") && strcmp(argv[2],"DUMPORSPOSITIONS") && strcmp(argv[2],"SETGROSSMARGINCHECK") && strcmp(argv[2],"SETNETMARGINCHECK") && strcmp(argv[2],"SETORSPNLCHECK")) {
      std::cout << "ONLY CMDS EXEC DUMPORSPNLMARGINSTATUS/DUMPORSPOSITIONS/SETGROSSMARGINCHECK/SETNETMARGINCHECK/SETORSPNLCHECK" << std::endl;
