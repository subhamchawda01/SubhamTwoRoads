...
class OrderEntryRequest {
 ...
 public:
  ...
  virtual void KillSwitchOrder(int32_t const &packet_sequence_number) {}
 ...
 public:
  ...
  virtual void SetDynamicOrderEntryRequestFields(int32_t const &packet_sequence_number, int16_t const &buy_sell,
                                                 ...
                                                 bool is_mo, bool add_preopen) = 0;
  virtual void SetDynamicOrderEntryRequestFields(int32_t const &packet_sequence_number, int16_t const &buy_sell_1,
