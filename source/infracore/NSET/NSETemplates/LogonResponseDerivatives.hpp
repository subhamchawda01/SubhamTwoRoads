...
#define NSE_LOGON_RESPONSE_PASSWORD_OFFSET \
  (NSE_LOGON_RESPONSE_STP_RESERVED1_OFFSET + NSE_LOGON_RESPONSE_STP_RESERVED1_LENGTH)
#define NSE_LOGON_RESPONSE_PASSWORD_LENGTH LENGTH_OF_LOGON_RESPONSE_PASSWORD_CHAR_FIELD

#define NSE_LOGON_RESPONSE_STP_RESERVED2_OFFSET \
  (NSE_LOGON_RESPONSE_PASSWORD_OFFSET + NSE_LOGON_RESPONSE_PASSWORD_LENGTH)
#define NSE_LOGON_RESPONSE_STP_RESERVED2_LENGTH 8

#define NSE_LOGON_RESPONSE_NEWPASSWORD_OFFSET \
  (NSE_LOGON_RESPONSE_STP_RESERVED2_OFFSET + NSE_LOGON_RESPONSE_STP_RESERVED2_LENGTH)
...
#define NSE_LOGON_RESPONSE_STP_RESERVED_GROUP_OFFSET \
  (NSE_LOGON_RESPONSE_BROKERNAME_OFFSET + NSE_LOGON_RESPONSE_BROKERNAME_LENGTH)
...
#define NSE_LOGON_RESPONSE_LENGTH                                                                                   \
  (NSE_LOGON_RESPONSE_USERID_LENGTH + NSE_LOGON_RESPONSE_PASSWORD_LENGTH + NSE_LOGON_RESPONSE_NEWPASSWORD_LENGTH +  \
   ...
   NSE_LOGON_RESPONSE_STP_RESERVED1_LENGTH + NSE_LOGON_RESPONSE_STP_RESERVED2_LENGTH +                              \
   NSE_LOGON_RESPONSE_STP_RESERVED_GROUP_LENGTH)
...
class NSELogonResponseDerivatives : public NSELogonResponse {
 public:
  ...
  inline ProcessedLogonResponse *ProcessLogon(char const *msg_ptr) {
    ...
    processed_logon_response_.broker_status = *((double *)(msg_ptr + NSE_LOGON_RESPONSE_BROKERSTATUS_OFFSET));
