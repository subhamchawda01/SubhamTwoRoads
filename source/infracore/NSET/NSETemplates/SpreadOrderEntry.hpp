...
/* #define NSE_SPREAD_ORDERENTRY_REQUEST_PARTCIPANTTYPE_OFFSET \
  (NSE_REQUEST_START_OFFSET + NSE_REQUEST_MESSAGE_HEADER_LENGTH)
*/
...
#define NSE_SPREAD_ORDERENTRY_REQUEST_PAN_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MKTREPLAY_OFFSET + NSE_SPREAD_ORDERENTRY_REQUEST_MKTREPLAY_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_PAN_LENGTH 10

#define NSE_SPREAD_ORDERENTRY_REQUEST_ALGOID_OFFSET (NSE_SPREAD_ORDERENTRY_REQUEST_PAN_OFFSET + NSE_SPREAD_ORDERENTRY_REQUEST_PAN_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_ALGOID_LENGTH 4

#define NSE_SPREAD_ORDERENTRY_REQUEST_RESERVED_3_OFFSET (NSE_SPREAD_ORDERENTRY_REQUEST_ALGOID_OFFSET + NSE_SPREAD_ORDERENTRY_REQUEST_ALGOID_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_RESERVED_3_LENGTH sizeof(int16_t)

#define NSE_SPREAD_ORDERENTRY_LAST_ACTIVITY_REFERENCE_OFFSET (NSE_SPREAD_ORDERENTRY_REQUEST_RESERVED_3_OFFSET + NSE_SPREAD_ORDERENTRY_REQUEST_RESERVED_3_LENGTH)
#define NSE_SPREAD_ORDERENTRY_LAST_ACTIVITY_REFERENCE_LENGTH sizeof(int64_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_RESERVED_4_OFFSET (NSE_SPREAD_ORDERENTRY_LAST_ACTIVITY_REFERENCE_OFFSET + NSE_SPREAD_ORDERENTRY_LAST_ACTIVITY_REFERENCE_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_RESERVED_4_LENGTH 52

#define NSE_SPREAD_ORDERENTRY_REQUEST_PRICEDIFF_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_RESERVED_4_OFFSET + NSE_SPREAD_ORDERENTRY_REQUEST_RESERVED_4_LENGTH)
...
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TOKENNO_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_2_FLLERFLAGS_Y_OFFSET + NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_2_FLLERFLAGS_Y_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TOKENNO_LENGTH 4

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_INSTRUMENTNAME_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TOKENNO_OFFSET +                                \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TOKENNO_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_INSTRUMENTNAME_LENGTH 6

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_SYMBOL_OFFSET      \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_INSTRUMENTNAME_OFFSET + \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_INSTRUMENTNAME_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_SYMBOL_LENGTH 10

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_EXPIRYDATE_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_SYMBOL_OFFSET +        \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_SYMBOL_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_EXPIRYDATE_LENGTH sizeof(int32_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_STRIKEPRICE_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_EXPIRYDATE_OFFSET +     \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_EXPIRYDATE_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_STRIKEPRICE_LENGTH sizeof(int32_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_OPTIONTYPE_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_STRIKEPRICE_OFFSET +   \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_STRIKEPRICE_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_OPTIONTYPE_LENGTH 2

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_CALEVEL_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_OPTIONTYPE_OFFSET + \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_OPTIONTYPE_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_CALEVEL_LENGTH 2

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_OPBROKERID_OFFSET                \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_CALEVEL_OFFSET + \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_CONTRACT_DESC_STRUCT_CALEVEL_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_OPBROKERID_LENGTH 5

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_FILLER_X_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_OPBROKERID_OFFSET +  \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_OPBROKERID_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_FILLER_X_LENGTH sizeof(char)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_ORDERTYPE_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_FILLER_X_OFFSET +     \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_FILLER_X_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_ORDERTYPE_LENGTH sizeof(int16_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_BUYSELLINDICATOR_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_ORDERTYPE_OFFSET +           \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_ORDERTYPE_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_BUYSELLINDICATOR_LENGTH sizeof(int16_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_DISCLOSEDVOLUME_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_BUYSELLINDICATOR_OFFSET +   \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_BUYSELLINDICATOR_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_DISCLOSEDVOLUME_LENGTH sizeof(int32_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_DISCLOSEDVOLUMEREMAINING_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_DISCLOSEDVOLUME_OFFSET +             \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_DISCLOSEDVOLUME_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_DISCLOSEDVOLUMEREMAINING_LENGTH sizeof(int32_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TOTALVOLUMEREMAINING_OFFSET  \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_DISCLOSEDVOLUMEREMAINING_OFFSET + \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_DISCLOSEDVOLUMEREMAINING_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TOTALVOLUMEREMAINING_LENGTH sizeof(int32_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_VOLUME_OFFSET            \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TOTALVOLUMEREMAINING_OFFSET + \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TOTALVOLUMEREMAINING_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_VOLUME_LENGTH sizeof(int32_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_VOLUMEFILLEDTODAY_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_VOLUME_OFFSET + NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_VOLUME_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_VOLUMEFILLEDTODAY_LENGTH sizeof(int32_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_PRICE_OFFSET          \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_VOLUMEFILLEDTODAY_OFFSET + \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_VOLUMEFILLEDTODAY_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_PRICE_LENGTH sizeof(int32_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TRIGGERPRICE_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_PRICE_OFFSET + NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_PRICE_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TRIGGERPRICE_LENGTH sizeof(int32_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_MINIMUMFILL_OR_AONVOLUME_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TRIGGERPRICE_OFFSET +                \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_TRIGGERPRICE_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_MINIMUMFILL_OR_AONVOLUME_LENGTH sizeof(int32_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_STORDERFLAGS_STRUCT_OFFSET   \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_MINIMUMFILL_OR_AONVOLUME_OFFSET + \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_MINIMUMFILL_OR_AONVOLUME_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_STORDERFLAGS_STRUCT_LENGTH sizeof(int16_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_OPENCLOSE_OFFSET        \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_STORDERFLAGS_STRUCT_OFFSET + \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_STORDERFLAGS_STRUCT_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_OPENCLOSE_LENGTH sizeof(char)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_ADDITIONALORDERFLAGS_STRUCT_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_OPENCLOSE_OFFSET +                      \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_OPENCLOSE_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_ADDITIONALORDERFLAGS_STRUCT_LENGTH sizeof(int8_t)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_GIVENUPFLAG_OFFSET              \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_ADDITIONALORDERFLAGS_STRUCT_OFFSET + \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_ADDITIONALORDERFLAGS_STRUCT_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_GIVENUPFLAG_LENGTH sizeof(char)

#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_FLLERFLAGS_Y_OFFSET \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_GIVENUPFLAG_OFFSET +     \
   NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_GIVENUPFLAG_LENGTH)
#define NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_FLLERFLAGS_Y_LENGTH sizeof(int8_t)
...
#define NSE_SPREAD_ORDERENTRY_REQUEST_LENGTH \
  (NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_FLLERFLAGS_Y_OFFSET + NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_3_FLLERFLAGS_Y_LENGTH)
 ...
 public:
  ...
  inline void SetProClient(int16_t const &proclient){
    *((int16_t *)(msg_ptr + NSE_PACKET_REQUEST_LENGTH +
                  NSE_SPREAD_ORDERENTRY_REQUEST_PROCLIENTINDICATOR_OFFSET)) = hton16(proclient);
  }
 ...
 public:
  ...
  inline void SetDynamicOrderEntryRequestFields(int32_t const &packet_sequence_number, int32_t const &saos,
    ...
    inline void SetDynamicOrderEntryRequestFields(int32_t const &packet_sequence_number, int16_t const &buy_sell_1,
                                                 int16_t const &buy_sell_2, int32_t const &price_1,int32_t const &price_2,
                                                 HFSAT::ORS::Order *order_1, HFSAT::ORS::Order *order_2,
                                                 InstrumentDesc *inst_desc_1,InstrumentDesc *inst_desc_2,
                                                 SecurityInfoCashMarket *sec_info_1,SecurityInfoCashMarket *sec_info_2,
                                                 bool is_mo, bool add_preopen) {
    std::cout << "Spread: SetDynamicOrderEntryRequestFields New Implementation... "<< std::endl;
    *((int32_t *)(msg_ptr + NSE_PACKET_SEQUENCE_OFFSET)) = hton32(packet_sequence_number);
    ...
    memcpy((void *)(msg_ptr + NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_2_TOKENNO_OFFSET), inst_desc_2->GetInstrumentDescAsBuffer(),
           sizeof(InstrumentDesc));
   // *((int16_t *)(msg_ptr + NSE_SPREAD_ORDERENTRY_REQUEST_STORDERFLAGS_STRUCT_OFFSET)) |= hton16(1 << 8);  // SET IOC FLAG
   // *((int16_t *)(msg_ptr + NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_2_STORDERFLAGS_STRUCT_OFFSET)) |= hton16(1 << 8);  // SET IOC FLAG

    *((int16_t *)(msg_ptr + NSE_SPREAD_ORDERENTRY_REQUEST_BUYSELLINDICATOR_OFFSET)) = hton16(1);
    *((int16_t *)(msg_ptr +  NSE_SPREAD_ORDERENTRY_REQUEST_MS_SPD_LEG_2_BUYSELLINDICATOR_OFFSET)) = hton16(2);
    ...
    *((int32_t *)(msg_ptr + NSE_SPREAD_ORDERENTRY_REQUEST_PRICEDIFF_OFFSET)) = hton32(100);

    *((int32_t *)(msg_ptr + NSE_SPREAD_ORDERENTRY_REQUEST_FLLERFLAGS_1_TO_8_OFFSET)) = hton32(order_1->server_assigned_order_sequence_);
    ...
    std::cout << "Order Entry Spread Size:: " << NSE_SPREAD_ORDERENTRY_REQUEST_LENGTH << std::endl;
  }

  char const *GetSpreadOrderEntryRequestBuffer() const { return order_entry_request_buffer; }
  inline int32_t GetSpreadOrderEntryMsgLength(){ return NSE_SPREAD_ORDERENTRY_REQUEST_LENGTH;}
};
