/**
   \file MDSMessages/livesources/new_puma_raw_live_data_source.hpp
...
#ifndef BASE_MDSMESSAGES_NEW_PUMA_RAW_LIVE_DATA_SOURCE_H
#define BASE_MDSMESSAGES_NEW_PUMA_RAW_LIVE_DATA_SOURCE_H
...
#define MAX_PUMA_CHANNEL_NUM 200
#define MAX_PUMA_SOCKETS 200
#define PUMA_MSG_HEADER_LEN 10

#define MAX_BMF_PACKET_SIZE (1 << 20)

class NewPumaRawLiveDataSource : public SimpleExternalDataLiveListener {
 public:
  NewPumaRawLiveDataSource(DebugLogger& dbglogger, const SecurityNameIndexer& sec_name_indexer,
                           HFSAT::SimpleLiveDispatcher* simple_live_dispatcher_, HFSAT::FastMdConsumerMode_t mode,
                           bool is_full_reference_mode, int bmf_feed_type = 1);

  ~NewPumaRawLiveDataSource();
 ...
 private:
  ...
  PUMA_MDS::Puma_Header* msg_header_ptr;
