  ...
  if( true == are_we_using_auto_getflat_near_circuit_ ) {
    if((_security_id_ == primary0_id_) && (true == is_primary_book_valid)) { 
      ...
      if(false == is_theoturnoff_due_to_autogetflat_near_primary_circuit_){
        //violation
        if(primary_mid_int_px >= primary_upper_int_price_threshold_autogetflat_ || primary_mid_int_px <= primary_lower_int_price_threshold_autogetflat_){
        ...
        //resume
        if(primary_mid_int_px < primary_upper_int_price_threshold_autoresume_ && primary_mid_int_px > primary_lower_int_price_threshold_autoresume_){
    ...
    if((_security_id_ == secondary_id_) && (true == is_secondary_book_valid)){
      ...
      if(false == is_theoturnoff_due_to_autogetflat_near_secondary_circuit_){
        //violation
        if(secondary_mix_int_px >= secondary_upper_int_price_threshold_autogetflat_ || secondary_mix_int_px <= secondary_lower_int_price_threshold_autogetflat_){
        ...
        //resume
        if(secondary_mix_int_px < secondary_upper_int_price_threshold_autoresume_ && secondary_mix_int_px > secondary_lower_int_price_threshold_autoresume_){
