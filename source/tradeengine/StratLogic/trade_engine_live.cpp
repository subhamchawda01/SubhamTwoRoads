...
int main(int argc, char **argv) {
  ...
  if (argc < 6) {  // 5 is min of live and sim
    std::cerr << "expecting :\n"
              << " $tradeengineexec STRAT_LIVE_FILE TRADINGDATE START_TIME END_TIME PROGID ADD_DBG_CODE DBG_CODE.... --tbt_recovery=[false]/true [by default false is used as not to go for HFT/tbt data recovery] --use_oi=[false]/true --exchange=[NSE]/BSE/BSE_NSE" << '\n';
