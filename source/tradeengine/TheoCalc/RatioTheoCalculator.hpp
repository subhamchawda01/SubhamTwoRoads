...
class RatioTheoCalculator : public BaseTheoCalculator, public HFSAT::BasePNLListener {
 protected:
  ...
  bool spread_check_;
  double primary_upper_int_price_threshold_autogetflat_;
  double primary_lower_int_price_threshold_autogetflat_;
  double primary_upper_int_price_threshold_autoresume_;
  double primary_lower_int_price_threshold_autoresume_;
  double secondary_upper_int_price_threshold_autogetflat_;
  double secondary_lower_int_price_threshold_autogetflat_;
  double secondary_upper_int_price_threshold_autoresume_;
  double secondary_lower_int_price_threshold_autoresume_;
  double day_open_px_;
 ...
 public:
  ...
  virtual void OnCircuitUpdate() {
    dbglogger_ << watch_.tv() << " Circuit Updates " << DBGLOG_ENDL_FLUSH;
    LoadCircuitVars();
  }
