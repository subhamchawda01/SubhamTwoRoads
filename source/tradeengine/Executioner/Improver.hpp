#ifndef _EXECUTIONER_IMPROVER_HPP
#define _EXECUTIONER_IMPROVER_HPP

#include "baseinfra/OrderRouting/order_manager_listeners.hpp"
#include "dvccode/CDef/math_utils.hpp"
#include "tradeengine/Executioner/BaseExecutioner.hpp"

class Improver : public BaseExecutioner, public HFSAT::ThrottleNumberListener {
 private:
  ...
  double bid_offset_;
  double ask_offset_;
  int improver_bid_size_;
  int improver_ask_size_;
  ...
  double improver_bid_price_;
  int improver_bid_int_price_;
  double improver_ask_price_;
  int improver_ask_int_price_;
 ...
 public:
  Improver(std::string _exec_param_file, HFSAT::Watch& _watch_, HFSAT::DebugLogger& dbglogger_,
