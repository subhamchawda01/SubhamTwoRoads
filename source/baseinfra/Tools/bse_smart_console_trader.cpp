// =====================================================================================
//
//       Filename:  bse_smart_console_trader.cpp
//
//    Description:
//
//        Version:  1.0
...
int main(int argc, char** argv) {
  ...
  if (std::string::npos != shortcode.find("BSE_")) {
    ...
    if (std::string::npos != shortcode.find("INR_") || std::string::npos != shortcode.find("_GIND")) {
      ...
      if (std::string::npos != shortcode.find("_FUT") || HFSAT::BSESecurityDefinitions::IsOption(shortcode)) {
