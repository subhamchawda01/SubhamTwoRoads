...
/// Reads EOBI_MDS::EOBICommonStructOld
///    depending on EOBI_MDS::EOBICommonStructOld::msgType
///    and for msgType == EOBI_MDS::EOBI_ORDER
///        depending on EOBI_MDS::EOBICommonStructOld::data_::eobi_order_::action_
...
class EOBILoggedMessageFileSource : public ExternalDataListener {
 protected:
  ...
  EOBI_MDS::EOBICommonStructOld next_event_;
