/**
    \file MDSMessages/chix_l1_logged_message_filesource.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_MDSMESSAGES_CHIX_L1_LOGGED_MESSAGE_FILESOURCE_H
#define BASE_MDSMESSAGES_CHIX_L1_LOGGED_MESSAGE_FILESOURCE_H
...
/// @brief reads CHIX logged data stored in file for this { symbol, tradingdate }
/// Reads BATSCHI_PL_MDS::BatsChiPLCommonStruct
///    depending on BATSCHI_PL_MDS::BatsChiPLCommonStruct::msgType
///    and for msgType == CHIX_MDS::CHIX_DELTA
///        depending on BATSCHI_PL_MDS::BatsChiPLCommonStruct::data_::chix_dels_::action_
///        calls the listeners, if any, of the security, action_
class CHIXL1LoggedMessageFileSource : public ExternalDataListener {
 protected:
  ...
  BATSCHI_PL_MDS::BatsChiPLCommonStruct next_event_;
 ...
 public:
   ...
   */
  CHIXL1LoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
...
#endif  // BASE_MDSMESSAGES_CHIX_L1_LOGGED_MESSAGE_FILESOURCE_H
