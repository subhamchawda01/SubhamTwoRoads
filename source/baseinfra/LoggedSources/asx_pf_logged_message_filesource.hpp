/**
    \file LoggedSources/asx_pf_logged_message_filesource.hpp
...
class ASXPFLoggedMessageFileSource : public ExternalDataListener {
 protected:
 ...
 public:
   ...
   */
  ASXPFLoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
