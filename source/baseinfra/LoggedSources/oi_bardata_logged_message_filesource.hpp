...
#include "baseinfra/LoggedSources/oi_bardata_logged_message_filenamer.hpp"



namespace HFSAT {

  class OiBarDataLoggedFileSource : public ExternalDataListener {
    ...
    protected:
      ...
      std::string options_type_;
      double options_strike_;
      std::string exch_;


    public:
      OiBarDataLoggedFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
                              ...
                              bool t_is_options_,std::string t_options_expiry_,std::string t_options_type_, std::string t_exch_);
