/**
    \file LoggedSources/tmx_logged_message_filesource.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef TMX_LOGGED_MESSAGE_FILESOURCE_H
#define TMX_LOGGED_MESSAGE_FILESOURCE_H
...
/// @brief reads TMX logged data stored in file for this { symbol, tradingdate }
/// Reads TMX_MDS::TMXCommonStruct
///    depending on TMX_MDS::TMXCommonStruct::msgType
///    and for msgType == TMX_MDS::TMX_DELTA
///        depending on TMX_MDS::TMXCommonStruct::data_::bmf_dels_::action_
///        calls the listeners, if any, of the security, action_
class TMXLoggedMessageFileSource : public ExternalDataListener {
 protected:
 ...
 public:
  TMXLoggedMessageFileSource(DebugLogger& t_debuglogger_, SecurityNameIndexer& t_sec_name_indexer_,
  ...
  inline bool IsNormalTradeTime(int securityId, ttime_t tv) {
    return tmx_trade_time_manager_.isValidTimeToTrade(securityId, tv.tv_sec % 86400);
  }
