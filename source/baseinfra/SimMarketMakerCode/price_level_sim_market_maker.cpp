...
void PriceLevelSimMarketMaker::OnMarketUpdate(const unsigned int _security_id_,
  ...
  if (_market_update_info_.bestbid_price_ == kInvalidPrice || _market_update_info_.bestask_price_ == kInvalidPrice) {
    return;
  }
