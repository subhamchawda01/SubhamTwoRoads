...
struct MDEntryInit_t {
  ...
  union {
    ...
    OpeningPriceInit_t openingPrice;  //< \brief Valid when \ref MDEntryType = '4' (OpeningPrice). Check if your API
                                      //version supports this MDEntryType.
    ImbalanceInit_t imbalance;  //< \brief Valid when \ref MDEntryType = '7' (TradingSessionHighPrice). Check if your
                                //API version supports this MDEntryType.
  };
};
