...
IndexedAsxMarketViewManager::IndexedAsxMarketViewManager(
...
void IndexedAsxMarketViewManager::DropIndexedBookForSource(HFSAT::ExchSource_t t_exch_source_,
 ...
 */
void IndexedAsxMarketViewManager::OnPriceLevelNew(const unsigned int t_security_id_, const TradeType_t t_buysell_,
  ...
  HFSAT::CpucycleProfiler::GetUniqueInstance(30).End(11);
#endif
...
void IndexedAsxMarketViewManager::OnPriceLevelChange(const unsigned int t_security_id_, const TradeType_t t_buysell_,
 ...
 */
void IndexedAsxMarketViewManager::OnPriceLevelDelete(const unsigned int t_security_id_, const TradeType_t t_buysell_,
 ...
 */
void IndexedAsxMarketViewManager::OnTrade(const unsigned int t_security_id_, const double t_trade_price_,
...
void IndexedAsxMarketViewManager::OnResetBegin(const unsigned int t_security_id_) {
  SecurityMarketView& smv_ = *(security_market_view_map_[t_security_id_]);
  smv_.InitializeSMVForIndexedBook();
}
void IndexedAsxMarketViewManager::OnResetEnd(const unsigned int t_security_id_) {}
}
