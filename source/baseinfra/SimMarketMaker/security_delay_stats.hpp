...
class SecurityDelayStats {
 public:
  static SecurityDelayStats& GetUniqueInstance(const unsigned security_id, Watch& watch,
 ...
 private:
  SecurityDelayStats(Watch& watch, const unsigned security_id, TradingLocation_t trading_location,
                     int _normal_delay_usecs);
  ~SecurityDelayStats();
