...
class IndexedEobiPriceLevelMarketViewManager : public PriceLevelGlobalListener,
 ...
 public:
  IndexedEobiPriceLevelMarketViewManager(DebugLogger& t_dbglogger_, const Watch& t_watch_,
