...
class FpgaEobiPriceLevelMarketViewManager : public PriceLevelGlobalListener,
 ...
 public:
  FpgaEobiPriceLevelMarketViewManager(DebugLogger& t_dbglogger_, const Watch& t_watch_,
  ...
  inline void printBook(const unsigned int t_security_id_) {
    ...
    for (int t_level_ = 0; t_level_ < 5; t_level_++) {
      printf("%2d %5d %3d %11.7f %7d X %7d %11.7f %3d %5d %2d\n",
             ...
             smv_.market_update_info_.bidlevels_[t_level_].limit_size_,
             smv_.market_update_info_.bidlevels_[t_level_].limit_ordercount_,
             smv_.market_update_info_.bidlevels_[t_level_].limit_price_,
             smv_.market_update_info_.bidlevels_[t_level_].limit_int_price_,
             smv_.market_update_info_.asklevels_[t_level_].limit_int_price_,
             smv_.market_update_info_.asklevels_[t_level_].limit_price_,
             smv_.market_update_info_.asklevels_[t_level_].limit_ordercount_,
             smv_.market_update_info_.asklevels_[t_level_].limit_size_,
