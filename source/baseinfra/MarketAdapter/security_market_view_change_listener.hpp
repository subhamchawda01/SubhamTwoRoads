...
class SecurityMarketViewChangeListener {
 public:
  ...
  virtual void OnIndexUpdate(const unsigned int _security_id_, double const t_spot_index_price_) {}
  virtual void OnOpenInterestUpdate(const unsigned int _security_id_, double const t_Oi_price_) {} 
  virtual void OnCircuitUpdate() {};
};

class SecurityMarketViewBardataListener {
 public:
  virtual ~SecurityMarketViewBardataListener() {}
  virtual void OnBardataUpdate(const unsigned int _security_id_, const char* _bardata_line_) {}
  virtual void OnIndexUpdate(const unsigned int _security_id_, double const t_spot_index_price_) {}
  virtual void OnOpenInterestUpdate(const unsigned int _security_id_, double const t_Oi_price_) {}
};
...
typedef std::vector<SecurityMarketViewBardataListener*> SMVBardataListenerVec;
