...
struct RetailReplyStruct {
  ...
  std::string ToString() {
    ...
    t_temp_oss_ << "Sym: " << symbol_ << " Px: " << std::fixed << std::setprecision(6) << price_
                << " ST: " << time_set_by_server_.val << " CT: " << client_request_time_
                << " ORR: " << ToString(orr_type_) << " SAMS: " << server_assigned_message_sequence_
                << " SACI: " << server_assigned_client_id_ << " SR: " << size_remaining_ << " BS: " << (int)(buysell_)
...
struct GenericORSReplyStructLiveProShm {
  char symbol_[kSecNameLen];     ///< b(16) exchange symbol this order was about
  double price_;                 ///< b(8) price of the order
  ttime_t client_request_time_;  // basically source time of the data
  ...
  uint64_t ors_end_cycles_from_exchange_;
  uint64_t csw_start_cycles_;
  uint32_t csw_end_cycles_delta_;
  uint32_t query_start_cycles_delta_;
  uint32_t query_end_cycles_delta_;
  uint32_t ors_start_cycles_delta_;
  uint32_t ors_end_cycles_delta_;
  int32_t order_flags_;
  ...
  std::string ToString() {
    ...
    t_temp_oss_ << "Sym: " << symbol_ << " Px: " << std::fixed << std::setprecision(6) << price_
                << " CT: " << client_request_time_ << " ORR: " << ToString(orr_type_)
                << " SACI: " << server_assigned_client_id_ << " SR: " << size_remaining_ << " BS: " << (int)(buysell_)
                << " SAOS: " << server_assigned_order_sequence_ << " CAOS: " << client_assigned_order_sequence_
                << " SE: " << size_executed_ << " CP: " << client_position_ << " GP: " << global_position_
                << " IP: " << int_price_ << " QP: " << query_order_ptr_ << " OP: " << ors_order_ptr_
                << " CS: " << csw_start_cycles_ << " CE: " << csw_end_cycles_delta_
                << " QS: " << query_start_cycles_delta_ << " QE: " << query_end_cycles_delta_
                << " OS: " << ors_start_cycles_delta_ << " OE: " << ors_end_cycles_delta_
                << " EE: " << ors_end_cycles_from_exchange_ << " OF: " << order_flags_ << std::endl;
...
struct GenericORSRequestStruct {
  ...
  int size_disclosed_;
  bool is_reserved_type_;  // Flag to indicate reserved type for throttle
  ...
  std::string ToString() const {
    ...
    ss << "GenericORSRequestStruct: { symbol_: " << symbol_ << ", price_: " << price_
       ...
       << ", is_reserved_type_ : " << is_reserved_type_ << ", size_disclosed_: " << size_disclosed_
