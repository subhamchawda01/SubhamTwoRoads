...
typedef enum {
  ...
  kControlMessageEnableEfficientSquareoff,
  kControlMessageGetEODPositions,
  kControlMessageUnfreezeDataEntryReject,
  kControlMessageReloadSpanFile,
...
inline const char *GetControlMessageCodeString(ControlMessageCode_t _control_message_code_) {
  switch (_control_message_code_) {
    ...
    case kControlMessageCodeSetBreakMsecsOpenTradeLoss:
      ...
      break;
    case kControlMessageEnableEfficientSquareoff:
      return "kControlMessageEnableEfficientSquareoff";
      break;
    case kControlMessageGetEODPositions:
      return "kControlMessageGetEODPositions";
      break;
    ...
    case kControlMessageUnfreezeDataEntryReject:
      return "kControlMessageUnfreezeDataEntryReject";
    case kControlMessageReloadSpanFile:
      return "kControlMessageReloadSpanFile";
    default:
      break;
  }
