...
class DebugLogger {
 ...
 public:
  ...
  static inline int TextToLogLevel(const char* log_level_text_) {
   ...
   virtual void LogQueryOrder(HFSAT::CDef::LogBuffer& buffer, char *sec_shortcode_, char *identifier_, ttime_t tv, HFSAT::TradeType_t side, bool is_eye, bool is_consec,
