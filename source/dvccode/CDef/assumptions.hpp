...
#define DEF_MAX_SEC_ID 8192
#define ORS_MAX_NUM_OF_CLIENTS 8191
...
#define NSE_MAX_RECOVERY_PACKET_SIZE 134217728
#define MAX_RECOVERY_PACKET_SIZE 134217728
#define BSE_MAX_RECOVERY_PACKET_SIZE 134217728

#define NSE_RECOVERY_HOST_IP "127.0.0.1"
#define NSE_RECOVERY_HOST_PORT 44011
#define NSE_MAX_FD_SUPPORTED 1024
#define BSE_MAX_FD_SUPPORTED 1024
...
#define NSE_SPOT_CHANNELS_ADDRESS_PATTERN "239.50.50"
#define NSE_OI_CHANNELS_ADDRESS_PATTERN "239.50.51"
#define BSE_EQ_CHANNELS_ADDRESS_PATTERN "237.0"
#define BSE_FO_CHANNELS_ADDRESS_PATTERN "238.0"
#define BSE_CD_CHANNELS_ADDRESS_PATTERN "236.0"
#define BSE_SPOT_CHANNELS_ADDRESS_PATTERN "227.0"
#define BSE_OI_CHANNELS_ADDRESS_PATTERN "228.0"
...
#define NSE_IX_SEGMENT_MARKING 'S'
...
#define BSE_EQ_SEGMENT_MARKING 'E'
#define BSE_FO_SEGMENT_MARKING 'F'
#define BSE_CD_SEGMENT_MARKING 'C'
#define BSE_IX_SEGMENT_MARKING 'S'
#define BSE_INVALID_SEGMENT 'I'
#define BSE_IX_SEGMENT_MARKING 'S'

// NSE & BSE acceptable max params
#define MAX_ACCEPTABLE_POS 120
#define MAX_ACCEPTABLE_ORDER_SIZE 40
...
// Bardata Recovery Requet message length
#define BARDATA_RECOVERY_REQUEST_EXCHANGE_LENGTH 4
#define BARDATA_RECOVERY_REQUEST_SEGMENT_LENGTH 1
#define BARDATA_RECOVERY_REQUEST_SYMBOL_LENGTH 32
#define BARDATA_RECOVERY_REQUEST_START_TIME_LENGTH 4
#define BARDATA_RECOVERY_REQUEST_END_TIME_LENGTH 4
#define BARDATA_RECOVERY_REQUEST_MESSAGE_LENGTH \
  (BARDATA_RECOVERY_REQUEST_EXCHANGE_LENGTH + BARDATA_RECOVERY_REQUEST_SEGMENT_LENGTH + BARDATA_RECOVERY_REQUEST_SYMBOL_LENGTH + BARDATA_RECOVERY_REQUEST_START_TIME_LENGTH + BARDATA_RECOVERY_REQUEST_END_TIME_LENGTH)
...
#define CONTROL_MDS_SHM_KEY 9236
#define SIGNAL_MDS_SHM_KEY 9347
