...
/apps/s3cmd/s3cmd-1.5.0-alpha1/s3cmd put $FILENAME s3://s3dvc$FILENAME > /dev/null;
...
ssh dvctrader@52.0.55.252 "mkdir -p $enclosing_folder ; \
/home/dvctrader/s3cmd-1.5.0-rc1/s3cmd get --skip-existing --no-progress $s3_path $path_temp > /dev/null; \
