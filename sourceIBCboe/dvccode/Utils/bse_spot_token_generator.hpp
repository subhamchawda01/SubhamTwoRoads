#ifndef _BSE_SPOT_INDEX_GEN_HPP_
#define _BSE_SPOT_INDEX_GEN_HPP_
...
#define BSE_SPOT_INDEX_TOKEN_FILE "/spare/local/files/BSE/spot_index_token.txt"

class BSESpotTokenGenerator {
 public:
  static BSESpotTokenGenerator& GetUniqueInstance();
 ...
 private:
  BSESpotTokenGenerator();
  static BSESpotTokenGenerator* unique_instance_;
