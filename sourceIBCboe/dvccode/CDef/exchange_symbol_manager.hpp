...
class ExchangeSymbolManager {
 ...
 public:
  ...
  static void AddExchSymbol(const std::string& _shortcode_, const std::string& _exchange_symbol_) {
    GetUniqueInstance()._AddExchSymbol(_shortcode_,_exchange_symbol_);
  }
 ...
 protected:
  ...
  void _AddExchSymbol(const std::string& _shortcode_, const std::string& _exchange_symbol_);
  ...
  inline void _addlocalstore(const std::string& _shortcode_, const std::string& _exchange_symbol_) {
    ShortcodeExchangeSymbolMap::const_iterator _citer_ = shortcode_exchange_symbol_map_.find(_shortcode_);
    if (_citer_ != shortcode_exchange_symbol_map_.end()) {
      std::cerr<<"Already added this shortcode_"<<std::endl;
    }else {
      shortcode_exchange_symbol_map_[_shortcode_]=_exchange_symbol_.c_str();
    }
    return;
  }
