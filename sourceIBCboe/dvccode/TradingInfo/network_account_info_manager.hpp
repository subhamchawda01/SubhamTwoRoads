...
class NetworkAccountInfoManager {
 protected:
  ...
  DataInfo trade_control_recv_udp_direct_data_info_;
  DataInfo trade_signal_recv_udp_direct_data_info_;
  DataInfo combined_control_data_info_;
  DataInfo combined_control_udp_direct_data_info_;
 ...
 public:
  ...
  const DataInfo GetControlRecvUDPDirectDataInfo() const;
  const DataInfo GetSignalRecvUDPDirectDataInfo() const;
  ...
  const DataInfo GetCombControlUDPDirectDataInfo() const;
