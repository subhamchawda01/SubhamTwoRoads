...
void OnlineDebugLogger::LogQueryOrder(HFSAT::CDef::LogBuffer &buffer,char const *sec_shortcode_, char const *identifier_, ttime_t tv, TradeType_t side, bool is_eye,
