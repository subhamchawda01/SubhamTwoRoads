...
#include "dvccode/IBUtils/EReaderSignal.hpp"
...
const int MIN_SERVER_VER_SUPPORTED    = 38; //all supported server versions are defined in dvccode/IBUtils/EDecoder.hpp
