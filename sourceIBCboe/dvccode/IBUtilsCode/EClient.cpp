...
#include "dvccode/IBUtils/EMessage.hpp"
#include "dvccode/IBUtils/ETransport.hpp"
#include "dvccode/IBUtils/FamilyCode.hpp"
#include "dvccode/IBUtils/EClientException.hpp"
...
//   std::cout << "PLACE ORDER CALLED BUT AVOIDED..." << std::endl;
//   return;
    // not connected?
    if( !isConnected()) {
