...
Contract ContractSamples::USOptionContract(){
	...
	contract.currency = "USD";
	contract.lastTradeDateOrContractMonth = "20241114";
	contract.strike = 5835;
	contract.right = "C";
	contract.multiplier = "100";
	return contract;
}
...
Contract ContractSamples::OptionComboContract(){
	...
	leg1->conId = 704323727;
	leg1->action = "SELL";
	leg1->ratio = 1;
	leg1->exchange = "CBOE";

	ComboLegSPtr leg2(new ComboLeg);
	leg2->conId = 704325111;
	leg2->action = "SELL";
	leg2->ratio = 1;
	leg2->exchange = "CBOE";

	ComboLegSPtr leg3(new ComboLeg);
	leg3->conId = 704323732;
	leg3->action = "BUY";
	leg3->ratio = 1;
	leg3->exchange = "CBOE";

	ComboLegSPtr leg4(new ComboLeg);
	leg4->conId = 704325100;
	leg4->action = "BUY";
	leg4->ratio = 1;
	leg4->exchange = "CBOE";
	...
	contract.comboLegs->push_back(leg4);
	//! [bagoptcontract]
	return contract;
}
