...
#include <cstdlib>
#include <map>
#include "dvccode/IBUtils/TagValue.hpp"
...
public:
	...
	std::string ToString() const {
        ...
        oss << "Contract Details:\n";
        oss << "  ConId: " << conId << "\n";
        oss << "  Symbol: " << symbol << "\n";
        oss << "  SecType: " << secType << "\n";
        oss << "  LastTradeDateOrContractMonth: " << lastTradeDateOrContractMonth << "\n";
        oss << "  Strike: " << strike << "\n";
        oss << "  Right: " << right << "\n";
        oss << "  Multiplier: " << multiplier << "\n";
        oss << "  Exchange: " << exchange << "\n";
        oss << "  PrimaryExchange: " << primaryExchange << "\n";
        oss << "  Currency: " << currency << "\n";
        oss << "  LocalSymbol: " << localSymbol << "\n";
        oss << "  TradingClass: " << tradingClass << "\n";
        oss << "  IncludeExpired: " << (includeExpired ? "true" : "false") << "\n";
        oss << "  SecIdType: " << secIdType << "\n";
        oss << "  SecId: " << secId << "\n";
        oss << "  Description: " << description << "\n";
        oss << "  IssuerId: " << issuerId << "\n";

        if (comboLegs) {
            oss << "  ComboLegs:\n";
            for (const auto& leg : *comboLegs) {
                oss << "    [ConId: " << leg->conId
                    << ", Action: " << leg->action
                    << ", Ratio: " << leg->ratio
        ...
        if (deltaNeutralContract) {
            oss << "  DeltaNeutralContract: Exists\n";
        } else {
            oss << "  DeltaNeutralContract: None\n";
        }
