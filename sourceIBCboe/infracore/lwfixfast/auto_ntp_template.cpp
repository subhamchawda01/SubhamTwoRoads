...
void NTP_TEMPLATE_DECODER::MDNewsMessage_120::process() {}
...
void NTP_TEMPLATE_DECODER::MDSecurityStatus_125::process() {
...
void NTP_TEMPLATE_DECODER::MDIncRefresh_123::ProcessTrade(char entry_type, uint64_t sec_id) {
  NTP_MD_PROCESSOR::NtpMDProcessor& md_processor = NTP_MD_PROCESSOR::NtpMDProcessor::GetInstance();
...
void NTP_TEMPLATE_DECODER::MDIncRefresh_123::ProcessBookDelta(char entry_type, uint64_t sec_id) {
  NTP_MD_PROCESSOR::NtpMDProcessor& md_processor = NTP_MD_PROCESSOR::NtpMDProcessor::GetInstance();
...
void NTP_TEMPLATE_DECODER::MDIncRefresh_123::ProcessOpeninigPrice(char entry_type, uint64_t sec_id) {
  NTP_MD_PROCESSOR::NtpMDProcessor& md_processor = NTP_MD_PROCESSOR::NtpMDProcessor::GetInstance();
  ...
  int32_t size = MDEntrySize->isValueSet ? (MDEntrySize->previousValue).getValue() : 0;
  uint32_t seq_no = (RptSeq->previousValue).getValue();
  uint32_t open_close_flag = OpenCloseSettleFlag->previousValue.getValue();

  md_processor.UpdateOpeningPrice(sec_id, price, size, seq_no, open_close_flag);
}

void NTP_TEMPLATE_DECODER::MDIncRefresh_123::ProcessImbalance(char entry_type, uint64_t sec_id) {
  NTP_MD_PROCESSOR::NtpMDProcessor& md_processor = NTP_MD_PROCESSOR::NtpMDProcessor::GetInstance();
...
void NTP_TEMPLATE_DECODER::MDIncRefresh_123::process() {
  uint64_t sec_id = SecurityID->previousValue.getValue();
...
void NTP_TEMPLATE_DECODER::MDIncRefresh_123::process_end() {
  NTP_MD_PROCESSOR::NtpMDProcessor& md_processor = NTP_MD_PROCESSOR::NtpMDProcessor::GetInstance();

  md_processor.flushQuoteQueue(false);
}

void NTP_TEMPLATE_DECODER::MDSequenceReset::process() { NTP_MD_PROCESSOR::NtpMDProcessor::GetInstance().seqReset(); }

void NTP_TEMPLATE_DECODER::MDSecurityList_111::process() {
  NTP_MD_PROCESSOR::NtpMDProcessor& md_processor = NTP_MD_PROCESSOR::NtpMDProcessor::GetInstance();
...
void NTP_TEMPLATE_DECODER::MDSnapshotFullRefresh_124::process() {
  NTP_MD_PROCESSOR::NtpMDProcessor& md_processor = NTP_MD_PROCESSOR::NtpMDProcessor::GetInstance();
...
void NTP_TEMPLATE_DECODER::MDSnapshotFullRefresh_124::process_end() {}

bool NTP_TEMPLATE_DECODER::MDSnapshotFullRefresh_124::findSecurity() {
  NTP_MD_PROCESSOR::NtpMDProcessor& md_processor = NTP_MD_PROCESSOR::NtpMDProcessor::GetInstance();
...
void NTP_TEMPLATE_DECODER::MDHeartbeat_101::process() {}
