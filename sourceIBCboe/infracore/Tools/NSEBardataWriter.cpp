...
int main(int argc, char* argv[]) {
  ...
  HFSAT::NSEMD::NSETBTRawMDHandler::GetUniqueInstance(dbglogger_, *simple_live_dispatcher, nullptr, mode, exch_);
  if (argc > 2 ) HFSAT::NSEMD::NSETBTRawMDHandler::GetUniqueInstance(dbglogger_, *simple_live_dispatcher, nullptr, mode, exch_).SetBardataPeriod(stoi(argv[1]));
