...
case $CMD in
	...
	then
	    ...
	    ls > $PIDFILE
	        ...
	        onload $ORSBCAST_LOG_EXEC --exch $EXCH --ip $ORSBCAST_IP --port $ORSBCAST_PORT &
                ...
                then 
                  ...
                  LD_PRELOAD=libvma.so $ORSBCAST_LOG_EXEC --exch $EXCH --ip $ORSBCAST_IP --port $ORSBCAST_PORT &
