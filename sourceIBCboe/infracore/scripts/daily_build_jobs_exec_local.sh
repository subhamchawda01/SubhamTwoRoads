...
rsync -avz ~/important/DAILY_BUILD_JOBS_EXEC 10.23.5.26:~/important/
rsync -avz ~/important/DAILY_BUILD_JOBS_EXEC 10.23.5.66:~/important/
rsync -avz ~/important/DAILY_BUILD_JOBS_EXEC 10.23.5.43:~/important/
