...
#ssh dvctrader@54.90.155.232 '/home/dvctrader/EOD_SCRIPTS/eod_jobs.sh';
#sleep 10;
echo "EODCHECK"
...
#  echo "To: raghunandan.sharma@tworoads-trading.co.in, hardik.dhakate@tworoads-trading.co.in, sanjeev.kumar@tworoads-trading.co.in"
