...
'''
 Here pick fut0 lotsize on all days other than expiry day
'''
...
def get_position_limits(row,base_num_spreads_factor,max_num_spreads_diff,physical_factor,banned_products,physical_settlement_products, exp_num):
    if row['Stock'] in banned_products:
        ...
        base_num_spreads = 10*physical_factor
        max_num_spreads = 20*physical_factor
    else:
        base_num_spreads = 10
        max_num_spreads = 20
...
output_position_file_ = "/home/dvctrader/usarraf/PositionLimits.13"
