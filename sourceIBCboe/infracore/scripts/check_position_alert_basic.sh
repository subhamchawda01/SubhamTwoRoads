...
#cat $email_file | mailx -s "Position Limit alert CASH $today" -r "${HOSTNAME}-${USER}<raghunandan.sharma@tworoads-trading.co.in>" raghunandan.sharma@tworoads-trading.co.in
