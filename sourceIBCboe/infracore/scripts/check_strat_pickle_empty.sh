...
then
         echo "File not empty"
         cat $mail_file | mailx -s "Alert: Error Picke File empty" -r "${HOSTNAME}-${USER}<raghunandan.sharma@tworoads-trading.co.in>" raghunandan.sharma@tworoads-trading.co.in  smit@tworoads-trading.co.in  subham.chawda@tworoads-trading.co.in
fi
