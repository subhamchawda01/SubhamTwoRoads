...
#ssh dvctrader@54.90.155.232 "ulimit -m 1; echo {1..1000000000}"
#exit
ssh dvctrader@54.90.155.232 "ulimit -m 16777216; jupyter notebook --notebook-dir=/home/dvctrader/Jupyter_NoteBooks/ --no-browser --port=8080 >${log_file} 2>&1 " &
ssh_proc_id=$!
