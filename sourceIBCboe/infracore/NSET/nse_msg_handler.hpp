...
#include "infracore/NSET/NSETemplates/OrderEntryThreeLegDerivativesResponses.hpp"
...
#include "infracore/NSET/NSETemplates/ControlMsgResponse.hpp"
...
#include "infracore/NSET/NSETemplates/OrderEntryThreeLegDerivatives.hpp"
...
#include "infracore/NSET/NSETemplates/SecureBoxRegistration.hpp"
...
class NseMsgHandler {
 public:
  ...
  NSESecureBoxRegistrationRequest* secure_box_registration_request_;
  ...
  OrderEntryThreeLegRequestDerivatives* new_three_leg_order;
  ...
  OrderResponseThreeLeg* order_response_three_leg;
  ...
  KillSwitch* kill_switch_order;
  

  // Control Response msg handlers
  NSEControlMsgResponse* control_msg_response_;
  ...
  NseMsgHandler()
    ...
    secure_box_registration_request_ = new NSESecureBoxRegistrationRequest();
    ...
    control_msg_response_ = new NSEControlMsgResponse();
  }
