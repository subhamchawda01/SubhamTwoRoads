...
#include "infracore/NSET/NSETemplates/KillSwitchDerivative.hpp"
...
class NseMsgHandlerDerivatives : public NseMsgHandler {
 public:
  void InitialiseMsgStructures() {
    ...
    new_three_leg_order = new OrderEntryThreeLegRequestDerivatives();
    spread_new_order_ = new SpreadOrderEntryRequest();
    ...
    order_response_three_leg = new OrderResponseThreeLeg();
    ...
    kill_switch_order = new KillSwitchDerivative();
  }
