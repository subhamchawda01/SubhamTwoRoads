...
class OrderCancelRequest {
 ...
 public:
  virtual void SetPreLoadedOrderCancelRequestFields(int32_t const &user_id, char const *broker_id, double const &nnf,
  ...
  virtual void SetDynamicOrderCancelRequestFields(int32_t const &packet_sequence_number, int16_t const &buy_sell,
...
*/
  ...
  virtual void SetAccountNumber(char const *broker_id) {}
  virtual void UpdateAccountNumber(char const *broker_id) {}
  virtual void SetSettlor(char const *settlor) {}
  virtual void SetBuySell(int16_t const &buy_sell) {}
 ...
 public:
  virtual void SetPreLoadedOrderModifyRequestFields(int32_t const &user_id, char const *broker_id, double const &nnf,
                                                    int32_t const &algo_id, char const *pan, int16_t const &branch_id) {
    SetBranchId(branch_id);
    SetTraderId(user_id);
    SetPan(pan);
  ...
  virtual void SetDynamicOrderModifyRequestFields(int32_t const &packet_sequence_number, int16_t const &buy_sell,
                                                  int32_t const &price, HFSAT::ORS::Order *order,
                                                  InstrumentDesc *inst_desc, SecurityInfoCashMarket *sec_info,
                                                  bool add_preopen) = 0;
