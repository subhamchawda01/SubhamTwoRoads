...
#define NSE_LOGON_REQUEST_PASSWORD_OFFSET \
  (NSE_LOGON_REQUEST_STP_RESERVED1_OFFSET + NSE_LOGON_REQUEST_STP_RESERVED1_LENGTH)
...
#define NSE_LOGON_REQUEST_NEWPASSWORD_OFFSET \
  (NSE_LOGON_REQUEST_STP_RESERVED2_OFFSET + NSE_LOGON_REQUEST_STP_RESERVED2_LENGTH)
