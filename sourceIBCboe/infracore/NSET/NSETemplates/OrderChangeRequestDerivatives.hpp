...
class OrderCancelRequestDerivatives : public OrderCancelRequest {
 ...
 public:
  ...
  inline void SetProClient(int16_t const &proclient){
    ...
    *((int16_t *)(msg_ptr + NSE_CHANGE_REQUEST_PROCLIENTINDICATOR_OFFSET)) = hton16(proclient); // default is 2
  }
  ...
  inline void UpdateAccountNumber(char const *broker_id) {
    memcpy((void *)(msg_ptr + NSE_CHANGE_REQUEST_ACCOUNTNUMBER_OFFSET),
           (void *)broker_id, NSE_CHANGE_REQUEST_ACCOUNTNUMBER_LENGTH);
  }

  inline void SetSettlor(char const *settlor_) {
    memcpy((void *)(msg_ptr + NSE_CHANGE_REQUEST_SETTLOR_OFFSET), (void *)settlor_,
           NSE_CHANGE_REQUEST_SETTLOR_LENGTH);  // this field should be set to blank for a pro order
  }
  ...
  */
  ...
  inline void SetDynamicOrderCancelRequestFields(int32_t const &packet_sequence_number, int16_t const &buy_sell,
                                                 int32_t const &price, HFSAT::ORS::Order *order,
                                                 InstrumentDesc *inst_desc, SecurityInfoCashMarket *sec_info,
                                                 bool add_preopen = false) {
    memcpy((void *)(msg_ptr + NSE_CHANGE_REQUEST_TOKENNUM_OFFSET), inst_desc, sizeof(InstrumentDesc));
    *((int32_t *)(msg_ptr + NSE_PACKET_SEQUENCE_OFFSET)) = hton32(packet_sequence_number);
    *((int64_t *)(msg_ptr + NSE_CHANGE_REQUEST_ORDERNUMBER_OFFSET)) =
        (int64_t)ntoh64((int64_t)order->exch_assigned_seq_);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_ENTRYDATETIME_OFFSET)) = hton32(order->entry_dt_);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_LASTMODIFIED_OFFSET)) = hton32(order->last_mod_dt_);
    *((int64_t *)(msg_ptr + NSE_CHANGE_REQUEST_LASTACTIVITYREFERENCE_OFFSET)) = hton64(order->last_activity_reference_);
    *((int16_t *)(msg_ptr + NSE_CHANGE_REQUEST_BUYSELLINDICATOR_OFFSET)) = hton16(buy_sell);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_DISCLOSEDVOLUME_OFFSET)) = hton32(order->size_remaining_);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_VOLUME_OFFSET)) = hton32(order->size_remaining_);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_DISCLOSEDVOLUMEREMAINING_OFFSET)) = hton32(order->size_remaining_);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_TOTALVOLUMEREMAINING_OFFSET)) = hton32(order->size_remaining_);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_PRICE_OFFSET)) = hton32(price);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_FILLER_OFFSET)) = hton32(order->server_assigned_order_sequence_);
...
class OrderModifyRequestDerivatives : public OrderModifyRequest {
  ...
  */
  ...
  inline void SetDynamicOrderModifyRequestFields(int32_t const &packet_sequence_number, int16_t const &buy_sell,
                                                 int32_t const &price, HFSAT::ORS::Order *order,
                                                 InstrumentDesc *inst_desc, SecurityInfoCashMarket *sec_info,
                                                 bool add_preopen = false) {
    memcpy((void *)(msg_ptr + NSE_CHANGE_REQUEST_TOKENNUM_OFFSET), inst_desc, sizeof(InstrumentDesc));
    ...
    *((int64_t *)(msg_ptr + NSE_CHANGE_REQUEST_LASTACTIVITYREFERENCE_OFFSET)) = hton64(order->last_activity_reference_);
    *((int16_t *)(msg_ptr + NSE_CHANGE_REQUEST_BUYSELLINDICATOR_OFFSET)) = hton16(buy_sell);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_DISCLOSEDVOLUME_OFFSET)) = hton32(order->size_disclosed_);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_VOLUME_OFFSET)) = hton32(order->size_remaining_);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_DISCLOSEDVOLUMEREMAINING_OFFSET)) = hton32(order->size_disclosed_);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_TOTALVOLUMEREMAINING_OFFSET)) = hton32(order->size_remaining_);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_VOLUMEFILLEDTODAY_OFFSET)) = hton32(order->size_executed_);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_PRICE_OFFSET)) = hton32(price);
    *((int32_t *)(msg_ptr + NSE_CHANGE_REQUEST_FILLER_OFFSET)) = hton32(order->server_assigned_order_sequence_);
    /*
    SetInstrumentDesc(inst_desc->GetInstrumentDescAsBuffer());
