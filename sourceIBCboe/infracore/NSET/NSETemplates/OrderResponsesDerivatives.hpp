...
#define NSE_ORDER_RESPONSE_LENGTH ( NSE_ORDER_RESPONSE_LASTACTIVITYREFERENCE_OFFSET + NSE_ORDER_RESPONSE_LASTACTIVITYREFERENCE_LENGTH + 52)
 ...
 public:
  inline ProcessedOrderResponse *ProcessOrderResponse(const char *msg_ptr) {
    ...
    processed_order_response_.last_activity_reference = 
        ntoh64(*((int64_t *)(msg_ptr + NSE_ORDER_RESPONSE_LASTACTIVITYREFERENCE_OFFSET)));
