...
void IndexedNSEMarketViewManager2::OnIndexPrice(const unsigned int t_security_id_, double const t_spot_price_){
...
void IndexedNSEMarketViewManager2::OnOpenInterestUpdate(const unsigned int t_security_id_, double const t_oi_price_){
  SecurityMarketView &smv_ = *(security_market_view_map_[t_security_id_]);
