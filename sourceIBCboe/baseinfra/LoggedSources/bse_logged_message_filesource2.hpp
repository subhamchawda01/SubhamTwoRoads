...
namespace HFSAT {
  ...
  class BSELoggedMessageFileSource2 : public ExternalDataListener {
  protected:
  ...
  public:
     ...
     */
    BSELoggedMessageFileSource2(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
