/**
    \file LoggedSources/OSE_logged_message_filenamer.hpp
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_MDSMESSAGES_OSE_LOGGED_MESSAGE_FILENAMER_H
#define BASE_MDSMESSAGES_OSE_LOGGED_MESSAGE_FILENAMER_H
...
/// Returns the name of the data file where OSE MDS has logged data
/// Typically it will be of the format /NAS1/data/OSE_L1LoggedData/OSE/2011/05/01/DOLM11_20110501
class OSEL1LoggedMessageFileNamer {
 public:
  ...
  static std::string GetName(const char* _exchange_symbol_, const unsigned int _preevent_YYYYMMDD_,
    ...
    static std::string logging_dir = "/NAS1/data/OSENew_L1LoggedData/";
...
#endif  // BASE_MDSMESSAGES_OSE_LOGGED_MESSAGE_FILENAMER_H
