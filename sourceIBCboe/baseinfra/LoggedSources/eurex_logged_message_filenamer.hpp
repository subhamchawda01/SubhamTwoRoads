/**
    ...
    \author: (c) Copyright Two Roads Technological Solutions Pvt Ltd 2011
     Address:
         ...
         +91 80 4190 3551
*/
#ifndef BASE_MDSMESSAGES_EUREX_LOGGED_MESSAGE_FILENAMER_H
#define BASE_MDSMESSAGES_EUREX_LOGGED_MESSAGE_FILENAMER_H
...
/// Typically it will be of the format /NAS1/data/EUREXLoggedData/2009/12/01/FESX200912_20091201
class EUREXLoggedMessageFileNamer {
 public:
  static std::string GetName(const char* _exchange_symbol_, const unsigned int _preevent_YYYYMMDD_,
    ...
    static std::string logging_dir = "/NAS1/data/EUREXLoggedData/";
...
#endif  // BASE_MDSMESSAGES_EUREX_LOGGED_MESSAGE_FILENAMER_H
