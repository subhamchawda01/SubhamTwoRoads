/**
    \file LoggedSources/asx_logged_message_filesource.hpp
...
class ASXLoggedMessageFileSource : public ExternalDataListener {
 protected:
  ...
  ASX_MDS::ASXCommonStruct next_event_;
 ...
 public:
   ...
   */
  ASXLoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
  ...
  void NotifyOrderExecWithPx(const uint32_t security_id, const uint64_t bid_order_id, const uint64_t ask_order_id,
