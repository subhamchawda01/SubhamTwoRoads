/**
    \file LoggedSources/ibkr_logged_message_filesource.hpp
...
#include "baseinfra/LoggedSources/ibkr_l1_logged_message_filenamer.hpp"
...
/// @brief reads IBKR logged data stored in file for this { symbol, tradingdate }
/// Reads IBKR_MDS::IBKRCommonStruct
///    depending on IBKR_MDS::IBKRCommonStruct::msgType
///    and for msgType == IBKR_MDS::IBKR_ORDER
///        depending on IBKR_MDS::IBKRCommonStruct::data_::ibkr_order_::action_
///        calls the listeners, if any, of the security, action_
class IBKRL1LoggedMessageFileSource : public ExternalDataListener {
 public:
  /**
   ...
   */
  IBKRL1LoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
  ...
  void SetOrderGlobalListenerIBKR(OrderGlobalListenerIBKR* listener);
