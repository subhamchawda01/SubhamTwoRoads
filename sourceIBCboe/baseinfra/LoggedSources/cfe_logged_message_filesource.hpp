/**
   \file LoggedSources/cfe_logged_message_filesource.hpp
...
class CFELoggedMessageFileSource : public ExternalDataListener {
 protected:
 ...
 public:
   ...
   */
  CFELoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
  ...
  inline void SetPriceLevelGlobalListener(CFEPriceLevelGlobalListener* p_new_listener_) {
