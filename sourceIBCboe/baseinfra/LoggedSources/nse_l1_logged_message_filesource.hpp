...
class NSEL1LoggedMessageFileSource : public ExternalDataListener {
 public:
  /**
   ...
   */
  NSEL1LoggedMessageFileSource(DebugLogger& t_dbglogger_, SecurityNameIndexer& t_sec_name_indexer_,
 ...
 protected:
  ...
  char shortcode_[NSE_DOTEX_OFFLINE_SYMBOL_LENGTH];
