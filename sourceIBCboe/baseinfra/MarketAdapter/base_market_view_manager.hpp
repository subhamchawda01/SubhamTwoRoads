...
class BaseMarketViewManager : public OrderExecutedListener,
 ...
 public:
  ...
  inline void UpdateBestBidVariables(const unsigned int t_security_id_, const unsigned int index) {
    ...
    if (smv_.market_update_info_.bidlevels_[index].limit_size_ > 0) {
      ...
      smv_.market_update_info_.bestbid_int_price_ = kInvalidIntPrice;
      smv_.market_update_info_.bestbid_ordercount_ = 0;
      smv_.market_update_info_.bestbid_price_ = kInvalidPrice;
      smv_.market_update_info_.bestbid_size_ = kInvalidSize;
    }
  ...
  inline void UpdateBestAskVariables(const unsigned int t_security_id_, const unsigned int index) {
    ...
    if (smv_.market_update_info_.asklevels_[index].limit_size_ > 0) {
      ...
      smv_.market_update_info_.bestask_ordercount_ = 0;
      smv_.market_update_info_.bestask_price_ = kInvalidPrice;
      smv_.market_update_info_.bestask_size_ = kInvalidSize;
    }
