/**
   \file MarketAdapter/indexed_ntp_market_view_manager.hpp
...
class IndexedNtpMarketViewManager : public NTPPriceLevelGlobalListener,
 ...
 private:
  ...
  std::vector<TradeType_t> last_intermediate_update_;

  void SanitizeBook(SecurityMarketView& smv, bool intermediate);

 public:
  IndexedNtpMarketViewManager(DebugLogger& t_dbglogger_, const Watch& t_watch_,
