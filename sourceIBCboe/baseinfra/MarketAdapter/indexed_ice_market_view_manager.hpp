/**
   \file MarketAdapter/indexed_ice_market_view_manager.hpp
...
class IndexedIceMarketViewManager : public PriceLevelGlobalListener,
 ...
 public:
  IndexedIceMarketViewManager(DebugLogger& t_dbglogger_, const Watch& t_watch_,
  ...
  void OnResetBegin(const unsigned int t_security_id_) override;
  void OnResetEnd(const unsigned int t_security_id_) override;
