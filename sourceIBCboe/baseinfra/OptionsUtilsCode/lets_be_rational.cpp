...
#include "baseinfra/OptionsUtils/normaldistribution.hpp"
...
// See https://www.kernel.org/doc/Documentation/atomic_ops.txt for further details on this simplistic implementation of
// an atomic flag that is *not* volatile.
typedef struct { int data; } atomic_t;

static atomic_t implied_volatility_maximum_iterations = {2};  // (DBL_DIG*20)/3 ≈ 100 . Only needed when the iteration
                                                              // effectively alternates Householder/Halley/Newton steps
...
double SetImpliedVolatilityMaximumIterations(double t) {
  int i = (int)t;
  if (i >= 0) {
...
#ifdef ENABLE_SWITCHING_THE_OUTPUT_TO_ITERATION_COUNT
double SetImpliedVolatilityOutputType(double t) {
  int i = (int)t;
#if defined(_MSC_VER) || defined(_WIN32) || defined(_WIN64)
...
#ifdef ENABLE_CHANGING_THE_HOUSEHOLDER_METHOD_ORDER
double SetImpliedVolatilityHouseholderMethodOrder(double t) {
  int i = (int)t;
  if (i >= 0) {
#if defined(_MSC_VER) || defined(_WIN32) || defined(_WIN64)
...
double asymptotic_expansion_of_normalized_black_call(double h, double t) {
  ...
  // 17th order asymptotic expansion of A(h,t) in q, sufficient for Φ(h) [and thus y(h)] to have relative accuracy of
  // 1.64E-16 for h <= η  with  η:=-10.
  const double asymptotic_expansion_sum =
      (2.0 +
       q * (-6.0E0 - 2.0 * e +
            3.0 * q *
                (1.0E1 + e * (2.0E1 + 2.0 * e) +
                     ...
                     (-1.4E1 + e * (-7.0E1 + e * (-4.2E1 - 2.0 * e)) +
                      7.0 * q *
                          (1.8E1 + e * (1.68E2 + e * (2.52E2 + e * (7.2E1 + 2.0 * e))) +
                           9.0 * q * (-2.2E1 + e * (-3.3E2 + e * (-9.24E2 + e * (-6.6E2 + e * (-1.1E2 - 2.0 * e)))) +
                                      1.1E1 * q *
                                          (2.6E1 +
                                           e * (5.72E2 +
                                                e * (2.574E3 + e * (3.432E3 + e * (1.43E3 + e * (1.56E2 + 2.0 * e))))) +
                                           1.3E1 * q *
                                               (-3.0E1 +
                                                e * (-9.1E2 +
                                                     e * (-6.006E3 +
                                                                       ...
                                                                       2.1E1 *
                                                                           q * (-4.6E1 +
                                                                                ...
                                                                                2.3E1 * q * (5.0E1 +
                                                                                             ...
                                                                                             2.5E1 * q * (-5.4E1 +
                                                                                                          e * (-5.85E3 +
                                                                                                               e * (-1.6146E5 + e * (-1.77606E6 + e * (-9.37365E6 + e * (-2.607579E7 + e * (-4.01166E7 + e * (-3.476772E7 + e * (-1.687257E7 + e * (-4.44015E6 + e * (-5.9202E5 + e * (-3.51E4 + e * (-7.02E2 - 2.0 * e)))))))))))) +
                                                                                                          2.7E1 * q * (5.8E1 +
                                                                                                                       e * (7.308E3 +
                                                                                                                            e * (2.3751E5 +
                                                                                                                                 e * (3.12156E6 +
                                                                                                                                      e * (2.003001E7 +
                                                                                                                                           e * (6.919458E7 + e * (1.3572783E8 + e * (1.5511752E8 + e * (1.0379187E8 + e * (4.006002E7 + e * (8.58429E6 + e * (9.5004E5 + e * (4.7502E4 + e * (8.12E2 + 2.0 * e))))))))))))) +
                                                                                                                       2.9E1 *
                                                                                                                           q * (-6.2E1 + e * (-8.99E3 + e * (-3.39822E5 + e * (-5.25915E6 + e * (-4.032015E7 + e * (-1.6934463E8 + e * (-4.1250615E8 + e * (-6.0108039E8 + e * (-5.3036505E8 + e * (-2.8224105E8 + e * (-8.870433E7 + e * (-1.577745E7 + e * (-1.472562E6 + e * (-6.293E4 + e * (-9.3E2 - 2.0 * e)))))))))))))) +
                                                                                                                                3.1E1 * q * (6.6E1 +
                                                                                                                                             e * (1.0912E4 +
                                                                                                                                                  e * (4.74672E5 + e * (8.544096E6 + e * (7.71342E7 + e * (3.8707344E8 + e * (1.14633288E9 + e * (2.07431664E9 + e * (2.33360622E9 + e * (1.6376184E9 + e * (7.0963464E8 + e * (1.8512208E8 + e * (2.7768312E7 + e * (2.215136E6 + e * (8.184E4 + e * (1.056E3 + 2.0 * e))))))))))))))) +
                                                                                                                                             3.3E1 * (-7.0E1 +
                                                                                                                                                      e * (-1.309E4 +
                                                                                                                                                           e * (-6.49264E5 +
                                                                                                                                                                e * (-1.344904E7 +
                                                                                                                                                                     e * (-1.4121492E8 + e * (-8.344518E8 + e * (-2.9526756E9 + e * (-6.49588632E9 + e * (-9.0751353E9 + e * (-8.1198579E9 + e * (-4.6399188E9 + e * (-1.6689036E9 + e * (-3.67158792E8 + e * (-4.707164E7 + e * (-3.24632E6 + e * (-1.0472E5 + e * (-1.19E3 - 2.0 * e))))))))))))))))) *
                                                                                                                                                 q)))))))))))))))));
...
double normalised_black_call_using_erfcx(double h, double t) {
  ...
  // long expression in function asymptotic expansion asymptotic_expansion_of_normalized_black_call(). In this last
  // branch,
  // here, we therefore take a different tack as follows.
  //     The "scaled complementary error function" is defined as erfcx(z) = exp(z²)·erfc(z). Cody's implementation of
  //     this
  // function as published in "Rational Chebyshev approximations for the error function", W. J. Cody, Math. Comp., 1969,
  // pp.
  // 631-638, uses rational functions that theoretically approximates erfcx(x) to at least 18 significant decimal
  // digits,
  // *without* the use of the exponential function when x>4, which translates to about z<-5.66 in Φ(z). To make use of
  // it,
  // we write
  ...
  //
  const double b = 0.5 * exp(-0.5 * (h * h + t * t)) *
...
// Theoretically accurate to (better than) precision  ε = 2.23E-16  when  h<=0  and  t < τ  with  τ := 2·ε^(1/16) ≈
// 0.21.
...
double small_t_expansion_of_normalized_black_call(double h, double t) {
  ...
  // a := 1+h·Y(h)  --- Note that due to h<0, and h·Y(h) -> -1 (from above) as h -> -∞, we also have that a>0 and a -> 0
  // as h -> -∞
  // w := t² , h2 := h²
  const double a = 1 + h * (0.5 * SQRT_TWO_PI) * ErfcxCody(-ONE_OVER_SQRT_TWO * h), w = t * t, h2 = h * h;
  const double expansion =
      2 * t *
      (a +
       w * ((-1 + 3 * a + a * h2) / 6 +
            w * ((-7 + 15 * a + h2 * (-1 + 10 * a + a * h2)) / 120 +
...
namespace { /* τ */
static const double small_t_expansion_of_normalized_black_threshold = 2 * SIXTEENTH_ROOT_DBL_EPSILON;
}
...
double normalized_black_call_using_norm_cdf(double x, double s) {
  const double h = x / s, t = 0.5 * s, b_max = exp(0.5 * x), b = NormCdf(h + t) * b_max - NormCdf(h - t) / b_max;
  return fabs(std::max(b, 0.0));
}

double NormalisedBlackCall(double x, double s) {
  if (x > 0) return normalised_intrinsic_call(x) + NormalisedBlackCall(-x, s);
  const double ax = fabs(x);
  if (s <= ax * DENORMALIZATION_CUTOFF) return normalised_intrinsic_call(x);
  // Denote h := x/s and t := s/2.
  // We evaluate the condition |h|>|η|, i.e., h<η  &&  t < τ+|h|-|η|  avoiding any divisions by s , where η =
  // asymptotic_expansion_accuracy_threshold  and τ = small_t_expansion_of_normalized_black_threshold .
  ...
  // Black formula, and we retain more accuracy by not attempting to combine the two terms in any way.
...
double NormalisedVega(double x, double s) {
  const double ax = fabs(x);
  return (ax <= 0) ? ONE_OVER_SQRT_TWO_PI * exp(-0.125 * s * s)
                   : ((s <= 0 || s <= ax * SQRT_DBL_MIN) ? 0 : ONE_OVER_SQRT_TWO_PI *
                                                                   exp(-0.5 * (square(x / s) + square(0.5 * s))));
}
...
double d2_f_lower_map_d_beta2(const double x, const double s) {
  const double ax = fabs(x), z = SQRT_ONE_OVER_THREE * ax / s, y = z * z, s2 = s * s, Phi = norm_cdf(-z),
               phi = NormPdf(z);
  return PI_OVER_SIX * y / (s2 * s) * Phi * (8 * SQRT_THREE * s * ax + (3 * s2 * (s2 - 8) - 8 * x * x) * Phi / phi) *
         exp(2 * y + 0.25 * s2);
}
...
#else
void compute_f_lower_map_and_first_two_derivatives(const double x, const double s, double &f, double &fp, double &fpp) {
  const double ax = fabs(x), z = SQRT_ONE_OVER_THREE * ax / s, y = z * z, s2 = s * s, Phi = NormCdf(-z),
               phi = NormPdf(z);
  fpp = PI_OVER_SIX * y / (s2 * s) * Phi * (8 * SQRT_THREE * s * ax + (3 * s2 * (s2 - 8) - 8 * x * x) * Phi / phi) *
        exp(2 * y + 0.25 * s2);
...
double inverse_f_lower_map(const double x, const double f) {
  return is_below_horizon(f)
             ? 0
             : fabs(x /
                    (SQRT_THREE * InverseNormCdf(std::pow(f / (TWO_PI_OVER_SQRT_TWENTY_SEVEN * fabs(x)), 1. / 3.))));
}

#ifdef COMPUTE_UPPER_MAP_DERIVATIVES_INDIVIDUALLY
double f_upper_map(const double s) { return norm_cdf(-0.5 * s); }
...
double inverse_f_upper_map(double f) { return -2. * InverseNormCdf(f); }

// See http://en.wikipedia.org/wiki/Householder%27s_method for a detailed explanation of the third order Householder
// iteration.
//
...
double unchecked_normalised_implied_volatility_from_a_transformed_rational_guess_with_limited_iterations(
  ...
  if (beta < DENORMALIZATION_CUTOFF)  // For positive but denormalized (a.k.a. 'subnormal') prices, we return 0 since it
                                      // would be impossible to converge to full machine accuracy anyway.
    return implied_volatility_output(0, 0);
  const double b_max = exp(0.5 * x);
  if (beta >= b_max) return implied_volatility_output(0, VOLATILITY_VALUE_TO_SIGNAL_PRICE_IS_ABOVE_MAXIMUM);
  int iterations = 0, direction_reversal_count = 0;
  double f = -DBL_MAX, s = -DBL_MAX, ds = s, ds_previous = 0, s_left = DBL_MIN, s_right = DBL_MAX;
  // The temptation is great to use the optimised form b_c = exp(x/2)/2-exp(-x/2)·Phi(sqrt(-2·x)) but that would require
  // implementing all of the above types of round-off and over/underflow handling for this expression, too.
  const double s_c = sqrt(fabs(2 * x)), b_c = NormalisedBlackCall(x, s_c), v_c = NormalisedVega(x, s_c);
  // Four branches.
  if (beta < b_c) {
    const double s_l = s_c - b_c / v_c, b_l = NormalisedBlackCall(x, s_l);
    if (beta < b_l) {
      double f_lower_map_l, d_f_lower_map_l_d_beta, d2_f_lower_map_l_d_beta2;
      compute_f_lower_map_and_first_two_derivatives(x, s_l, f_lower_map_l, d_f_lower_map_l_d_beta,
                                                    d2_f_lower_map_l_d_beta2);
      const double r_ll = ConvexRationalCubicControlParameterToFitSecondDerivativeAtRightSide(
      ...
      for (; iterations < N && fabs(ds) > DBL_EPSILON * s; ++iterations) {
        if (ds * ds_previous < 0) ++direction_reversal_count;
        if (iterations > 0 && (3 == direction_reversal_count || !(s > s_left && s < s_right))) {
          // If looping inefficently, or the forecast step takes us outside the bracket, or onto its edges, switch to
          // binary nesting.
        ...
        ds_previous = ds;
        const double b = NormalisedBlackCall(x, s), bp = NormalisedVega(x, s);
        if (b > beta && s < s_right)
          s_right = s;
        ...
        if (b <= 0 || bp <= 0)  // Numerical underflow. Switch to binary nesting for this iteration.
          ...
          const double ln_b = log(b), ln_beta = log(beta), bpob = bp / b, h = x / s, b_halley = h * h / s - s / 4,
                       newton = (ln_beta - ln_b) * ln_b / ln_beta / bpob, halley = b_halley - bpob * (1 + 2 / ln_b);
          const double b_hh3 = b_halley * b_halley - 3 * square(h / s) - 0.25,
                       hh3 = b_hh3 + 2 * square(bpob) * (1 + 3 / ln_b * (1 + 1 / ln_b)) -
      ...
      const double v_l = NormalisedVega(x, s_l),
                   r_lm = ConvexRationalCubicControlParameterToFitSecondDerivativeAtRightSide(
                       b_l, b_c, s_l, s_c, 1 / v_l, 1 / v_c, 0.0, false);
      s = RationalCubicInterpolation(beta, b_l, b_c, s_l, s_c, 1 / v_l, 1 / v_c, r_lm);
      s_left = s_l;
      s_right = s_c;
    }
  } else {
    const double s_h = v_c > DBL_MIN ? s_c + (b_max - b_c) / v_c : s_c, b_h = NormalisedBlackCall(x, s_h);
    if (beta <= b_h) {
      const double v_h = NormalisedVega(x, s_h),
                   r_hm = ConvexRationalCubicControlParameterToFitSecondDerivativeAtLeftSide(
                       b_c, b_h, s_c, s_h, 1 / v_c, 1 / v_h, 0.0, false);
      s = RationalCubicInterpolation(beta, b_c, b_h, s_c, s_h, 1 / v_c, 1 / v_h, r_hm);
      s_left = s_c;
      s_right = s_h;
    } else {
      double f_upper_map_h, d_f_upper_map_h_d_beta, d2_f_upper_map_h_d_beta2;
      compute_f_upper_map_and_first_two_derivatives(x, s_h, f_upper_map_h, d_f_upper_map_h_d_beta,
                                                    d2_f_upper_map_h_d_beta2);
      if (d2_f_upper_map_h_d_beta2 > -SQRT_DBL_MAX && d2_f_upper_map_h_d_beta2 < SQRT_DBL_MAX) {
        const double r_hh = ConvexRationalCubicControlParameterToFitSecondDerivativeAtLeftSide(
            b_h, b_max, f_upper_map_h, 0., d_f_upper_map_h_d_beta, -0.5, d2_f_upper_map_h_d_beta2, true);
        f = RationalCubicInterpolation(beta, b_h, b_max, f_upper_map_h, 0., d_f_upper_map_h_d_beta, -0.5, r_hh);
      }
      if (f <= 0) {
        const double h = b_max - b_h, t = (beta - b_h) / h;
        f = (f_upper_map_h * (1 - t) + 0.5 * h * t) * (1 - t);  // We switch to quadratic interpolation using f(b_h),
                                                                // f(b_max)≡0, and f'(b_max)≡-1/2 to specify the
                                                                // quadratic.
      }
      ...
      if (beta > 0.5 * b_max) {  // Else we better drop through and let the objective function be g(s) = b(x,s)-beta.
        ...
        for (; iterations < N && fabs(ds) > DBL_EPSILON * s; ++iterations) {
          ...
          if (b >= b_max || bp <= DBL_MIN)  // Numerical underflow. Switch to binary nesting for this iteration.
            ...
            const double b_halley = square(x / s) / s - s / 4,
  ...
  // In this branch, which comprises the two middle segments, the objective function is g(s) = b(x,s)-beta, or g(s) =
  // b(s) - beta, for short.
  // This makes
  //              newton = -g/g'   =  -(b-beta)/b'
  ...
  for (; iterations < N && fabs(ds) > DBL_EPSILON * s; ++iterations) {
    if (ds * ds_previous < 0) ++direction_reversal_count;
    if (iterations > 0 && (3 == direction_reversal_count || !(s > s_left && s < s_right))) {
      // If looping inefficently, or the forecast step takes us outside the bracket, or onto its edges, switch to binary
      // nesting.
      // NOTE that this can only really happen for very extreme values of |x|, such as |x| = |ln(F/K)| > 500.
      s = 0.5 * (s_left + s_right);
      if (s_right - s_left <= DBL_EPSILON * s) break;
    ...
    if (b > beta && s < s_right)
      ...
      s_left = s;  // Tighten the bracket if applicable.
    const double newton = (beta - b) / bp, halley = square(x / s) / s - s / 4,
...
double ImpliedVolatilityFromTransformedRationalGuessWithLimitedIterations(double price, double F, double K, double T,
                                                                          double q /* q=±1 */, int N) {
  const double intrinsic = fabs(std::max((q < 0 ? K - F : F - K), 0.0));
  if (price < intrinsic) return implied_volatility_output(0, VOLATILITY_VALUE_TO_SIGNAL_PRICE_IS_BELOW_INTRINSIC);
  const double max_price = (q < 0 ? K : F);
  if (price >= max_price) return implied_volatility_output(0, VOLATILITY_VALUE_TO_SIGNAL_PRICE_IS_ABOVE_MAXIMUM);
...
double ImpliedVolatilityFromTransformedRationalGuess(double price, double F, double K, double T, double q /* q=±1 */) {
  return ImpliedVolatilityFromTransformedRationalGuessWithLimitedIterations(price, F, K, T, q,
                                                                            implied_volatility_maximum_iterations.data);
}
...
double NormalisedImpliedVolatilityFromTransformedRationalGuessWithLimitedIterations(double beta, double x,
  ...
  if (beta < 0) return implied_volatility_output(0, VOLATILITY_VALUE_TO_SIGNAL_PRICE_IS_BELOW_INTRINSIC);
...
double NormalisedImpliedVolatilityFromTransformedRationalGuess(double beta, double x, double q /* q=±1 */) {
  return NormalisedImpliedVolatilityFromTransformedRationalGuessWithLimitedIterations(
