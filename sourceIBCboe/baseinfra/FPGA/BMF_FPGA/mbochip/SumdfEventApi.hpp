 ...
 * \return Open returns status, indicating if the operation was successfully completed. Check the SiliconUMDF log in
 * case of failure.
*/
 ...
 * \return CloseReturn status, indicating if the operation was successfully completed. Check the SiliconUMDF log in case
 * of failure.
*/
...
/*!
 * \param handler is the device handler.
 * \param sumdfChannelId number that identifies the channel. It is the position of the channel in the channelArray of
sumdfConfiguration parameter passed in the open function.
...
//     * \return SiliconUmdf::EventAPI::JoinChannelReturn status, indicating if the operation was successfully
completed. Check the SiliconUMDF log in case of failure.
*/
JoinChannelReturn joinChannel(DeviceHandler &handler, unsigned sumdfChannelId, bool instrumentFilterEnabled,
                              unsigned numSecurityIds, Uint64 securityIds[], MDEntriesAllowed_t mdEntriesAllowed);
 ...
 * \param sumdfChannelId number that identifies the channel. It is the position of the channel in the channelArray of
 * sumdfConfiguration parameter passed in the open function.
 * \return the LeaveChannelReturn status, indicating if the operation was successfully completed. Check the SiliconUMDF
 ...
 * \param sumdfChannelId number that identifies the channel. It is the position of the channel in the channelArray of
 * sumdfConfiguration parameter passed in the open function.
 * \return the RequestReturn status, indicating if the operation was successfully completed.  Check the SiliconUMDF log
 * in case of failure.
*/
 ...
 * \return the WaitEventReturn status, indicating if the operation was successfully completed. Check the SiliconUMDF log
 * in case of failure.
*/
 ...
 * \return the GetChannelStatusReturn status, indicating if the operation was successfully completed. Check the
 * SiliconUMDF log in case of failure.
*/
